...
created: 2026-06-01
layout: default
title: "Appendix \u2014 True-Color ROM Asset Extraction"
---
...
- **Title / boot / cinematics** — `render_boot_title_screens` ○, `display_fullscreen_graphic_sequence` ○ (logo + ending/cutscene blobs; `assets/screens/title-screen.png` exists from an earlier method — re-do via this recipe for color + the full sequence).
