...
; ============================================================
 ...
 >$CCB3  B3                         PUSHL
  ...
  $CCB5  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  $CCB9  CF                         RETURN
...
; ============================================================
 ...
 >$CD99  8A FF 00                   LOADL_imm2             $00FF
  ...
  $CDA2  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
...
; ============================================================
 ...
 >$D171  0B                         LOADL_quick   ; inline operand = 11
  ...
  $D195  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  ...
  $D1A5  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
 ...
 >$D1CA  2B                         STORE_quick   ; inline operand = 11
  ...
  $D1CC  E9 72 D7 02                CALL_abs_imm1          $D772 (ui_helper_d772) {bytecode}, $02
  $D1D0  B3                         PUSHL
 ...
 >$D220  2B                         STORE_quick   ; inline operand = 11
  ...
  $D224  E9 72 D7 02                CALL_abs_imm1          $D772 (ui_helper_d772) {bytecode}, $02
  $D228  B3                         PUSHL
...
; ============================================================
 ...
 >$D345  B3                         PUSHL
  ...
  $D347  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
...
; ============================================================
 ...
 >$D3A1  2B                         STORE_quick   ; inline operand = 11
  $D3A2  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
...
; ============================================================
 ...
 >$D3E7  2B                         STORE_quick   ; inline operand = 11
  $D3E8  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
...
; ============================================================
 ...
 >$D5B0  38                         PUSH_quick   ; inline operand = 8
  ...
  $D5B2  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
 ...
 >$D5C2  2A                         STORE_quick   ; inline operand = 10
  ...
  $D5CB  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
...
; ============================================================
  ...
  $D604  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
...
; ============================================================
  ...
  $D611  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  ...
  $D620  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
...
; ============================================================
  ...
  $D76E  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
  $D771  CF                         RETURN
...
; ============================================================
  ...
  $D786  E9 72 D7 02                CALL_abs_imm1          $D772 (ui_helper_d772) {bytecode}, $02
  $D78A  CF                         RETURN
...
; ============================================================
  ...
  $D798  E9 72 D7 02                CALL_abs_imm1          $D772 (ui_helper_d772) {bytecode}, $02
...
; ============================================================
  ...
  $D7BC  E9 72 D7 02                CALL_abs_imm1          $D772 (ui_helper_d772) {bytecode}, $02
...
; ============================================================
  ...
  $D7E0  E9 72 D7 02                CALL_abs_imm1          $D772 (ui_helper_d772) {bytecode}, $02
  $D7E4  B3                         PUSHL
...
; ============================================================
  ...
  $D978  E9 72 D7 02                CALL_abs_imm1          $D772 (ui_helper_d772) {bytecode}, $02
...
; ============================================================
  ...
  $D9C1  E9 72 D7 02                CALL_abs_imm1          $D772 (ui_helper_d772) {bytecode}, $02
  $D9C5  B4                         POPR
  $D9C6  C0                         CMPEQ
  $D9C7  CF                         RETURN
...
; ============================================================
  ...
  $DA89  E9 72 D7 02                CALL_abs_imm1          $D772 (ui_helper_d772) {bytecode}, $02
...
; ============================================================
 ...
 >$DAC6  0C                         LOADL_quick   ; inline operand = 12
  ...
  $DAC8  BD                         LSHIFT
  $DAC9  8C 04 80                   LOADR_imm2             $8004 (map_render_driver_data_8004)
 >$DACC  BB                         ADD
  $DACD  B3                         PUSHL
...
; ============================================================
  ...
  $DB23  E9 72 D7 02                CALL_abs_imm1          $D772 (ui_helper_d772) {bytecode}, $02
  $DB27  53                         LOADR_qimm   ; inline operand = 3
  $DB28  C0                         CMPEQ
  $DB29  CF                         RETURN
 >$DB2A  AA 63 6F                   PUSH_abs               $6F63 (battle_defending_province)
  $DB2D  E9 72 D7 02                CALL_abs_imm1          $D772 (ui_helper_d772) {bytecode}, $02
...
; ============================================================
  ...
  $DB5E  E9 72 D7 02                CALL_abs_imm1          $D772 (ui_helper_d772) {bytecode}, $02
...
; ============================================================
  ...
  $DB81  E9 72 D7 02                CALL_abs_imm1          $D772 (ui_helper_d772) {bytecode}, $02
...
; ============================================================
 ...
 >$DBF6  0B                         LOADL_quick   ; inline operand = 11
  ...
  $DC01  E9 72 D7 02                CALL_abs_imm1          $D772 (ui_helper_d772) {bytecode}, $02
  $DC05  D2                         LSHIFT1
...
; ============================================================
  ...
  $DCA3  BB                         ADD
  $DCA4  8C 7E A5                   LOADR_imm2             $A57E (tactical_map_cell_pool)
  $DCA7  BB                         ADD
  $DCA8  B3                         PUSHL
...
; ============================================================
 ...
 >$DED9  28                         STORE_quick   ; inline operand = 8
  $DEDA  B3                         PUSHL
  $DEDB  E9 72 D7 02                CALL_abs_imm1          $D772 (ui_helper_d772) {bytecode}, $02
  $DEDF  2A                         STORE_quick   ; inline operand = 10
  $DEE0  AA 57 6F                   PUSH_abs               $6F57 (battle_winner_province_sel)
  $DEE3  E9 72 D7 02                CALL_abs_imm1          $D772 (ui_helper_d772) {bytecode}, $02
 ...
 >$DEF6  3B                         PUSH_quick   ; inline operand = 11
  $DEF7  E9 72 D7 02                CALL_abs_imm1          $D772 (ui_helper_d772) {bytecode}, $02
...
; ============================================================
 ...
 >$E145  0A                         LOADL_quick   ; inline operand = 10
  ...
  $E149  E9 72 D7 02                CALL_abs_imm1          $D772 (ui_helper_d772) {bytecode}, $02
  $E14D  B4                         POPR
  $E14E  C0                         CMPEQ
...
; ============================================================
  ...
  $E22F  E9 72 D7 02                CALL_abs_imm1          $D772 (ui_helper_d772) {bytecode}, $02
  $E233  B3                         PUSHL
  $E234  E9 B2 DC 02                CALL_abs_imm1          $DCB2 (generate_daimyo_name) {bytecode}, $02
  $E238  3C                         PUSH_quick   ; inline operand = 12
  $E239  E9 72 D7 02                CALL_abs_imm1          $D772 (ui_helper_d772) {bytecode}, $02
...
; ============================================================
  ...
  $E280  E9 72 D7 02                CALL_abs_imm1          $D772 (ui_helper_d772) {bytecode}, $02
...
; ============================================================
  $E2DB  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
  ...
  $E2E8  E9 72 D7 02                CALL_abs_imm1          $D772 (ui_helper_d772) {bytecode}, $02
...
; ============================================================
  ...
  $E353  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
...
; ============================================================
  ...
  $E3D5  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
...
; ============================================================
  ...
  $E42B  E9 72 D7 02                CALL_abs_imm1          $D772 (ui_helper_d772) {bytecode}, $02
 ...
 >$E439  3B                         PUSH_quick   ; inline operand = 11
  $E43A  E9 72 D7 02                CALL_abs_imm1          $D772 (ui_helper_d772) {bytecode}, $02
...
; ============================================================
 ...
 >$E4EB  0B                         LOADL_quick   ; inline operand = 11
  $E4EC  D3                         BYTE_DEREF
  $E4ED  B3                         PUSHL
  $E4EE  E9 72 D7 02                CALL_abs_imm1          $D772 (ui_helper_d772) {bytecode}, $02
...
; ============================================================
  ...
  $E574  B5                         MULT
  $E575  8C 3C 9E                   LOADR_imm2             $9E3C (fief_select_input_loop_data_9e3c)
  $E578  BB                         ADD
  $E579  B3                         PUSHL
 ...
 >$E58E  3A                         PUSH_quick   ; inline operand = 10
  ...
  $E590  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
 >$E594  CF                         RETURN
 >$E595  81 D8                      LOADL_near             $D8
  ...
  $E5CB  BB                         ADD
  $E5CC  8C 5A 8D                   LOADR_imm2             $8D5A (fief_select_input_loop_data_8d5a)
  $E5CF  BB                         ADD
  $E5D0  B3                         PUSHL
...
; ============================================================
  ...
  $E64B  B5                         MULT
  $E64C  8C 3C 9E                   LOADR_imm2             $9E3C (fief_select_input_loop_data_9e3c)
  $E64F  BB                         ADD
  $E650  B3                         PUSHL
 ...
 >$E67E  81 D8                      LOADL_near             $D8
  ...
  $E68A  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
...
; ============================================================
  ...
  $E6E8  B5                         MULT
  $E6E9  8C 04 A6                   LOADR_imm2             $A604 (portrait_feature0_head_tiles)
  $E6EC  BB                         ADD
  $E6ED  B3                         PUSHL
  ...
  $E6FA  B5                         MULT
  $E6FB  8C C4 A9                   LOADR_imm2             $A9C4 (portrait_feature1_eyes_tiles)
  $E6FE  BB                         ADD
  $E6FF  B3                         PUSHL
  ...
  $E70C  B5                         MULT
  $E70D  8C A4 AB                   LOADR_imm2             $ABA4 (portrait_feature2_nose_tiles)
  $E710  BB                         ADD
  $E711  B3                         PUSHL
  ...
  $E71F  B5                         MULT
  $E720  8C 84 AD                   LOADR_imm2             $AD84 (portrait_feature3_mouth_tiles)
  $E723  BB                         ADD
  $E724  B3                         PUSHL
  ...
  $E763  B5                         MULT
  $E764  8C AC AE                   LOADR_imm2             $AEAC (unpack_base5_digits_uplo_data_aeac)
  $E767  BB                         ADD
  $E768  B3                         PUSHL
...
; ============================================================
 ...
 >$E7A7  AA 5B 6F                   PUSH_abs               $6F5B (active_province_idx_copy)
  ...
  $E7AE  D2                         LSHIFT1
  $E7AF  D2                         LSHIFT1
  $E7B0  8C D0 BB                   LOADR_imm2             $BBD0 (build_blit_fief_tile_blo_data_bbd0)
  $E7B3  BB                         ADD
  ...
  $E7E6  B5                         MULT
  $E7E7  8C 44 B1                   LOADR_imm2             $B144 (build_blit_fief_tile_blo_data_b144)
  $E7EA  BB                         ADD
