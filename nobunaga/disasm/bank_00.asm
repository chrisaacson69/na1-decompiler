...
tab_b0_ac94: ; 242 bytes
            ...
            ora ($01,x)                 ; 02EF2:  01 01
            ora ($01,x)                 ; 02EF4:  01 01
...
tab_b0_af0b: ; 100 bytes
            ...
            hex 3e 00 00 ; rol $0000,x  ; 03240:  3e 00 00
            brk                         ; 03243:  00
            hex 3c                      ; 03244:  3c
            ror $7e                     ; 03245:  66 7e
            rts                         ; 03247:  60
...
b0_b5d7:    brk                         ; 035D7:  00
            ...
            hex 6e 6e 00 ; ror $006e    ; 0364F:  6e 6e 00
            rts                         ; 03652:  60

            hex 60 6c 7e 6e             ; 03653:  60 6c 7e 6e

            hex 6e 6e 00 ; ror $006e    ; 03657:  6e 6e 00
            sec                         ; 0365A:  38
            brk                         ; 0365B:  00
            hex 38                      ; 0365C:  38
            sec                         ; 0365D:  38
...
tab_b0_b683: ; 345 bytes
            ...
            adc ($74,x)                 ; 037DF:  61 74
            adc $6c,x                   ; 037E1:  75 6c
            adc ($74,x)                 ; 037E3:  61 74
            adc #$6f                    ; 037E5:  69 6f
            ...
            adc ($00,x)                 ; 0389C:  61 00
            brk                         ; 0389E:  00
            hex 44                      ; 0389F:  44
            adc ($74,x)                 ; 038A0:  61 74
