...
; ============================================================
  $8008  8E 10 BA                   PUSH_imm2              $BA10 (prompt_message_and_redra_data_ba10)
 ...
 >$8021  3D                         PUSH_quick   ; inline operand = 13
  ...
  $802A  8A 11 BA                   LOADL_imm2             $BA11 (prompt_message_and_redra_data_ba11)
 ...
 >$8033  B3                         PUSHL
  ...
  $8040  E9 34 D1 08                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $08
 >$8044  8E 12 BA                   PUSH_imm2              $BA12 (prompt_message_and_redra_data_ba12)
...
; ============================================================
 ...
 >$8059  38                         PUSH_quick   ; inline operand = 8
  ...
  $805B  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
...
; ============================================================
  ...
  $809D  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  ...
  $80AC  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  ...
  $80BE  E9 34 D1 06                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $06
  $80C2  8D 16                      BYTE_PUSH_imm1         +22
  $80C4  8D 14                      BYTE_PUSH_imm1         +20
  $80C6  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  ...
  $80D8  E9 34 D1 06                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $06
  $80DC  8D 17                      BYTE_PUSH_imm1         +23
  $80DE  8D 14                      BYTE_PUSH_imm1         +20
  $80E0  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  ...
  $80F2  E9 34 D1 06                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $06
  $80F6  8D 18                      BYTE_PUSH_imm1         +24
  $80F8  8D 14                      BYTE_PUSH_imm1         +20
  $80FA  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  ...
  $810C  E9 34 D1 06                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $06
  $8110  8D 19                      BYTE_PUSH_imm1         +25
  $8112  8D 14                      BYTE_PUSH_imm1         +20
  $8114  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  ...
  $8121  B6                         SDIV
  $8122  B3                         PUSHL
  $8123  8E 57 BA                   PUSH_imm2              $BA57 (transfer_owned_fiefs_and_data_ba57)
  $8126  E9 34 D1 06                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $06
...
; ============================================================
 ...
 >$817E  0D                         LOADL_quick   ; inline operand = 13
  ...
  $81A8  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
 ...
 >$81E4  8E 69 BA                   PUSH_imm2              $BA69 (count_eligible_targets_data_ba69)
...
; ============================================================
 ...
 >$82EB  B3                         PUSHL
  ...
  $82F8  BC                         SUB
  $82F9  D6 00 83                   JUMP_abs               $8300 (relation_base_data_8300)
...
; ============================================================
  ...
  $83B5  8E 6B BA                   PUSH_imm2              $BA6B (msg_lord_s_to)
  $83B8  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
  $83BC  D6 C6 83                   JUMP_abs               $83C6 (lookup_terrain_attr_record)
 >$83BF  8E 6F BA                   PUSH_imm2              $BA6F (province_window_redraw_data_ba6f)
...
; ============================================================
  ...
  $83D0  E9 A2 83 04                CALL_abs_imm1          $83A2 (calc_tactical_cell_coords) {bytecode}, $04
  $83D4  CF                         RETURN
...
; ============================================================
  ...
  $83EB  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
...
; ============================================================
  ...
  $8460  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  $8464  AC 77 D6                   CALL_abs               $D677 (draw_window_f6c4) {bytecode}
  $8467  63                         PUSH_qimm   ; inline operand = 3
  $8468  67                         PUSH_qimm   ; inline operand = 7
  $8469  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  $846D  AC 87 D6                   CALL_abs               $D687 (redraw_window_f6c7) {bytecode}
  ...
  $8477  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  ...
  $8484  D6 88 84                   JUMP_abs               $8488 (read_button_press)
 ...
 >$84C6  E9 C4 CE 02                CALL_abs_imm1          $CEC4 (redraw_window) {bytecode}, $02
  ...
  $84CC  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  $84D0  0C                         LOADL_quick   ; inline operand = 12
  $84D1  D0                         INC
  $84D2  B3                         PUSHL
  $84D3  8E 93 BA                   PUSH_imm2              $BA93 (msg_fief_2d_ba93)
  $84D6  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
  $84DA  63                         PUSH_qimm   ; inline operand = 3
  $84DB  8D 16                      BYTE_PUSH_imm1         +22
  $84DD  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  $84E1  3C                         PUSH_quick   ; inline operand = 12
  $84E2  E9 D3 D9 02                CALL_abs_imm1          $D9D3 (draw_window_row_7985) {bytecode}, $02
  $84E6  64                         PUSH_qimm   ; inline operand = 4
  $84E7  6A                         PUSH_qimm   ; inline operand = 10
  $84E8  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
 ...
 >$84F8  8E 9C BA                   PUSH_imm2              $BA9C (effect_view_a_data_ba9c)
 ...
 >$8522  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
 ...
 >$854A  89 10                      BYTE_LOADL_imm1        +16
  ...
  $8557  E9 A2 83 04                CALL_abs_imm1          $83A2 (calc_tactical_cell_coords) {bytecode}, $04
 >$855B  0B                         LOADL_quick   ; inline operand = 11
  ...
  $8578  E9 72 D9 02                CALL_abs_imm1          $D972 (war_helper_d972) {bytecode}, $02
  $857C  D8 8C 85                   JUMPF_abs              $858C
  $857F  6B                         PUSH_qimm   ; inline operand = 11
  $8580  62                         PUSH_qimm   ; inline operand = 2
  $8581  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
...
; ============================================================
 ...
 >$862A  0A                         LOADL_quick   ; inline operand = 10
  ...
  $8659  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
 ...
 >$8664  0B                         LOADL_quick   ; inline operand = 11
  ...
  $867E  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
  ...
  $86A2  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
 ...
 >$86A8  06                         LOADL_quick   ; inline operand = 6
  ...
  $86B5  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
  ...
  $86D2  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
...
; ============================================================
  ...
  $872A  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  $872E  8E 15 BB                   PUSH_imm2              $BB15 (msg_menu)
  $8731  E9 C4 CE 02                CALL_abs_imm1          $CEC4 (redraw_window) {bytecode}, $02
  $8735  AC 69 CC                   CALL_abs               $CC69 (trade_helper_cc69) {bytecode}
 ...
 >$8740  0B                         LOADL_quick   ; inline operand = 11
  ...
  $8745  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  $8749  0B                         LOADL_quick   ; inline operand = 11
  $874A  D0                         INC
  $874B  B3                         PUSHL
  $874C  8E 1E BB                   PUSH_imm2              $BB1E (msg_fmt__2d_bb1e)
  $874F  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
 ...
 >$876D  0B                         LOADL_quick   ; inline operand = 11
  ...
  $8773  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  $8777  0B                         LOADL_quick   ; inline operand = 11
  $8778  D0                         INC
  $8779  B3                         PUSHL
  $877A  8E 22 BB                   PUSH_imm2              $BB22 (msg_fmt__2d_bb22)
  $877D  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
...
; ============================================================
  ...
  $87BA  CF                         RETURN
 >$87BB  8E 26 BB                   PUSH_imm2              $BB26 (province_select_helper_data_bb26)
...
; ============================================================
  ...
  $8887  E9 72 D9 02                CALL_abs_imm1          $D972 (war_helper_d972) {bytecode}, $02
 ...
 >$8899  3B                         PUSH_quick   ; inline operand = 11
  ...
  $88A1  E9 AC 82 02                CALL_abs_imm1          $82AC (helper_82AC) {bytecode}, $02
  $88A5  CF                         RETURN
...
; ============================================================
 ...
 >$88FC  2A                         STORE_quick   ; inline operand = 10
  ...
  $8915  D2                         LSHIFT1
  $8916  B3                         PUSHL
  $8917  E9 7D 88 04                CALL_abs_imm1          $887D (helper_dam_rounding) {bytecode}, $04
...
; ============================================================
 ...
 >$8A94  0B                         LOADL_quick   ; inline operand = 11
  ...
  $8A9F  E9 34 D1 06                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $06
  $8AA3  39                         PUSH_quick   ; inline operand = 9
  $8AA4  3A                         PUSH_quick   ; inline operand = 10
  $8AA5  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  $8AA9  CF                         RETURN
...
; ============================================================
  ...
  $8B3B  E9 4E 8A 02                CALL_abs_imm1          $8A4E (helper_8A4E) {bytecode}, $02
  $8B3F  CF                         RETURN
...
; ============================================================
  ...
  $8B6B  E9 57 83 06                CALL_abs_imm1          $8357 (helper_8357) {bytecode}, $06
 ...
 >$8B7A  2B                         STORE_quick   ; inline operand = 11
  ...
  $8B8A  E9 4E 8A 02                CALL_abs_imm1          $8A4E (helper_8A4E) {bytecode}, $02
  $8B8E  CF                         RETURN
...
; ============================================================
  ...
  $8D97  E9 8F 8B 02                CALL_abs_imm1          $8B8F (helper_8B8F) {bytecode}, $02
  $8D9B  8D 1A                      BYTE_PUSH_imm1         +26
  $8D9D  E9 0C E8 02                CALL_abs_imm1          $E80C (ui_helper_e80c) {bytecode}, $02
  $8DA1  8E 3E BB                   PUSH_imm2              $BB3E (effect_bribe_data_bb3e)
  ...
  $8DAC  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
 ...
 >$8DBF  61                         PUSH_qimm   ; inline operand = 1
  $8DC0  E9 8F 8B 02                CALL_abs_imm1          $8B8F (helper_8B8F) {bytecode}, $02
...
; ============================================================
  ...
  $8E49  E9 0C E8 02                CALL_abs_imm1          $E80C (ui_helper_e80c) {bytecode}, $02
 ...
 >$8F42  A4 63 6F                   LOADL_abs              $6F63 (battle_defending_province)
  ...
  $8F57  AC D7 DA                   CALL_abs               $DAD7 (combat_helper_dad7) {bytecode}
  $8F5A  8E 4F 6F                   PUSH_imm2              $6F4F (deduped_owner_list)
  $8F5D  61                         PUSH_qimm   ; inline operand = 1
  $8F5E  E9 3A DD 04                CALL_abs_imm1          $DD3A (combat_helper_dd3a) {bytecode}, $04
...
; ============================================================
  ...
  $9024  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
  ...
  $903E  E9 34 D1 06                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $06
...
; ============================================================
 ...
 >$90CF  A5 65 6F                   BYTE_LOADL_abs         $6F65 (war_side_state_flag)
  ...
  $90DD  D6 E8 90                   JUMP_abs               $90E8 (normalize_relations_matrix_lower)
...
; ============================================================
  ...
  $9188  E9 12 CA 04                CALL_abs_imm1          $CA12 (byte_helper_ca12) {bytecode}, $04
  $918C  CF                         RETURN
...
; ============================================================
 ...
 >$9260  08                         LOADL_quick   ; inline operand = 8
  ...
  $9273  E9 12 CA 04                CALL_abs_imm1          $CA12 (byte_helper_ca12) {bytecode}, $04
 ...
 >$9284  E9 C4 CE 02                CALL_abs_imm1          $CEC4 (redraw_window) {bytecode}, $02
  ...
  $928C  E9 0C E8 02                CALL_abs_imm1          $E80C (ui_helper_e80c) {bytecode}, $02
 ...
 >$92A0  09                         LOADL_quick   ; inline operand = 9
  ...
  $92AD  BB                         ADD
  $92AE  D3                         BYTE_DEREF
  $92AF  D8 D9 92                   JUMPF_abs              $92D9 (deduct_b_from_a_void_b_if_overdrawn)
...
; ============================================================
  ...
  $936E  E9 72 D9 02                CALL_abs_imm1          $D972 (war_helper_d972) {bytecode}, $02
  $9372  2B                         STORE_quick   ; inline operand = 11
  $9373  D8 80 93                   JUMPF_abs              $9380 (ravage_defender_arms)
...
; ============================================================
  ...
  $94AF  E9 72 D9 02                CALL_abs_imm1          $D972 (war_helper_d972) {bytecode}, $02
 ...
 >$94C3  40                         LOADL_qimm   ; inline operand = 0
  $94C4  CF                         RETURN
 >$94C5  AC D7 DA                   CALL_abs               $DAD7 (combat_helper_dad7) {bytecode}
  $94C8  8E 4F 6F                   PUSH_imm2              $6F4F (deduped_owner_list)
  $94CB  60                         PUSH_qimm   ; inline operand = 0
  $94CC  E9 3A DD 04                CALL_abs_imm1          $DD3A (combat_helper_dd3a) {bytecode}, $04
...
; ============================================================
  ...
  $96E1  CF                         RETURN
 >$96E2  AC D7 DA                   CALL_abs               $DAD7 (combat_helper_dad7) {bytecode}
  $96E5  8E 4F 6F                   PUSH_imm2              $6F4F (deduped_owner_list)
  $96E8  61                         PUSH_qimm   ; inline operand = 1
  $96E9  E9 3A DD 04                CALL_abs_imm1          $DD3A (combat_helper_dd3a) {bytecode}, $04
  ...
  $9713  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
  ...
  $9773  AC A7 D3                   CALL_abs               $D3A7 (ui_helper_d3a7) {bytecode}
 ...
 >$9797  68                         PUSH_qimm   ; inline operand = 8
  $9798  E9 0C E8 02                CALL_abs_imm1          $E80C (ui_helper_e80c) {bytecode}, $02
  ...
  $97AF  E9 FE DF 04                CALL_abs_imm1          $DFFE (update_arms_table_dffe) {bytecode}, $04
...
; ============================================================
 ...
 >$986C  39                         PUSH_quick   ; inline operand = 9
  ...
  $9884  AC D7 DA                   CALL_abs               $DAD7 (combat_helper_dad7) {bytecode}
  $9887  8E 4F 6F                   PUSH_imm2              $6F4F (deduped_owner_list)
  $988A  60                         PUSH_qimm   ; inline operand = 0
  $988B  E9 3A DD 04                CALL_abs_imm1          $DD3A (combat_helper_dd3a) {bytecode}, $04
  ...
  $98B6  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
 ...
 >$98DA  A4 5F 6F                   LOADL_abs              $6F5F (selected_province_idx)
  ...
  $98F3  E9 72 D9 02                CALL_abs_imm1          $D972 (war_helper_d972) {bytecode}, $02
 ...
 >$9906  8E 2F FA                   PUSH_imm2              $FA2F (msg_how_many_men_fa2f)
  ...
  $9944  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
  ...
  $994E  AC A7 D3                   CALL_abs               $D3A7 (ui_helper_d3a7) {bytecode}
 ...
 >$9959  A4 81 6F                   LOADL_abs              $6F81 (war_attacker_men)
  ...
  $998B  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
  $998E  6D                         PUSH_qimm   ; inline operand = 13
  $998F  E9 0C E8 02                CALL_abs_imm1          $E80C (ui_helper_e80c) {bytecode}, $02
...
; ============================================================
  ...
  $99B5  8E E2 BB                   PUSH_imm2              $BBE2 (driver_tax_data_bbe2)
  ...
  $99C2  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
  $99C6  A4 5F 6F                   LOADL_abs              $6F5F (selected_province_idx)
  $99C9  A8 63 6F                   STORE_abs              $6F63 (battle_defending_province)
  $99CC  AC 12 DB                   CALL_abs               $DB12 (tax_helper_db12) {bytecode}
 ...
 >$99D9  B3                         PUSHL
  ...
  $99F5  E9 0C E8 02                CALL_abs_imm1          $E80C (ui_helper_e80c) {bytecode}, $02
  $99F9  8E AB FA                   PUSH_imm2              $FAAB (msg_the_peasants_are_protesting)
  $99FC  D6 08 9A                   JUMP_abs               $9A08
 >$99FF  8D 12                      BYTE_PUSH_imm1         +18
  $9A01  E9 0C E8 02                CALL_abs_imm1          $E80C (ui_helper_e80c) {bytecode}, $02
...
; ============================================================
  ...
  $9A63  E9 10 E5 02                CALL_abs_imm1          $E510 (ui_helper_e510) {bytecode}, $02
  ...
  $9A96  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
  ...
  $9ACE  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
 ...
 >$9AE3  AA 5F 6F                   PUSH_abs               $6F5F (selected_province_idx)
  ...
  $9B17  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
 ...
 >$9B34  8E E3 BB                   PUSH_imm2              $BBE3 (msg_is_this_ok_bbe3)
  ...
  $9B3B  AC A7 D3                   CALL_abs               $D3A7 (ui_helper_d3a7) {bytecode}
  ...
  $9B6C  E9 0C E8 02                CALL_abs_imm1          $E80C (ui_helper_e80c) {bytecode}, $02
...
; ============================================================
 ...
 >$9BCF  08                         LOADL_quick   ; inline operand = 8
  ...
  $9BEA  8E EE BB                   PUSH_imm2              $BBEE (driver_dam_data_bbee)
  ...
  $9BFA  E9 34 D1 06                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $06
 ...
 >$9C20  3A                         PUSH_quick   ; inline operand = 10
  ...
  $9C22  E9 7D 88 04                CALL_abs_imm1          $887D (helper_dam_rounding) {bytecode}, $04
  $9C26  8D 15                      BYTE_PUSH_imm1         +21
  $9C28  E9 0C E8 02                CALL_abs_imm1          $E80C (ui_helper_e80c) {bytecode}, $02
  ...
  $9C37  B1                         POPSTORE
 >$9C38  8E FA BB                   PUSH_imm2              $BBFA (driver_dam_data_bbfa)
  ...
  $9C45  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
...
; ============================================================
  ...
  $9C62  E9 10 E5 02                CALL_abs_imm1          $E510 (ui_helper_e510) {bytecode}, $02
  ...
  $9C96  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
  ...
  $9CBC  E9 34 D1 08                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $08
  $9CC0  AC A7 D3                   CALL_abs               $D3A7 (ui_helper_d3a7) {bytecode}
 ...
 >$9CD7  60                         PUSH_qimm   ; inline operand = 0
  $9CD8  E9 8F 8B 02                CALL_abs_imm1          $8B8F (helper_8B8F) {bytecode}, $02
  ...
  $9CF7  E9 0C E8 02                CALL_abs_imm1          $E80C (ui_helper_e80c) {bytecode}, $02
 ...
 >$9D19  61                         PUSH_qimm   ; inline operand = 1
  ...
  $9D32  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
...
; ============================================================
 ...
 >$9D66  0B                         LOADL_quick   ; inline operand = 11
  ...
  $9D6B  8E FC BB                   PUSH_imm2              $BBFC (driver_grow_data_bbfc)
  ...
  $9D7C  E9 34 D1 06                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $06
  ...
  $9D9B  E9 0C E8 02                CALL_abs_imm1          $E80C (ui_helper_e80c) {bytecode}, $02
  $9D9F  8E 04 BC                   PUSH_imm2              $BC04 (driver_grow_data_bc04)
  ...
  $9DAD  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
...
; ============================================================
  ...
  $9E10  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
  $9E13  AC 15 E3                   CALL_abs               $E315 (marry_helper_e315) {bytecode}
  ...
  $9E51  E9 34 D1 08                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $08
  $9E55  AC A7 D3                   CALL_abs               $D3A7 (ui_helper_d3a7) {bytecode}
  ...
  $9E73  E9 8F 8B 02                CALL_abs_imm1          $8B8F (helper_8B8F) {bytecode}, $02
  $9E77  8D 10                      BYTE_PUSH_imm1         +16
  $9E79  E9 0C E8 02                CALL_abs_imm1          $E80C (ui_helper_e80c) {bytecode}, $02
 ...
 >$9EC6  61                         PUSH_qimm   ; inline operand = 1
  ...
  $9EDF  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
 ...
 >$9EFA  0A                         LOADL_quick   ; inline operand = 10
  $9EFB  CF                         RETURN
 >$9EFC  AC CB 87                   CALL_abs               $87CB (helper_87CB) {bytecode}
...
; ============================================================
 ...
 >$9F2F  0C                         LOADL_quick   ; inline operand = 12
  ...
  $9F52  BC                         SUB
  $9F53  B3                         PUSHL
  $9F54  E9 57 83 06                CALL_abs_imm1          $8357 (helper_8357) {bytecode}, $06
  ...
  $9F62  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
  ...
  $9F76  E9 AC 82 02                CALL_abs_imm1          $82AC (helper_82AC) {bytecode}, $02
  $9F7A  60                         PUSH_qimm   ; inline operand = 0
  $9F7B  E9 4E 8A 02                CALL_abs_imm1          $8A4E (helper_8A4E) {bytecode}, $02
  $9F7F  67                         PUSH_qimm   ; inline operand = 7
  $9F80  8D 10                      BYTE_PUSH_imm1         +16
  $9F82  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  $9F86  0C                         LOADL_quick   ; inline operand = 12
  $9F87  B0                         DEREF
  $9F88  B3                         PUSHL
  $9F89  E9 C7 83 02                CALL_abs_imm1          $83C7 (helper_83C7) {bytecode}, $02
  $9F8D  68                         PUSH_qimm   ; inline operand = 8
  $9F8E  8D 10                      BYTE_PUSH_imm1         +16
  $9F90  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  $9F94  0C                         LOADL_quick   ; inline operand = 12
  $9F95  72                         ADD_qimm   ; inline operand = 2
  $9F96  B0                         DEREF
  $9F97  B3                         PUSHL
  $9F98  E9 C7 83 02                CALL_abs_imm1          $83C7 (helper_83C7) {bytecode}, $02
  $9F9C  41                         LOADL_qimm   ; inline operand = 1
  $9F9D  CF                         RETURN
 >$9F9E  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
...
; ============================================================
  ...
  $9FEB  CF                         RETURN
 >$9FEC  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
...
; ============================================================
  ...
  $A024  BC                         SUB
  $A025  B3                         PUSHL
  $A026  E9 57 83 06                CALL_abs_imm1          $8357 (helper_8357) {bytecode}, $06
  ...
  $A034  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
  ...
  $A048  E9 AC 82 02                CALL_abs_imm1          $82AC (helper_82AC) {bytecode}, $02
  $A04C  61                         PUSH_qimm   ; inline operand = 1
  $A04D  E9 4E 8A 02                CALL_abs_imm1          $8A4E (helper_8A4E) {bytecode}, $02
 ...
 >$A05C  E9 C4 CE 02                CALL_abs_imm1          $CEC4 (redraw_window) {bytecode}, $02
  $A060  AC 59 D7                   CALL_abs               $D759 (ui_helper_d759) {bytecode}
 >$A063  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
...
; ============================================================
  ...
  $A091  B0                         DEREF
  $A092  B3                         PUSHL
  $A093  E9 57 83 06                CALL_abs_imm1          $8357 (helper_8357) {bytecode}, $06
  ...
  $A0CC  B3                         PUSHL
  $A0CD  E9 AC 82 02                CALL_abs_imm1          $82AC (helper_82AC) {bytecode}, $02
  $A0D1  62                         PUSH_qimm   ; inline operand = 2
  $A0D2  E9 4E 8A 02                CALL_abs_imm1          $8A4E (helper_8A4E) {bytecode}, $02
 ...
 >$A0E1  E9 C4 CE 02                CALL_abs_imm1          $CEC4 (redraw_window) {bytecode}, $02
  $A0E5  AC 59 D7                   CALL_abs               $D759 (ui_helper_d759) {bytecode}
 >$A0E8  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
...
; ============================================================
 ...
 >$A12D  8E E9 BC                   PUSH_imm2              $BCE9 (subhandler_A113_data_bce9)
  ...
  $A152  B0                         DEREF
  $A153  B3                         PUSHL
  $A154  E9 57 83 06                CALL_abs_imm1          $8357 (helper_8357) {bytecode}, $06
  ...
  $A16A  D8 AA A1                   JUMPF_abs              $A1AA (calc_fief_harvest_base_term)
  ...
  $A18E  B3                         PUSHL
  $A18F  E9 AC 82 02                CALL_abs_imm1          $82AC (helper_82AC) {bytecode}, $02
  $A193  63                         PUSH_qimm   ; inline operand = 3
  $A194  E9 4E 8A 02                CALL_abs_imm1          $8A4E (helper_8A4E) {bytecode}, $02
 ...
 >$A1A3  E9 C4 CE 02                CALL_abs_imm1          $CEC4 (redraw_window) {bytecode}, $02
  $A1A7  AC 59 D7                   CALL_abs               $D759 (ui_helper_d759) {bytecode}
 >$A1AA  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
...
; ============================================================
  ...
  $A1C1  AC 69 CC                   CALL_abs               $CC69 (trade_helper_cc69) {bytecode}
 ...
 >$A1C8  0B                         LOADL_quick   ; inline operand = 11
  ...
  $A1CD  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  $A1D1  0B                         LOADL_quick   ; inline operand = 11
  $A1D2  D0                         INC
  $A1D3  B3                         PUSHL
  $A1D4  8E 15 BD                   PUSH_imm2              $BD15 (msg_fmt__2d_bd15)
  $A1D7  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
 ...
 >$A1F0  8E 19 BD                   PUSH_imm2              $BD19 (msg_lord_how_may_i_serve_you)
  ...
  $A216  E9 0C E8 02                CALL_abs_imm1          $E80C (ui_helper_e80c) {bytecode}, $02
...
; ============================================================
 ...
 >$A28D  B3                         PUSHL
  ...
  $A296  E9 34 D1 08                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $08
  $A29A  CF                         RETURN
...
; ============================================================
  ...
  $A2CD  E9 4E 8A 02                CALL_abs_imm1          $8A4E (helper_8A4E) {bytecode}, $02
  $A2D1  CF                         RETURN
...
; ============================================================
  ...
  $A2E0  B0                         DEREF
  $A2E1  B3                         PUSHL
  $A2E2  E9 57 83 06                CALL_abs_imm1          $8357 (helper_8357) {bytecode}, $06
  ...
  $A2FC  E9 10 E5 02                CALL_abs_imm1          $E510 (ui_helper_e510) {bytecode}, $02
  ...
  $A328  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
  ...
  $A35B  AC 59 D7                   CALL_abs               $D759 (ui_helper_d759) {bytecode}
 ...
 >$A36C  6C                         PUSH_qimm   ; inline operand = 12
  $A36D  E9 0C E8 02                CALL_abs_imm1          $E80C (ui_helper_e80c) {bytecode}, $02
  ...
  $A37C  8E CF BD                   PUSH_imm2              $BDCF (effect_ninja_sabotage_data_bdcf)
 ...
 >$A3AB  0C                         LOADL_quick   ; inline operand = 12
  ...
  $A3B9  E9 9B A2 04                CALL_abs_imm1          $A29B (effect_hire_pay_gold) {bytecode}, $04
  $A3BD  41                         LOADL_qimm   ; inline operand = 1
  $A3BE  CF                         RETURN
 >$A3BF  8D 1C                      BYTE_PUSH_imm1         +28
  $A3C1  E9 0C E8 02                CALL_abs_imm1          $E80C (ui_helper_e80c) {bytecode}, $02
 ...
 >$A43B  39                         PUSH_quick   ; inline operand = 9
  ...
  $A454  E9 4E 8A 02                CALL_abs_imm1          $8A4E (helper_8A4E) {bytecode}, $02
 ...
 >$A476  27                         STORE_quick   ; inline operand = 7
  ...
  $A47D  E9 9B A2 04                CALL_abs_imm1          $A29B (effect_hire_pay_gold) {bytecode}, $04
  $A481  41                         LOADL_qimm   ; inline operand = 1
  $A482  CF                         RETURN
 >$A483  8D 1B                      BYTE_PUSH_imm1         +27
  $A485  E9 0C E8 02                CALL_abs_imm1          $E80C (ui_helper_e80c) {bytecode}, $02
 ...
 >$A497  0C                         LOADL_quick   ; inline operand = 12
  ...
  $A4A5  E9 9B A2 04                CALL_abs_imm1          $A29B (effect_hire_pay_gold) {bytecode}, $04
  $A4A9  41                         LOADL_qimm   ; inline operand = 1
  $A4AA  CF                         RETURN
 >$A4AB  8D 1E                      BYTE_PUSH_imm1         +30
  $A4AD  E9 0C E8 02                CALL_abs_imm1          $E80C (ui_helper_e80c) {bytecode}, $02
 ...
 >$A529  27                         STORE_quick   ; inline operand = 7
  ...
  $A530  E9 9B A2 04                CALL_abs_imm1          $A29B (effect_hire_pay_gold) {bytecode}, $04
  $A534  41                         LOADL_qimm   ; inline operand = 1
  $A535  CF                         RETURN
 >$A536  8D 1D                      BYTE_PUSH_imm1         +29
  $A538  E9 0C E8 02                CALL_abs_imm1          $E80C (ui_helper_e80c) {bytecode}, $02
 ...
 >$A549  39                         PUSH_quick   ; inline operand = 9
  ...
  $A54B  E9 9B A2 04                CALL_abs_imm1          $A29B (effect_hire_pay_gold) {bytecode}, $04
...
; ============================================================
  ...
  $A569  B0                         DEREF
  $A56A  B3                         PUSHL
  $A56B  E9 57 83 06                CALL_abs_imm1          $8357 (helper_8357) {bytecode}, $06
  ...
  $A59D  E9 FE DF 04                CALL_abs_imm1          $DFFE (update_arms_table_dffe) {bytecode}, $04
  $A5A1  64                         PUSH_qimm   ; inline operand = 4
  $A5A2  E9 4E 8A 02                CALL_abs_imm1          $8A4E (helper_8A4E) {bytecode}, $02
  $A5A6  0C                         LOADL_quick   ; inline operand = 12
  $A5A7  8F 10                      BYTE_ADD_imm1          +16
  $A5A9  B3                         PUSHL
  $A5AA  E9 AC 82 02                CALL_abs_imm1          $82AC (helper_82AC) {bytecode}, $02
  $A5AE  8D 21                      BYTE_PUSH_imm1         +33
  $A5B0  E9 0C E8 02                CALL_abs_imm1          $E80C (ui_helper_e80c) {bytecode}, $02
  ...
  $A5D4  E9 34 D1 06                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $06
...
; ============================================================
  ...
  $A618  E9 51 D3 02                CALL_abs_imm1          $D351 (ui_helper_d351) {bytecode}, $02
...
; ============================================================
 ...
 >$A671  6A                         PUSH_qimm   ; inline operand = 10
  $A672  E9 0C E8 02                CALL_abs_imm1          $E80C (ui_helper_e80c) {bytecode}, $02
 ...
 >$A694  B0                         DEREF
  ...
  $A69E  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
...
; ============================================================
 ...
 >$A6D0  40                         LOADL_qimm   ; inline operand = 0
  ...
  $A6D3  E9 10 E5 02                CALL_abs_imm1          $E510 (ui_helper_e510) {bytecode}, $02
 ...
 >$A713  8E EF FB                   PUSH_imm2              $FBEF (msg_view_which_fief)
  ...
  $A71B  E9 10 E5 02                CALL_abs_imm1          $E510 (ui_helper_e510) {bytecode}, $02
 ...
 >$A72C  41                         LOADL_qimm   ; inline operand = 1
  ...
  $A743  AC 20 CD                   CALL_abs               $CD20 (ui_helper_cd20) {bytecode}
 ...
 >$A753  BB                         ADD
  ...
  $A756  B3                         PUSHL
  $A757  E9 F2 E5 02                CALL_abs_imm1          $E5F2 (map_helper_e5f2) {bytecode}, $02
 ...
 >$A77A  08                         LOADL_quick   ; inline operand = 8
  ...
  $A782  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
 ...
 >$A787  0A                         LOADL_quick   ; inline operand = 10
  ...
  $A7AD  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
 ...
 >$A7C0  AC A7 85                   CALL_abs               $85A7 (tactical_cursor_input_validate_redraw) {bytecode}
 ...
 >$A7C6  6A                         PUSH_qimm   ; inline operand = 10
  ...
  $A7E1  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  ...
  $A7EF  B0                         DEREF
  $A7F0  B3                         PUSHL
  $A7F1  E9 C7 83 02                CALL_abs_imm1          $83C7 (helper_83C7) {bytecode}, $02
 ...
 >$A82B  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
  $A82E  6E                         PUSH_qimm   ; inline operand = 14
  $A82F  E9 0C E8 02                CALL_abs_imm1          $E80C (ui_helper_e80c) {bytecode}, $02
 ...
 >$A843  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
...
; ============================================================
 ...
 >$A87C  0B                         LOADL_quick   ; inline operand = 11
  ...
  $A881  8E 13 BE                   PUSH_imm2              $BE13 (driver_build_data_be13)
  ...
  $A892  E9 34 D1 06                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $06
  ...
  $A8B2  E9 0C E8 02                CALL_abs_imm1          $E80C (ui_helper_e80c) {bytecode}, $02
  ...
  $A8BD  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
...
; ============================================================
  ...
  $A96E  8E 1F BE                   PUSH_imm2              $BE1F (effect_give_b_data_be1f)
  $A971  E9 26 D3 02                CALL_abs_imm1          $D326 (message_display) {bytecode}, $02
  $A975  8E 20 BE                   PUSH_imm2              $BE20 (msg_gold_rice)
  $A978  E9 51 D3 02                CALL_abs_imm1          $D351 (ui_helper_d351) {bytecode}, $02
 ...
 >$A9BB  8E D9 FD                   PUSH_imm2              $FDD9 (msg_you_have_no_gold)
  ...
  $A9C2  8E 2E BE                   PUSH_imm2              $BE2E (effect_give_b_data_be2e)
...
; ============================================================
  ...
  $A9E3  8E 30 BE                   PUSH_imm2              $BE30 (effect_give_c_data_be30)
  $A9E6  E9 26 D3 02                CALL_abs_imm1          $D326 (message_display) {bytecode}, $02
  $A9EA  8E 31 BE                   PUSH_imm2              $BE31 (msg_peasnts_men)
  $A9ED  E9 51 D3 02                CALL_abs_imm1          $D351 (ui_helper_d351) {bytecode}, $02
  $A9F1  2B                         STORE_quick   ; inline operand = 11
  $A9F2  0B                         LOADL_quick   ; inline operand = 11
  $A9F3  D7 FB A9                   JUMPT_abs              $A9FB (combat_command_select_target_resolve_attack)
 ...
 >$AA05  8E FD FD                   PUSH_imm2              $FDFD (msg_you_have_no_soldiers)
  ...
  $AA0C  8E 41 BE                   PUSH_imm2              $BE41 (effect_give_c_data_be41)
...
; ============================================================
 ...
 >$AA8A  3B                         PUSH_quick   ; inline operand = 11
  ...
  $AA94  E9 0C E8 02                CALL_abs_imm1          $E80C (ui_helper_e80c) {bytecode}, $02
...
; ============================================================
  ...
  $AAC6  E9 10 E5 02                CALL_abs_imm1          $E510 (ui_helper_e510) {bytecode}, $02
  ...
  $AAE9  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
...
; ============================================================
 ...
 >$AB29  0B                         LOADL_quick   ; inline operand = 11
  ...
  $AB40  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
 ...
 >$AB59  0B                         LOADL_quick   ; inline operand = 11
  ...
  $AB62  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
  $AB66  0B                         LOADL_quick   ; inline operand = 11
  $AB67  8F 14                      BYTE_ADD_imm1          +20
  $AB69  B3                         PUSHL
  $AB6A  65                         PUSH_qimm   ; inline operand = 5
  $AB6B  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
 ...
 >$AB7E  2A                         STORE_quick   ; inline operand = 10
  ...
  $AB8D  E9 34 D1 06                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $06
  $AB91  8D 19                      BYTE_PUSH_imm1         +25
  $AB93  65                         PUSH_qimm   ; inline operand = 5
  $AB94  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  ...
  $ABA2  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
...
; ============================================================
 ...
 >$ABF6  0A                         LOADL_quick   ; inline operand = 10
  ...
  $AC0B  E9 0C E8 02                CALL_abs_imm1          $E80C (ui_helper_e80c) {bytecode}, $02
...
; ============================================================
 ...
 >$AC68  39                         PUSH_quick   ; inline operand = 9
  ...
  $AC6A  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
 ...
 >$ACC1  60                         PUSH_qimm   ; inline operand = 0
  ...
  $ACC8  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  ...
  $ACD9  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
  $ACDD  8D 19                      BYTE_PUSH_imm1         +25
  $ACDF  6E                         PUSH_qimm   ; inline operand = 14
  $ACE0  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  $ACE4  3B                         PUSH_quick   ; inline operand = 11
  $ACE5  8E 5D BE                   PUSH_imm2              $BE5D
 >$ACE8  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
  $ACEC  39                         PUSH_quick   ; inline operand = 9
  $ACED  64                         PUSH_qimm   ; inline operand = 4
  $ACEE  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
 ...
 >$AD03  B3                         PUSHL
  ...
  $AD28  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  ...
  $AD39  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
  $AD3D  8D 19                      BYTE_PUSH_imm1         +25
  $AD3F  6E                         PUSH_qimm   ; inline operand = 14
  $AD40  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
 ...
 >$AD4B  60                         PUSH_qimm   ; inline operand = 0
  ...
  $AD50  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
 ...
 >$AD5D  60                         PUSH_qimm   ; inline operand = 0
  ...
  $AD62  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
...
; ============================================================
  ...
  $ADE8  E9 0C E8 02                CALL_abs_imm1          $E80C (ui_helper_e80c) {bytecode}, $02
  $ADEC  41                         LOADL_qimm   ; inline operand = 1
  $ADED  CF                         RETURN
 >$ADEE  AC CB 87                   CALL_abs               $87CB (helper_87CB) {bytecode}
...
; ============================================================
 ...
 >$AE78  85 D5                      STORE_near             $D5
  ...
  $AE94  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  $AE98  AA 5F 6F                   PUSH_abs               $6F5F (selected_province_idx)
  $AE9B  E9 6E DB 02                CALL_abs_imm1          $DB6E (draw_window_f706) {bytecode}, $02
...
; ============================================================
 ...
 >$AF26  3C                         PUSH_quick   ; inline operand = 12
  $AF27  E9 F2 E5 02                CALL_abs_imm1          $E5F2 (map_helper_e5f2) {bytecode}, $02
...
; ============================================================
  $AF3D  AC 20 CD                   CALL_abs               $CD20 (ui_helper_cd20) {bytecode}
 ...
 >$AF58  BB                         ADD
  ...
  $AF5B  B3                         PUSHL
  $AF5C  E9 F2 E5 02                CALL_abs_imm1          $E5F2 (map_helper_e5f2) {bytecode}, $02
...
; ============================================================
 ...
 >$AF9C  8E 40 FE                   PUSH_imm2              $FE40 (msg_which_fief_fe40)
  ...
  $AFB7  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
  ...
  $AFC7  AC 69 CC                   CALL_abs               $CC69 (trade_helper_cc69) {bytecode}
 ...
 >$AFCC  09                         LOADL_quick   ; inline operand = 9
  ...
  $AFD1  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  $AFD5  09                         LOADL_quick   ; inline operand = 9
  $AFD6  D0                         INC
  $AFD7  B3                         PUSHL
  $AFD8  8E 98 BE                   PUSH_imm2              $BE98 (msg_fmt__d_be98)
  $AFDB  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
 ...
 >$AFF5  66                         PUSH_qimm   ; inline operand = 6
  ...
  $B019  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
 ...
 >$B023  0B                         LOADL_quick   ; inline operand = 11
  ...
  $B03D  E9 34 D1 06                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $06
  $B041  AC A7 D3                   CALL_abs               $D3A7 (ui_helper_d3a7) {bytecode}
  ...
  $B052  E9 0C E8 02                CALL_abs_imm1          $E80C (ui_helper_e80c) {bytecode}, $02
 ...
 >$B060  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
...
; ============================================================
  ...
  $B075  E9 51 D3 02                CALL_abs_imm1          $D351 (ui_helper_d351) {bytecode}, $02
...
; ============================================================
  ...
  $B0AC  E9 51 D3 02                CALL_abs_imm1          $D351 (ui_helper_d351) {bytecode}, $02
...
; ============================================================
  ...
  $B0EC  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
 ...
 >$B104  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
...
; ============================================================
  ...
  $B115  AC A7 D3                   CALL_abs               $D3A7 (ui_helper_d3a7) {bytecode}
...
; ============================================================
  ...
  $B13A  E9 51 D3 02                CALL_abs_imm1          $D351 (ui_helper_d351) {bytecode}, $02
...
; ============================================================
  ...
  $B157  AC A7 D3                   CALL_abs               $D3A7 (ui_helper_d3a7) {bytecode}
  $B15A  D8 A4 B1                   JUMPF_abs              $B1A4
  $B15D  AC 35 DB                   CALL_abs               $DB35 (ui_helper_db35) {bytecode}
  ...
  $B16A  AC 20 CD                   CALL_abs               $CD20 (ui_helper_cd20) {bytecode}
  $B16D  6E                         PUSH_qimm   ; inline operand = 14
  $B16E  6C                         PUSH_qimm   ; inline operand = 12
  $B16F  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
...
; ============================================================
  ...
  $B1AE  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
 ...
 >$B1DF  60                         PUSH_qimm   ; inline operand = 0
  ...
  $B1E6  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
 ...
 >$B1EC  60                         PUSH_qimm   ; inline operand = 0
  ...
  $B202  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
 ...
 >$B21A  60                         PUSH_qimm   ; inline operand = 0
  ...
  $B231  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
...
; ============================================================
  $B243  AC 69 CC                   CALL_abs               $CC69 (trade_helper_cc69) {bytecode}
 ...
 >$B248  09                         LOADL_quick   ; inline operand = 9
  ...
  $B24D  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  $B251  09                         LOADL_quick   ; inline operand = 9
  $B252  D0                         INC
  $B253  B3                         PUSHL
  $B254  8E 71 BF                   PUSH_imm2              $BF71 (msg_fmt__2d_bf71)
  $B257  E9 34 D1 04                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $04
...
; ============================================================
  ...
  $B2C8  BB                         ADD
  $B2C9  B3                         PUSHL
  $B2CA  AC 12 DB                   CALL_abs               $DB12 (tax_helper_db12) {bytecode}
...
; ============================================================
 ...
 >$B367  AC 2B B3                   CALL_abs               $B32B (rng_threshold_10_29) {bytecode}
  ...
  $B380  B0                         DEREF
  $B381  B3                         PUSHL
  $B382  E9 57 83 06                CALL_abs_imm1          $8357 (helper_8357) {bytecode}, $06
  ...
  $B39F  E9 4E 8A 02                CALL_abs_imm1          $8A4E (helper_8A4E) {bytecode}, $02
...
; ============================================================
  ...
  $B48E  E9 7D 88 04                CALL_abs_imm1          $887D (helper_dam_rounding) {bytecode}, $04
...
; ============================================================
 ...
 >$B4E2  40                         LOADL_qimm   ; inline operand = 0
  ...
  $B539  B6                         SDIV
  $B53A  B3                         PUSHL
  $B53B  E9 57 83 06                CALL_abs_imm1          $8357 (helper_8357) {bytecode}, $06
 ...
 >$B571  0B                         LOADL_quick   ; inline operand = 11
  ...
  $B5E7  B3                         PUSHL
  $B5E8  E9 AC 82 02                CALL_abs_imm1          $82AC (helper_82AC) {bytecode}, $02
  $B5EC  63                         PUSH_qimm   ; inline operand = 3
  $B5ED  E9 4E 8A 02                CALL_abs_imm1          $8A4E (helper_8A4E) {bytecode}, $02
...
; ============================================================
  ...
  $B6BC  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
 ...
 >$B6F9  60                         PUSH_qimm   ; inline operand = 0
  ...
  $B700  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
 ...
 >$B719  67                         PUSH_qimm   ; inline operand = 7
  ...
  $B71C  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
 ...
 >$B729  67                         PUSH_qimm   ; inline operand = 7
  ...
  $B72C  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
 ...
 >$B734  A4 E2 7B                   LOADL_abs              $7BE2 (fief_menu_info_mode_flag)
  ...
  $B73E  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
 ...
 >$B746  6F                         PUSH_qimm   ; inline operand = 15
  ...
  $B749  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
...
; ============================================================
  ...
  $B7B1  D3                         BYTE_DEREF
  $B7B2  D8 DA B7                   JUMPF_abs              $B7DA (msg_congratulations_my_lord_b7da)
  ...
  $B7C3  AC 59 D7                   CALL_abs               $D759 (ui_helper_d759) {bytecode}
 ...
 >$B7DA  AC A7 85                   CALL_abs               $85A7 (tactical_cursor_input_validate_redraw) {bytecode}
 ...
 >$B7E8  07                         LOADL_quick   ; inline operand = 7
  ...
  $B7EF  AC A7 85                   CALL_abs               $85A7 (tactical_cursor_input_validate_redraw) {bytecode}
 >$B7F2  AC 89 CC                   CALL_abs               $CC89 (ui_helper_cc89) {bytecode}
 ...
 >$B839  0B                         LOADL_quick   ; inline operand = 11
  ...
  $B843  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
 ...
 >$B855  0B                         LOADL_quick   ; inline operand = 11
  ...
  $B85A  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  ...
  $B866  E9 A2 83 04                CALL_abs_imm1          $83A2 (calc_tactical_cell_coords) {bytecode}, $04
...
; ============================================================
  ...
  $B8A7  D6 9E B9                   JUMP_abs               $B99E (announce_combat_side_dai_data_b99e)
 >$B8AA  89 FE                      BYTE_LOADL_imm1        -2
  ...
  $B8D2  E9 72 D9 02                CALL_abs_imm1          $D972 (war_helper_d972) {bytecode}, $02
 ...
 >$B8EE  AC 28 D6                   CALL_abs               $D628 (count_6da2_set) {bytecode}
  ...
  $B8F4  AC 82 D9                   CALL_abs               $D982 (get_6e09) {bytecode}
 ...
 >$B90E  40                         LOADL_qimm   ; inline operand = 0
  ...
  $B91F  E9 7B CC 04                CALL_abs_imm1          $CC7B (ui_helper_cc7b) {bytecode}, $04
  ...
  $B92C  E9 34 D1 06                CALL_abs_imm1          $D134 (ui_helper_d134) {bytecode}, $06
 ...
 >$B98D  A4 79 6F                   LOADL_abs              $6F79 (ai_turn_loop_redispatch_flag)
  ...
  $B999  D6 A7 B9                   JUMP_abs               $B9A7 (msg_fmt_blank_b9a7)
