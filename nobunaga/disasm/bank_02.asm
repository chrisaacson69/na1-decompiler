...
tab_b2_b36f: ; 94 bytes
            ...
            hex 6e 00 00 ; ror $0000    ; 0B99B:  6e 00 00
            brk                         ; 0B99E:  00
            hex 00                      ; 0B99F:  00
