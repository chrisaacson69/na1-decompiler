...
def main():
    ...
    ap.add_argument("--out", default=str(ROOT / "decompiled" / "all_banks.c"),
                    help="output path (default: decompiled/all_banks.c)")
    args = ap.parse_args()
    decompile_all = _load("decompile_all", "decompile-all.py")
