...
def decompile(filepath, sub_addr, labels=None, var_names=None, collect=None):
    ...
    from na1dream import vm_cfg as _vmcfg
    ...
    if STRUCTURE and STRUCTURE_DREAM:
        ...
        from na1dream import vm_cfg as _vc
...
def main():
    ...
    labels = None
    try:
        from na1dream.nobunaga_vm import load_labels
        labels = load_labels()
    except Exception:
        pass
