// ============================================================
// decompiled/bank_01.v2.c  —  GENERATED by tools/decompile-all.py  (--v2: region-reducer structurer, NOT canonical until cutover)
...
word prompt_message_and_redraw(word prompt_id, word message_ptr) {
    ...
    if ((prompt_id == 255)) {    // $8014
        ...
        return redraw_window(prompt_message_and_redra_data_ba12);    // $8017
    } else {
        ...
        return redraw_window(prompt_message_and_redra_data_ba12);    // $8033
    }
...
word relations_matrix_get(word party_a, word party_b, word order_flag) {
    if ((((unsigned)party_a < (unsigned)party_b) ^ order_flag)) {    // $825A
        return *(byte*)((((party_b * 54) + party_a) + 0x6193));    // $825D
    } else {
        return *(byte*)((((party_b * 54) + party_a) + 0x6193));    // $8265
    }
...
word relations_rng_predicate(word arg1, word arg2) {
    return (((unsigned)rng_mod(100) < (unsigned)relations_matrix_get(ui_helper_d772(arg1), ui_helper_d772(arg2), 1)) || ((unsigned)rng_mod(100) < (unsigned)relations_matrix_get(arg1, arg2, 0)));    // $8276
}
...
word province_window_redraw_ba6f(word arg1, word arg2) {
    if ((province_ai_state[arg1] != 255)) {    // $83B1
        ...
        return redraw_window(province_window_redraw_data_ba6f);    // $83B4
    } else {
        return redraw_window(province_window_redraw_data_ba6f);    // $83BF
    }
...
word province_window_redraw_ba78(word arg1, word arg2) {
    if ((province_ai_state[arg1] != 255)) {    // $83E4
        ...
        return redraw_window(province_window_redraw_data_ba78);    // $83E7
    } else {
        return redraw_window(province_window_redraw_data_ba78);    // $83F2
    }
...
L_84B5:
    phi_84c6 = msg_home_fief;    // $84B5
    goto L_84C6;    // $84B6
L_84B9:
    if (local6) goto L_84B2;    // $84BA
    goto L_84B5;    // $84C0
L_84C3:
    phi_84c6 = msg_empty;    // $84C3
L_84C6:
    redraw_window(phi_84c6);    // $84C6
...
L_8511:
    ...
    } while (((unsigned)local11 < (unsigned)18));    // $855B
    if (local8) {    // $8566
...
word view_window_redraw_by_6da2_flag(word arg1) {
    ...
    if (!(fief_is_daimyo_capital[arg1])) return redraw_window(*(word*)(((get_province_ai_state(arg1) << 1) + view_window_redraw_by_6d_data_fee9)));    // $85C3
...
word effect_view_b(void) {
    local11 = 0x6F89;    // $85F2
    while (((unsigned)local8 < (unsigned)scenario_fief_count)) {    // $8615
...
word province_select_helper(word arg1, word arg2) {
    if (!(count_eligible_targets(arg1, arg2, 0))) {    // $87AB
...
word effect_dam(word fief) {
    if (fief->output) return sqrt_int(fief->output);    // $87E0
    return 0x2710;    // $87E3
}
...
word effect_trade(void) {
    if ((((scenario_fief_count == 50) ? 30 : 13) == selected_province_idx)) return 1;    // $8A2D
    if (!((((scenario_fief_count == 50) ? 32 : 14) == selected_province_idx))) return (ai_turn_flags & 1);    // $8A43
    return 1;    // $8A46
}
...
L_8AAE:
            ...
            goto L_8A93;    // $8AB9
        case 1:
            if (!((gold_rice_exchange_rate <= 1))) goto L_8ACB;    // $8AC1
            goto L_8ACC;    // $8AC8
L_8ACB:
L_8ACC:
            goto L_8AAE;    // $8AD1
...
word helper_8B8F(word arg1) {
    ...
    if ((audio_wait_gate != 1)) return call_bank10_entry(1);    // $8BAE
    do {    // $8BB1
...
word random_daimyo_stat_increment(void) {
    if (get_province_ai_state(selected_province_idx)) return 255;    // $8C74
    if (rng_mod(10)) return 255;    // $8C7C
    local11 = selected_province_daimyo_record();    // $8C82
    *(byte*)(((rng_mod(5) + local11) + 1)) = (*(byte*)(((rng_mod(5) + local11) + 1)) + 2);    // $8C90
    if (!((*(byte*)((local11 + 1)) >= 200))) return 255;    // $8C98
...
word effect_move(word amount) {
    ...
    do {    // $8CC8
        ...
        *(word*)(target_stat_ptr) = scaled_transfer_da24(*(word*)(target_stat_ptr), *(word*)(((donor_stat_ptr + 2) + -2)), amount, *(word*)(target), *(word*)((target + 8)));    // $8CDF
        ...
        i = (i + 1);    // $8CE5
    } while (((unsigned)i < (unsigned)3));    // $8CC8
...
word bribe_success_check(word arg1, word arg2) {
    ...
    if ((local11 <= local10)) return 0;    // $8D3E
...
word resolve_siege_assault_outcome(void) {
    ...
    if (((unsigned)defender_strength < (unsigned)attacker_strength)) {    // $8EDA
...
L_8FA1:
    ...
    switch (outcome_code) {    // $8FBE
        case 65535:
            phi_8fd0 = selected_province_idx;    // $8FCD
L_8FD0:
            prompt_helper_e275(phi_8fd0);    // $8FD0
            break;    // $8FD0
        case 65536:
            phi_8fd0 = battle_defending_province;    // $8FD8
            goto L_8FD0;    // $8FDB
        case 65537:
            phi_8fed = 0xBB49;    // $8FEA
            message_display(((attacker_name_idx * 9) + 0x77A8));    // $8FE6
L_8FED:
            redraw_window(phi_8fed);    // $8FED
            confirm_prompt();    // $8FF1
            break;    // $8FF4
        case 65538:
            phi_8fed = 0xBB58;    // $9003
...
L_9260:
    ...
    phi_9284 = msg_counterattacked;    // $927B
    goto L_9284;    // $927E
L_9281:
    phi_9284 = msg_enemy_morale_is_falling_to_pie;    // $9281
L_9284:
    redraw_window(phi_9284);    // $9284
    confirm_prompt();    // $9288
...
word war_prep_clamp_depleted_field_notify(word arg1, word arg2, word arg3) {
    if (!((*(word*)(arg3) <= 0))) return *(word*)(arg3);    // $930A
    *(word*)(arg3) = 0;    // $930F
    if (!(get_province_ai_state(arg2))) return *(word*)(arg3);    // $9315
    message_display(arg1);    // $9319
    confirm_prompt();    // $931D
    return *(word*)(arg3);    // $9318
}
...
word effect_war_combat_prep_d(word fief) {
    ...
    if (!(war_helper_d972(fief))) return is_too_weak;    // $9373
    redraw_window(msg_lord_you_are_too_weak_for_batt);    // $9379
    confirm_prompt();    // $937D
    return is_too_weak;    // $9376
}
...
word fief_men_if_provisioned(word arg1) {
    ...
    if (*(word*)((local11 + 6))) return *(word*)((local11 + 16));    // $9393
    return 0;    // $9396
}
...
word pick_ai_attack_target_fief(word fief_list) {
    ...
    while ((*(byte*)(fief_list) != 255)) {    // $9452
        if (get_province_ai_state(target_fief)) {    // $9433
            if (!(ai_relations_and_low_drive_skip_gate(target_fief))) {    // $943B
...
word ai_try_war_attack(void) {
    ...
    if ((target_idx == 30)) {    // $954B
        if ((*(byte*)((selected_province_daimyo_record() + 2)) < (rng_mod(80) + 90))) return 0;    // $955E
    }
    if (!(get_province_ai_state(target_idx))) {    // $9566
        if (!(rng_mod(2))) return 0;    // $956E
    }
    if (!(do_attack)) return 0;    // $9572
...
word effect_train(void) {
    ...
    *(word*)(skill_field) = (*(word*)(skill_field) + (((rng_mod(20) + 10) << 1) << 1));    // $95A9
    if (!(((*(byte*)((daimyo + 5)) + *(byte*)((daimyo + 3))) > (rng_mod(10) + 90)))) return 11;    // $95BD
...
word ai_develop_grow_if_men_exceeds_gold(void) {
    ...
    result = 0;    // $95EA
    if (!(((*(word*)(fief) - *(word*)((fief + 16))) >= 1))) return result;    // $95F6
    ...
    if ((*(word*)((((selected_province_idx * 26) + 0x7001) + 16)) > 8)) {    // $9635
        ...
        do {    // $9640
            *(byte*)((i + &arms_buf)) = 5;    // $964A
            i = (i + 1);    // $964E
        } while (((unsigned)i < (unsigned)5));    // $9640
        i = 0;    // $9658
        do {    // $965A
            *(byte*)((rng_mod(5) + &arms_buf)) = (*(byte*)((rng_mod(5) + &arms_buf)) + 5);    // $966A
            i = (i + 1);    // $966E
        } while (((unsigned)i < (unsigned)5));    // $965A
...
word driver_move(void) {
    ...
    if (!(province_select_helper(1, deduped_owner_list))) return 0;    // $96F5
    redraw_window(msg_move_where);    // $96FB
    battle_defending_province = province_select_prompt(deduped_owner_list);    // $9706
    if (!(province_select_prompt(deduped_owner_list))) return 0;    // $9709
    ...
    if (local10) {    // $9743
        ...
        if (!(number_input(1, local10))) return 0;    // $9754
        if (fief_is_daimyo_capital[selected_province_idx]) {    // $975F
            if (!(effect_war_combat_prep_d(selected_province_idx))) {    // $9769
...
word relations_roll_vs_owner(word arg1, word arg2) {
    if (arg2) {    // $97F7
        return ((unsigned)relations_matrix_get(selected_province_idx, arg1, arg2) > (unsigned)ui_helper_d77e());    // $97FA
    } else {
        return ((unsigned)relations_matrix_get(selected_province_idx, arg1, arg2) > (unsigned)ui_helper_d77e());    // $9808
    }
...
word effect_war_e(word relation_flags_out) {
    ...
    while ((*(byte*)(owner_cursor) != 255)) {    // $9846
        ...
        if (!(relations_roll_vs_owner(*(byte*)(owner_cursor), 0))) {    // $9834
        } else {
        }
...
word driver_war(void) {
    ...
    if (fief_is_daimyo_capital[local9]) {    // $985F
        if (effect_war_combat_prep_d(local9)) return 0;    // $9867
    }
    if (!(effect_war_combat_prep_c(local9))) return 0;    // $9871
    if (!(effect_war_combat_prep_a(local9))) return 0;    // $9879
    if (!(effect_war_combat_prep_b(local9))) return 0;    // $9881
    combat_helper_dad7();    // $9884
    combat_helper_dd3a(0, deduped_owner_list);    // $988B
    effect_war_e(&local1);    // $9893
    if (!(province_select_helper(2, deduped_owner_list))) return 0;    // $989F
    redraw_window(msg_attack_where);    // $98A5
    battle_defending_province = province_select_prompt(deduped_owner_list);    // $98B0
    if (!(province_select_prompt(deduped_owner_list))) return 0;    // $98B3
    ui_helper_cc89();    // $98B6
    ...
    if (candidate_list_6f4f_lookup(battle_defending_province, &local1)) {    // $98CB
        ...
        if (!(number_input(1, local10))) return 0;    // $9916
        ...
        if (!(number_input(1, min_word(*(word*)((local11 + 6)), war_attacker_men)))) return 0;    // $9934
...
word driver_tax(void) {
    ...
    if (!(number_input(1, (tax_helper_db12() ? 30 : 100)))) return 0;    // $99E0
    if (!((*(byte*)(local6) != local5))) return 0;    // $99E7
    if ((local5 > *(byte*)(local6))) {    // $99F0
        phi_9a08 = msg_the_peasants_are_protesting;    // $99F9
        ui_helper_e80c(19);    // $99F5
    } else {
        phi_9a08 = msg_the_peasants_are_delighted;    // $9A05
        ui_helper_e80c(18);    // $9A01
    }
    message_display(phi_9a08);    // $9A08
    local7 = (((*(byte*)(local6) - local5) > 0) ? 1 : -1);    // $9A1B
    if ((local7 != 1)) goto L_9A2D;    // $9A20
    if (!((*(byte*)((selected_province_daimyo_record() + 4)) < 1))) {    // $9A2A
L_9A2D:
...
word driver_dam(void) {
    if (!(*(word*)(((selected_province_idx * 26) + 0x7009)))) {    // $9B8E
        ...
        if ((*(word*)(local10) >= 100)) {    // $9BAF
            ...
            if (!(*(word*)(local8))) {    // $9BC0
                ...
                if (!(number_input(1, local11))) return 1;    // $9C05
                *(word*)(local8) = (*(word*)(local8) - local9);    // $9C0E
                local9 = ((local9 << 1) / effect_dam(local8));    // $9C19
                if (!(((local9 << 1) / effect_dam(local8)))) {    // $9C1A
...
word driver_grow(void) {
    ...
    if ((*(word*)((local11 + 24)) <= *(word*)((local11 + 8)))) {    // $9D57
        ...
        if (*(word*)(local11)) {    // $9D68
            ...
            if (!(number_input(1, *(word*)(local11)))) return 0;    // $9D89
...
word driver_marry(void) {
    ...
    *(word*)(((battle_defending_province * 26) + 0x7001)) = (*(word*)(((battle_defending_province * 26) + 0x7001)) + local11);    // $9E9A
    goto L_9EAB;    // $9E9B
L_9E9E:
    phi_9ea7 = msg_you_have_no_gold;    // $9E9E
    goto L_9EA7;    // $9EA1
L_9EA4:
    phi_9ea7 = msg_don_t_you_long_to_hear_the_pit;    // $9EA4
L_9EA7:
    message_display(phi_9ea7);    // $9EA7
L_9EAB:
    confirm_prompt();    // $9EAB
...
L_9FEC:
    ...
    return 0;    // $9FF0
L_9FF1:
    phi_9ffa = msg_no_gold;    // $9FF1
    goto L_9FFA;    // $9FF4
L_9FF7:
    phi_9ffa = msg_debt_what_debt;    // $9FF7
L_9FFA:
    redraw_window(phi_9ffa);    // $9FFA
    confirm_prompt();    // $9FFE
    return 0;    // $A002
}
...
word subhandler_A003(word arg1) {
    ...
    return 1;    // $A052
L_A053:
    phi_a05c = msg_treasury_full;    // $A053
    goto L_A05C;    // $A056
L_A059:
    phi_a05c = msg_no_rice;    // $A059
L_A05C:
    redraw_window(phi_a05c);    // $A05C
    ui_helper_d759();    // $A060
L_A063:
    ui_helper_cc89();    // $A063
    return 0;    // $A067
...
word subhandler_A068(word arg1) {
    ...
    *(word*)(arg1) = (*(word*)(arg1) - math32_muladddiv(gold_rice_exchange_rate, local10));    // $A0C1
    ...
    return 1;    // $A0D7
L_A0D8:
    phi_a0e1 = msg_storehouse_full;    // $A0D8
    goto L_A0E1;    // $A0DB
L_A0DE:
    phi_a0e1 = msg_sorry_no_credit;    // $A0DE
L_A0E1:
    redraw_window(phi_a0e1);    // $A0E1
    ui_helper_d759();    // $A0E5
L_A0E8:
    ui_helper_cc89();    // $A0E8
    return 0;    // $A0EC
...
word effect_subhandler_A113(word fief, word amount) {
    ...
    if (divisor) return (amount / divisor);    // $A10A
    divisor = 1;    // $A10E
    return (amount / divisor);    // $A10D
}
...
L_A12D:
    ...
    *(word*)(arg1) = (*(word*)(arg1) - math32_muladddiv(arms_buy_price_rate, local10));    // $A17B
    ...
    return 1;    // $A199
L_A19A:
    phi_a1a3 = msg_armory_full;    // $A19A
    goto L_A1A3;    // $A19D
L_A1A0:
    phi_a1a3 = msg_we_merchants_deal_only_in_cash;    // $A1A0
L_A1A3:
    redraw_window(phi_a1a3);    // $A1A3
    ui_helper_d759();    // $A1A7
L_A1AA:
    ui_helper_cc89();    // $A1AA
    return 0;    // $A1AE
...
word report_fief_stat_decline(word arg1, word arg2) {
    if ((arg1 == 7)) {    // $A27D
        return ui_helper_d134(msg_fief_d_s_s_has_declined_by_d, (battle_defending_province + 1), *(word*)(((arg1 << 1) + effect_view_a_data_f8ae)), arg2);    // $A280
    } else {
        return ui_helper_d134(msg_fief_d_s_s_has_declined_by_d, (battle_defending_province + 1), *(word*)(((arg1 << 1) + effect_view_a_data_f8ae)), arg2);    // $A286
    }
...
word effect_hire_variant_pay(word fief) {
    ...
    if (helper_8357(*(word*)(fief), gold_men_hire_rate, (fief->header - fief->men))) {    // $A570
        message_display(msg_how_many);    // $A576
        amount = number_input(1, max_affordable);    // $A580
        if (!(number_input(1, max_affordable))) return 0;    // $A581
...
word driver_hire(void) {
    if (!(effect_war_combat_prep_c(selected_province_idx))) return 0;    // $A600
...
word driver_build(void) {
    ...
    if ((*(word*)((local11 + 24)) <= *(word*)((local11 + 4)))) {    // $A86D
        ...
        if (*(word*)(local11)) {    // $A87E
            ...
            if (!(number_input(1, *(word*)(local11)))) return 0;    // $A89F
...
word give_transfer_apply(word arg1, word arg2, word arg3) {
    ...
    if (!(number_input(1, *(word*)(local11)))) return 0;    // $A8F5
...
L_A98D:
    ...
    phi_a9a6 = msg_you_have_no_gold;    // $A99D
    goto L_A9A6;    // $A9A0
L_A9A3:
    phi_a9a6 = msg_you_have_no_rice;    // $A9A3
L_A9A6:
    message_display(phi_a9a6);    // $A9A6
    confirm_prompt();    // $A9AA
    return 0;    // $A9AE
L_A9AF:
...
L_A9F7:
            ...
            if ((local11 != 2)) return local11;    // $A9FE
            goto L_A9F7;    // $AA01
        }
    } else {
...
word driver_give(void) {
    ...
    if (!(effect_give_c(local9))) return 0;    // $AA3B
    if (!((local10 & local11))) {    // $AA41
        local10 = (local10 - 1);    // $AA46
        if ((local10 - 1)) {    // $AA47
            phi_aa53 = msg_you_have_no_peasants;    // $AA4A
        } else {
            phi_aa53 = msg_you_have_no_soldiers;    // $AA50
        }
        message_display(phi_aa53);    // $AA53
        confirm_prompt();    // $AA57
        return 0;    // $AA5B
    } else {
        if ((local11 == 1)) {    // $AA64
        ...
        if ((*(word*)((local9 + 18)) >= *(word*)((local9 + 24)))) {    // $AA7B
            ...
            if (!(effect_give_b(local9, local11))) return 0;    // $AA90
...
word driver_bribe(void) {
    ...
    if ((*(word*)(local11) > 10)) {    // $AAC2
        ui_helper_e510(0);    // $AAC6
        if (!(province_select_helper(15, 0x6F89))) return 0;    // $AAD2
        redraw_window(msg_bribe_which);    // $AAD8
        battle_defending_province = province_select_prompt(0x6F89);    // $AAE3
        if (!(province_select_prompt(0x6F89))) return 0;    // $AAE6
        ui_helper_cc89();    // $AAE9
        ...
        if (!(number_input(1, (*(word*)(local11) + -10)))) return 0;    // $AB05
...
word driver_assign(void) {
    ...
    if ((*(word*)((local11 + 16)) <= 0)) {    // $AD7D
        ...
        if ((*(word*)(local11) >= 30)) {    // $AD91
            if (!(effect_assign(30))) return 0;    // $AD9A
...
word subhandler_B109(void) {
    ...
    if (!(ui_helper_d3a7())) return 0;    // $B118
...
word subhandler_B14B(void) {
    ...
    if (!(ui_helper_d3a7())) return 0;    // $B15A
    ui_helper_db35();    // $B15D
...
word ai_calc_men_surplus_over_gold_and_rice(word out_gold_surplus, word out_rice_surplus) {
    ...
    *(word*)(out_rice_surplus) = (*(word*)((fief + 6)) - *(word*)((fief + 16)));    // $B315
    ...
    if (!((*(word*)(out_rice_surplus) < 0))) return 0;    // $B324
...
word ai_province_gold_to_rice_convert(word gold_surplus_ptr, word rice_surplus_ptr) {
    ...
    if (((unsigned)rng_threshold_10_29() < (unsigned)gold_rice_exchange_rate)) {    // $B358
        ...
        return ai_calc_men_surplus_over_gold_and_rice(gold_surplus_ptr, rice_surplus_ptr);    // $B35B
    } else {
        if (!(((unsigned)rng_threshold_10_29() > (unsigned)gold_rice_exchange_rate))) return ai_calc_men_surplus_over_gold_and_rice(gold_surplus_ptr, rice_surplus_ptr);    // $B36E
        ...
        *(word*)((fief + 6)) = (*(word*)((fief + 6)) + rice_gain);    // $B39D
        helper_8A4E(2);    // $B39F
        return ai_calc_men_surplus_over_gold_and_rice(gold_surplus_ptr, rice_surplus_ptr);    // $B371
    }
...
word ai_econ_command_dispatch(void) {
    ...
    if (fief_is_daimyo_capital[selected_province_idx]) {    // $B676
        if (!(get_province_ai_state(selected_province_idx))) {    // $B680
            if (!(*(word*)((fief + 16)))) {    // $B687
                *(word*)((fief + 16)) = 2;    // $B68F
    ...
    if (!(rng_mod(10))) return ai_develop_dam_and_grow();    // $B6AA
    ai_develop_town_handler();    // $B6AD
    return ai_develop_dam_and_grow();    // $B6AD
}
...
word issue_province_command(word fief) {
    ...
    if (*(byte*)(rest_turns_ptr)) {    // $B7B2
        if (!(fief_is_daimyo_capital[fief])) return ((unsigned)i < (unsigned)18);    // $B7BB
        ...
        *(byte*)((fief_to_daimyo_record_addr(fief) + 1)) = (*(byte*)((fief_to_daimyo_record_addr(fief) + 1)) + 4);    // $B7D6
        return ((unsigned)i < (unsigned)18);    // $B7BE
    } else {
        effect_view_c();    // $B7DA
        ...
        if ((command == 1)) return ((unsigned)i < (unsigned)18);    // $B818
        if ((command == 20)) return ((unsigned)i < (unsigned)18);    // $B81F
        ...
        do {    // $B839
            ...
            i = (i + 1);    // $B86C
        } while (((unsigned)i < (unsigned)18));    // $B86A
    }
...
word ai_econ_action_state0(void) {
    ...
    if (rng_mod(4)) return (*(word*)((fief + 22)) + 1);    // $B890
    *(word*)((fief + 22)) = (*(word*)((fief + 22)) + 1);    // $B899
    return (*(word*)((fief + 22)) + 1);    // $B893
}
