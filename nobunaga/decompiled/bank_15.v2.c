// ============================================================
// decompiled/bank_15.v2.c  —  GENERATED by tools/decompile-all.py  (--v2: region-reducer structurer, NOT canonical until cutover)
...
word rng_mod(word arg1) {
    if ((arg1 >= 1)) return (rng_next_wrapper() % arg1);    // $CA5A
    return 0;    // $CA5D
}
...
word is_digit(word arg1) {
    return (((unsigned)48 <= (unsigned)arg1) && ((unsigned)arg1 <= (unsigned)57));    // $CA6A
}
...
word is_lower(word arg1) {
    return ((97 <= *(byte*)&arg1) && (*(byte*)&arg1 <= 122));    // $CB16
}
...
word min_word(word arg1, word arg2) {
    return ((arg1 < arg2) ? arg1 : arg2);    // $CB63
}
...
word max_word(word arg1, word arg2) {
    return ((arg1 > arg2) ? arg1 : arg2);    // $CB74
}
...
word ui_helper_cc89(void) {
    ...
    return ui_helper_cc7b(2, (ui_msg_col_shift_flag ? 20 : 22));    // $CCA0
}
...
word get_6f5d_or_ff(void) {
    ...
    if ((selected_record_idx_9e3c == 255)) return 255;    // $CD10
...
word ui_helper_cd20(void) {
    ...
    if (ui_pending_flag_7fc7) {    // $CD52
        ...
        } while (((unsigned)local11 < (unsigned)4));    // $CD57
...
word ui_get_menu_count_7fcf(void) {
    ...
    if (!(((unsigned)(ui_cursor_row + 1) > (unsigned)27))) return 3;    // $CDC2
...
word char_advance_width(word arg1) {
    ...
    *(byte*)&arg1 = char_classify(*(byte*)&arg1);    // $CE9A
    ...
    if (!(((unsigned)(ui_window_col + 1) > (unsigned)31))) return ui_get_menu_count_7fcf();    // $CEBD
    return ui_get_menu_count_7fcf();    // $CEC0
}
...
L_CF27:
    ...
    if ((local11 == ui_window_col)) return ppu_blit_from_bank_wrap(local11, ui_cursor_row, (ui_window_col - 1), ui_cursor_row, &tile_buf, 4);    // $CF37
    return ppu_blit_from_bank_wrap(local11, ui_cursor_row, (ui_window_col - 1), ui_cursor_row, &tile_buf, 4);    // $CF3A
...
L_D16B:
    ...
    if ((ui_timer_gate_flag_7fe7 == 2)) return syscall_read_controller(local11);    // $D1B2
    frame_counter = (frame_counter - 1);    // $D1B9
    switch ((frame_counter - 1)) {    // $D1BC
    case 100: goto L_D252;    // $D1BC
    case 0: goto L_D270;    // $D1BC
...
word select_province_by_cursor(word arg1, word arg2) {
    ...
    while (1) {    // $D5B0
        ...
        if ((local7 <= 0)) break;    // $D5D8
        if (!((local7 >= arg1))) continue;    // $D5DE
        if ((local7 <= arg2)) break;    // $D5E4
    }
    return local7;    // $D5E8
}
...
word number_input(word arg1, word arg2) {
    ...
    if ((local11 <= 0)) return local11;    // $D601
    ui_helper_cc89();    // $D604
    return local11;    // $D604
}
...
word pct_op(word arg1, word arg2) {
    if ((arg2 != 100)) return (((((arg2 % 10) * (arg1 / 10)) / 10) + (((arg1 % 10) * arg2) / 100)) + ((arg2 / 10) * (arg1 / 10)));    // $D716
    return arg1;    // $D719
}
...
word province_clear_fields_d7f7(word arg1) {
    ...
    if (*(word*)((local11 + 8))) return 0;    // $D808
...
word record_grow_capped_d8f2(word arg1, word arg2) {
    ...
    if (!((local11 > (arg1->header - arg1->loyalty)))) return local11;    // $D912
    return local10;    // $D915
}
...
word record_grow_capped_d919(word arg1, word arg2) {
    ...
    if (!((local11 > (arg1->header - arg1->wealth)))) return local11;    // $D939
    return local10;    // $D93C
}
...
word tax_helper_db12(void) {
    if ((scenario_fief_count != 17)) return (ui_helper_d772(battle_defending_province) == 20);    // $DB1D
    return (ui_helper_d772(battle_defending_province) == 3);    // $DB20
}
...
word ui_helper_db35(void) {
    ...
    if (!(get_6e09())) return set_6da1_bit7();    // $DB44
    return set_6da1_bit7();    // $DB47
}
...
word draw_owner_name(word arg1) {
    if ((province_ai_state[arg1] == 255)) return redraw_window(((ui_helper_d772(arg1) * 9) + 0x77A8));    // $DB5A
    return redraw_window(((ui_helper_d772(arg1) * 9) + 0x77A8));    // $DB5D
}
...
L_DCB7:
    ...
    *(byte*)((local9 + 1)) = 0;    // $DCFB
    local8 = 0;    // $DCFD
    phi_val_dd1c = 0;    // $DCFF
    while (((unsigned)local11 < (unsigned)scenario_fief_count)) {    // $DD1C
        if (!(strcmp(&name_buf, ((local11 * 9) + 0x77A8)))) {    // $DD12
            local8 = 1;    // $DD16
            break;    // $DD15
        }
...
word combat_helper_dd3a(word match_enemy, word out_list) {
    ...
    while ((*(byte*)(src_ptr) != 255)) {    // $DD67
        if (!((is_enemy_owned(*(byte*)(src_ptr)) ^ match_enemy))) {    // $DD50
            if (!(province_state_is_FF(*(byte*)(src_ptr)))) {    // $DD5A
...
word reassign_fiefs_to_conqueror(void) {
    ...
    while (((unsigned)local11 < (unsigned)scenario_fief_count)) {    // $DF33
        if ((ui_helper_d772(local11) == local9)) {    // $DEFD
            if (!(province_state_is_FF(local11))) {    // $DF05
...
word transfer_force_triplet(void) {
    ...
    } while (((unsigned)local8 < (unsigned)3));    // $DF94
...
word update_arms_table_dffe(word arg1, word arg2) {
    ...
    if (!(((unsigned)*(byte*)(((arg1 * 5) + 0x76AB)) > (unsigned)local11))) return local11;    // $E017
...
L_E120:
            ...
            if (local8) {    // $E125
                if (fief_is_daimyo_capital[battle_defending_province]) {    // $E130
                    ...
                    while (((unsigned)local11 < (unsigned)scenario_fief_count)) {    // $E165
                        if ((ui_helper_d772(local11) == *(byte*)(local10))) {    // $E14F
    ...
    if (local8) return cap_fief_stats(selected_province_idx);    // $E1DC
    return cap_fief_stats(selected_province_idx);    // $E1DF
}
...
word prompt_helper_e275(word arg1) {
    ...
    if (!(get_province_ai_state(arg1))) return confirm_prompt();    // $E29B
    ui_helper_d134(msg_in_fief_2d_in_the_year_d, (arg1 + 1), current_game_year);    // $E2A7
    return confirm_prompt();    // $E29E
}
...
L_E35B:
        ...
        if (rng_mod(const_two)) return 0;    // $E368
        if (!(war_helper_d972(selected_province_idx))) goto L_E37D;    // $E372
        if (rng_mod(3)) return 0;    // $E37A
L_E37D:
        local10 = *(word*)(((selected_province_idx * 26) + 0x7001));    // $E388
        if (!((*(word*)(((selected_province_idx * 26) + 0x7001)) > 200))) return 0;    // $E38D
        return (pct_op(local10, (rng_mod(30) + 50)) + 200);    // $E390
    }
}
...
word neutralize_fief(word arg1) {
    if ((province_ai_state[arg1] == 255)) return find_record_9e3c(arg1);    // $E463
    ...
    return find_record_9e3c(arg1);    // $E466
}
...
word ui_helper_e510(word arg1) {
    ...
    while (((unsigned)local11 < (unsigned)scenario_fief_count)) {    // $E545
        if (!(province_state_is_FF(local11))) {    // $E524
            if (!((is_enemy_owned(local11) ^ arg1))) {    // $E52E
...
word find_record_9e3c(word arg1) {
    if (!(((unsigned)selected_record_idx_9e3c <= (unsigned)8))) return ui_helper_cc7b(local11, local10);    // $E55E
...
word map_helper_e5f2(word arg1) {
    if ((arg1 == selected_record_idx_9e3c)) return marry_helper_cc35(0);    // $E5FC
    ...
    return marry_helper_cc35(0);    // $E688
}
...
word dispatch_map_helper_e694(void) {
    return map_helper_e5f2(*(byte*)((selected_province_idx_latch_7fdd + ((scenario_fief_count == 50) ? province_to_map_section_50 : province_to_map_section_17))));    // $E699
}
...
word draw_daimyo_portrait(word col, word row) {
    ...
    } while (((unsigned)pal_idx < (unsigned)4));    // $E777
    if (((unsigned)active_province_idx_copy >= (unsigned)53)) goto L_E7A7;    // $E798
    if (!(*(byte*)((daimyo_record_addr(active_province_idx_copy) + 6)))) {    // $E7A4
L_E7A7:
...
word ui_helper_e80c(word arg1) {
    if (!((ai_turn_flags & 4))) return call_bank_wrap(14);    // $E816
    mem_7FCB = arg1;    // $E81A
    return call_bank_wrap(14);    // $E819
}
