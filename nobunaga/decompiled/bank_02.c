...
L_835A:
        ...
        side = (side + 1);    // $8362
    } while (((unsigned)side < (unsigned)2));    // $8366
...
word map_render_driver(void) {
    ...
    } while (((unsigned)local9 < (unsigned)5));    // $888B
...
word draw_unit_count_digits(word arg1, word arg2) {
    ...
    if ((!((((unsigned)local9 <= (unsigned)10) || ((unsigned)local8 > (unsigned)4))))) return ((unsigned)local8 > (unsigned)4);    // $89FD
...
word validate_dir_code_and_dispatch(word arg1, word arg2, word arg3) {
    if ((((unsigned)arg3 <= (unsigned)51) || ((unsigned)arg3 >= (unsigned)55))) {    // $8F38
    arg3 = (arg3 - 49);    // $8F40
...
word find_unit_slot_by_fields(word arg1, word arg2, word arg3) {
    ...
    } while (((unsigned)local11 < (unsigned)5));    // $8FE7
    return 0;    // $8FEB
}
...
word find_unit_at_tile(word arg1, word arg2) {
    ...
    } while (((unsigned)local11 < (unsigned)2));    // $9005
    return 0;    // $9009
}
...
L_9757:
    ...
    } while (((unsigned)local7 < (unsigned)6));    // $978D
L_9790:
    return 0;    // $9791
}
...
L_9928:
    ...
    } while (((unsigned)local11 < (unsigned)6));    // $992E
L_9931:
...
L_9990:
    ...
    if (!(!(seek_enemy_adjacent_cell_and_commit_move(x, y)))) return ai_place_unit_in_free_slot_resolve_coords(3);    // $99B2
...
L_9B37:
    ...
    } while (((unsigned)local11 < (unsigned)2));    // $9B46
...
L_9B80:
    ...
    } while (((unsigned)local11 < (unsigned)3));    // $9BB0
...
word ai_strength_term_gated_table_word(word unit, word idx, word gate_idx) {
    if ((!(((unsigned)wrap_index_0_2_to_zero(idx) <= (unsigned)wrap_index_0_2_to_zero(gate_idx))))) return *(word*)(unit_word_field_ptr_6fbc(unit, idx));    // $9C7B
    return 0;    // $9C87
}
...
L_9F37:
    if (get_province_ai_state(local9)) {    // $9F3C
    }
L_9F46:
...
word find_adjacent_unit_around_tile(word arg1, word arg2, word arg3, word arg4) {
    ...
    } while (((unsigned)local11 < (unsigned)6));    // $A0A8
    return 0;    // $A0AC
}
...
L_A1D5:
    ...
    if (!(!(place_unit_at_tile_if_free(tile_x, tile_y)))) return place_unit_at_tile_if_free(tile_x, tile_y);    // $A1E1
    dir = (dir + 1);    // $A1E7
...
word ai_engage_present_enemy_if_favorable(word unit_idx) {
    if (enemy_unit_type_present_at_unit_tile(unit_idx)) {    // $A1F9
...
L_A572:
    ...
    if (((unsigned)max_enemy_unit_type_strength_pct(&reachable_enemy_list) > (unsigned)strength_threshold)) {    // $A59D
    }
L_A5A3:
...
word ai_advance_units_toward_reachable_enemies(void) {
    ...
    do {    // $A5D5
        ...
        i = (i + 1);    // $A5FE
    } while (((unsigned)i < (unsigned)6));    // $A603
...
L_A6FB:
    ...
    if (((unsigned)unit_type > (unsigned)5)) {    // $A71A
    }
L_A720:
...
word ai_rng_resolve_combat_apply_casualties(void) {
    ...
    if (((unsigned)*(word*)(((get_battle_side_province(enemy_side) * 26) + 0x7013)) > (unsigned)(const_two * 100))) {    // $A796
L_A799:
...
L_A86A:
    ...
    if (((unsigned)fief > (unsigned)29)) {    // $A884
L_A887:
    ...
    if (province_ai_state[owner]) {    // $A8C0
...
word battle_init_driver(void) {
    ...
    if (!(!(result))) return dispatch_battle_resolution(result);    // $B027
...
L_B05B:
    ...
    side = 0;    // $B061
L_B062:
    if ((*(word*)(*(word*)(((side << 1) + &side_unit_ptr))) <= 0)) {    // $B06E
...
L_B07F:
    ...
    if (!(!(run_both_sides_combat_turn(day)))) return dispatch_battle_resolution(result);    // $B08E
