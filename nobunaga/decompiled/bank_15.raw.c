// ============================================================
// decompiled/bank_15.raw.c  —  GENERATED by tools/decompile-all.py  (BASIC: bytecode -> direct goto-infused C, the intermediary form the structure engine folds; the CFG-equivalence reference for bank_15.c)
