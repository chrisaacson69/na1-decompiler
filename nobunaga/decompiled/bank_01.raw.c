// ============================================================
// decompiled/bank_01.raw.c  —  GENERATED by tools/decompile-all.py  (BASIC: bytecode -> direct goto-infused C, the intermediary form the structure engine folds; the CFG-equivalence reference for bank_01.c)
