...
- **NEXT (stage 4):** walk the menu (`combat_command_dispatch_loop_per_unit`, the 5 verbs Attack/Bribe/Flee/Pass/View) and the per-unit attack → the casualty/damage formula + where terrain's 16-byte modifiers are read. Treat ch.14-17 + toml as suspect throughout.
