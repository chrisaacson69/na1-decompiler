...
- **PAUSED 2026-06-13.** State: plains melee = certified symmetric formula; terrain = an ASYMMETRIC DEFENSIVE casualty-reduction applied OUTSIDE `resolve_mutual` (occupant takes far less — seen, not yet located); the +1s = deploy-redistribution/bribe, not reinforcement; unit-rank commander question open.
