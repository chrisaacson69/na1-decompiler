...
- **PAUSED 2026-06-13. COMBAT MELEE = RESOLVED:** `p` from `S = men+home+rank+8stat40+momentum` (no terrain in the attacker's S); **terrain is DEFENSIVE — the defending unit's terrain boosts its S in the casualty calc, so it takes fewer losses** (castle ≫ forest > town). Off-screen resolver + player difficulty tax still untested.
