// ============================================================
// source/3-c-basic/bank_14.raw.c  —  GENERATED by `python -m na1dream.cli.decompile_all`  (BASIC: bytecode -> direct goto-infused C, the intermediary form the structure engine folds; the CFG-equivalence reference for bank_14.c)
...
L_800E:
    ...
    if (local11) goto L_800E;    // $8012
    arg1 = (arg1 - 1);    // $8017
L_8018:
    if (arg1) goto L_800B;    // $8019
    return arg1;    // $801C
}
...
L_8091:
    if ((local10 < local7)) goto L_8068;    // $8094
    local11 = (local11 + 1);    // $8099
    local8 = (local8 + 8);    // $809F
L_80A0:
    if ((local11 < local6)) goto L_8061;    // $80A3
...
L_80F8:
    ...
    if ((local11 < 32)) goto L_80DC;    // $80FD
