// ============================================================
// source/3-c-basic/bank_01.raw.c  —  GENERATED by `python -m na1dream.cli.decompile_all`  (BASIC: bytecode -> direct goto-infused C, the intermediary form the structure engine folds; the CFG-equivalence reference for bank_01.c)
...
word prompt_message_and_redraw(word prompt_id, word message_ptr) {
    ...
    if ((prompt_id != 255)) goto L_8021;    // $8014
...
L_806F:
    ...
    if (province_state_is_FF((picked_fief - 1))) goto L_8085;    // $8080
...
word apply_two_grows_const1_override(word arg1, word arg2) {
    ...
    *(word*)(arg1) = (*(word*)(arg1) - arg2);    // $8392
    if (!((*(word*)(arg1) < 0))) goto L_839D;    // $8397
    *(word*)(arg1) = 0;    // $839C
L_839D:
...
word province_window_redraw_ba6f(word arg1, word arg2) {
    if ((province_ai_state[arg1] == 255)) goto L_83BF;    // $83B1
...
word province_window_redraw_ba78(word arg1, word arg2) {
    if ((province_ai_state[arg1] == 255)) goto L_83F2;    // $83E4
...
word effect_view_a(word arg1) {
    ...
    if (!(get_province_ai_state(arg1))) goto L_84B9;    // $8498
...
L_84FF:
    ...
    local11 = 0;    // $8510
L_8511:
    if (!(((unsigned)local11 < (unsigned)6))) goto L_851E;    // $8514
    phi_8522_0 = 2;    // $851B
...
L_8522:
    ...
    if (!(((unsigned)local11 < (unsigned)6))) goto L_854A;    // $8535
...
word view_window_redraw_by_6da2_flag(word arg1) {
    ...
    if (!(fief_is_daimyo_capital[arg1])) goto L_85D9;    // $85C3
...
word effect_view_b(void) {
    ...
    goto L_8615;    // $85F4
L_85F7:
    if (!(is_enemy_owned(local8))) goto L_8613;    // $85FC
    if ((province_ai_state[local8] == 255)) goto L_8613;    // $8609
...
word effect_dam(word fief) {
    if (fief->output) goto L_87E7;    // $87E0
    return 0x2710;    // $87E6
L_87E7:
...
L_881B:
    ...
    if (!((gain > (fief->header - fief->output)))) goto L_882F;    // $882A
    gain = local10;    // $882E
L_882F:
    if (!(((gain / 2) > fief->output))) goto L_8840;    // $8838
...
word helper_dam_rounding(word arg1, word arg2) {
    local11 = arg1;    // $8883
    if (!(war_helper_d972(selected_province_idx))) goto L_8899;    // $888B
...
L_88D0:
    ...
    if (!((gain > (fief->header - fief->town)))) goto L_88E4;    // $88DF
    gain = local10;    // $88E3
L_88E4:
    if ((gain <= fief->town)) goto L_88F3;    // $88EB
...
L_894F:
    ...
    if (!((gain > (fief->header - fief->loyalty)))) goto L_8963;    // $895E
    gain = headroom;    // $8962
L_8963:
...
L_89A1:
    ...
    if (!((gain > (fief->header - fief->wealth)))) goto L_89B5;    // $89B0
    gain = headroom;    // $89B4
L_89B5:
...
L_89F5:
    ...
    if (!((gain > (fief->header - fief->morale)))) goto L_8A0A;    // $8A05
    gain = headroom;    // $8A09
L_8A0A:
...
word effect_trade(void) {
    ...
    if (!((((scenario_fief_count == 50) ? 32 : 14) == selected_province_idx))) goto L_8A48;    // $8A43
L_8A46:
    return 1;    // $8A47
L_8A48:
...
L_8A74:
    ...
    if ((loan_rate <= 15)) goto L_8A8B;    // $8A80
...
word helper_8B8F(word arg1) {
    ...
    if ((audio_wait_gate != 1)) goto L_8BBB;    // $8BAE
L_8BB1:
...
word random_daimyo_stat_increment(void) {
    ...
    *(byte*)(((rng_mod(5) + local11) + 1)) = (*(byte*)(((rng_mod(5) + local11) + 1)) + 2);    // $8C90
    if (!((*(byte*)((local11 + 1)) >= 200))) goto L_8CA1;    // $8C98
...
word effect_bribe(word gold_amount) {
    ...
    if (!(bribe_success_check(selected_province_idx, battle_defending_province))) goto L_8DBF;    // $8D78
...
word ai_commit_attack_deduct_resources(void) {
    ...
    if (!(fief_is_daimyo_capital[selected_province_idx])) goto L_906F;    // $9062
...
L_9070:
    ...
    if ((attack_budget >= 5)) goto L_909D;    // $9098
    return 0;    // $909C
L_909D:
    if (!((min_word(*(word*)(((battle_defending_province * 26) + 0x7007)), *(word*)(((battle_defending_province * 26) + 0x7011))) > attack_budget))) goto L_90C0;    // $90BB
    return 0;    // $90BF
L_90C0:
    if (!(relations_rng_predicate(battle_defending_province, selected_province_idx))) goto L_90CF;    // $90CA
    return 0;    // $90CE
L_90CF:
...
L_90E8:
    ...
    *(word*)((local11 + 16)) = (*(word*)((local11 + 16)) - spend_amount);    // $9105
    if (!(((unsigned)math32_2arg(*(word*)((local11 + 6)), spend_amount) > (unsigned)55))) goto L_9119;    // $9112
...
L_9130:
    ...
    *(word*)((local11 + 6)) = (*(word*)((local11 + 6)) - war_attacker_rice);    // $913C
    ...
    if (!((get_province_ai_state(battle_defending_province) == 5))) goto L_9159;    // $914C
L_914F:
...
word ninja_mission_resolve_vs_defender(word arg1) {
    ...
    if (!(((*(byte*)(local6) - rng_mod((const_two * 10))) > (*(byte*)(local5) - rng_mod((const_two * 10)))))) goto L_9213;    // $91F6
...
L_9213:
    ...
    local8 = 1;    // $9214
    if (!((*(word*)(local11) <= (rng_mod(10) + 1)))) goto L_9260;    // $9220
    local10 = (rng_mod(*(byte*)(local6)) + 50);    // $922C
    if (!(((rng_mod(*(byte*)(local6)) + 50) > 100))) goto L_9236;    // $9230
    local10 = 100;    // $9235
L_9236:
    if (!(((arg1 / pct_op(*(word*)(local11), local10)) <= rng_mod((*(byte*)(local7) / 10))))) goto L_9260;    // $924E
    if (!(rng_mod((*(byte*)(local7) / 100)))) goto L_9260;    // $925B
    local8 = 0;    // $925F
L_9260:
    if (!(local8)) goto L_92BC;    // $9261
    byte_helper_ca12(local4, (rng_mod(((unsigned)*(byte*)(local4) / (unsigned)(local9 + 1))) + 1));    // $9273
    if (!(local9)) goto L_9281;    // $9278
...
word war_prep_clamp_depleted_field_notify(word arg1, word arg2, word arg3) {
    if (!((*(word*)(arg3) <= 0))) goto L_9320;    // $930A
    *(word*)(arg3) = 0;    // $930F
    if (!(get_province_ai_state(arg2))) goto L_9320;    // $9315
...
word effect_war_combat_prep_d(word fief) {
    ...
    if (!(war_helper_d972(fief))) goto L_9380;    // $9373
...
word fief_men_if_provisioned(word arg1) {
    ...
    if (*(word*)((local11 + 6))) goto L_9398;    // $9393
    return 0;    // $9397
L_9398:
...
word pick_weakest_men_fief(word fief_list_ptr) {
    ...
    goto L_93D2;    // $93BB
L_93BE:
    if (!(((unsigned)fief_men_ratio_pct(weakest_fief, *(byte*)(fief_list_ptr)) > (unsigned)50))) goto L_93CF;    // $93C9
...
word pick_ai_attack_target_fief(word fief_list) {
    ...
    goto L_9452;    // $942B
L_942E:
    if (!(get_province_ai_state(target_fief))) goto L_944F;    // $9433
    if (ai_relations_and_low_drive_skip_gate(target_fief)) goto L_944F;    // $943B
    if (!(((unsigned)fief_men_ratio_pct(target_fief, *(byte*)(fief_list)) > (unsigned)50))) goto L_944F;    // $9449
...
word find_fief_by_owner_men_minority(word arg1, word arg2) {
    ...
    goto L_948D;    // $946D
L_9470:
    if (!((fief_owner(local11) == arg2))) goto L_948A;    // $9477
...
word ai_try_war_attack(void) {
    ...
    if (!((war_helper_d972(attacker_idx) || (!(*(word*)((fief + 16))) || !(*(word*)((fief + 6))))))) goto L_94C5;    // $94C0
    return 0;    // $94C4
L_94C5:
...
L_94E2:
    ...
    if ((minority_target_idx == 255)) goto L_9505;    // $9500
...
L_9505:
    ...
    if (!(rng_mod(100))) goto L_952D;    // $9526
    phi_val_952e = 0;    // $952A
    goto L_952E;    // $952A
L_952D:
    phi_val_952e = 1;    // $952D
L_952E:
    ...
    if (!(get_province_ai_state(alt_target_idx))) goto L_9547;    // $9534
    if (!(((unsigned)fief_men_ratio_pct(attacker_idx, alt_target_idx) > (unsigned)47))) goto L_9547;    // $9540
    do_attack = 1;    // $9544
...
L_9571:
    if (!(do_attack)) goto L_9584;    // $9572
    battle_defending_province = target_idx;    // $9576
    if (!(ai_commit_attack_deduct_resources())) goto L_9584;    // $957C
    effect_war_a();    // $957F
    return 2;    // $9583
L_9584:
    return 0;    // $9585
...
word effect_train(void) {
    ...
    *(word*)(skill_field) = (*(word*)(skill_field) + (((rng_mod(20) + 10) << 1) << 1));    // $95A9
    if (!(((*(byte*)((daimyo + 5)) + *(byte*)((daimyo + 3))) > (rng_mod(10) + 90)))) goto L_95C7;    // $95BD
...
L_95DE:
    ...
    result = 0;    // $95EA
    if (!(((*(word*)(fief) - *(word*)((fief + 16))) >= 1))) goto L_960A;    // $95F6
...
word ai_reinforce_province_arms_and_econ_10pct(void) {
    *(byte*)((selected_province_daimyo_record() + 2)) = (*(byte*)((selected_province_daimyo_record() + 2)) + rng_mod((const_two + 1)));    // $9623
    ...
    if (!((*(word*)((((selected_province_idx * 26) + 0x7001) + 16)) > 8))) goto L_9693;    // $9635
    arms_buf = 50;    // $963A
    i = 1;    // $963E
L_9640:
...
L_96E2:
    ...
    if (!(province_select_prompt(deduped_owner_list))) goto L_97BF;    // $9709
    ...
    if (!(number_input(1, local10))) goto L_97BF;    // $9754
...
word candidate_list_6f4f_lookup(word arg1, word arg2) {
    ...
    goto L_97E0;    // $97CA
L_97CD:
    if (!((*(byte*)(local11) == arg1))) goto L_97D7;    // $97D1
...
word driver_war(void) {
    ...
    if (!(effect_war_combat_prep_d(local9))) goto L_986C;    // $9867
    return 0;    // $986B
L_986C:
    ...
    if (!(province_select_prompt(deduped_owner_list))) goto L_9998;    // $98B3
    open_message_window();    // $98B6
    battle_defending_province = (battle_defending_province - 1);    // $98BD
    if (!(candidate_list_6f4f_lookup(battle_defending_province, &local1))) goto L_98DA;    // $98CB
...
L_98DA:
    ...
    if (!(war_helper_d972(local9))) goto L_9906;    // $98F7
...
L_9906:
    ...
    if (!(number_input(1, local10))) goto L_9998;    // $9916
    ...
    if (!(number_input(1, min_word(*(word*)((local11 + 6)), war_attacker_men)))) goto L_9998;    // $9934
...
word driver_tax(void) {
    ...
    if (!(number_input(1, (tax_helper_db12() ? 30 : 100)))) goto L_9A5B;    // $99E0
    if (!((*(byte*)(local6) != local5))) goto L_9A5B;    // $99E7
    if (!((local5 > *(byte*)(local6)))) goto L_99FF;    // $99F0
...
word driver_send(void) {
    ...
    if (!(province_select_prompt(0x6F89))) goto L_9B7C;    // $9A81
    ...
    if (!(effect_war_combat_prep_a(selected_province_idx))) goto L_9AE3;    // $9AA1
    ...
    if (!((local10 <= 0))) goto L_9AE3;    // $9ACB
    open_message_window();    // $9ACE
    if ((local10 >= 0)) goto L_9AE3;    // $9AD4
    return 0;    // $9AD8
L_9AD9:
...
L_9AE3:
    ...
    if (!(effect_war_combat_prep_c(selected_province_idx))) goto L_9B2C;    // $9AEB
    ...
    if (!((local11 <= 0))) goto L_9B2C;    // $9B14
    open_message_window();    // $9B17
    if ((local11 >= 0)) goto L_9B2C;    // $9B1D
    return 0;    // $9B21
L_9B22:
...
L_9B9D:
    ...
    if (!((*(word*)(local10) >= 100))) goto L_9BBE;    // $9BAF
...
L_9BCF:
    ...
    if (!(number_input(1, local11))) goto L_9C4E;    // $9C05
...
L_9C20:
    ...
    if (!((*(word*)(local10) > 100))) goto L_9C38;    // $9C31
...
word driver_pact(void) {
    ...
    *(byte*)((selected_province_daimyo_record() + 2)) = (*(byte*)((selected_province_daimyo_record() + 2)) - 1);    // $9C93
    ...
    draw_message(msg_lord_s_s_wants_d_gold_pay, ((ui_helper_d77e() * 9) + 0x77A8), ((fief_owner(battle_defending_province) * 9) + 0x77A8), local10);    // $9CBC
...
L_9D19:
    ...
    draw_message(msg_lord_s_they_ve_refused, ((ui_helper_d77e() * 9) + 0x77A8));    // $9D32
    goto L_9D0C;    // $9D36
L_9D39:
    return local9;    // $9D3A
L_9D3B:
...
word driver_grow(void) {
    ...
    if (!((*(word*)((local11 + 24)) <= *(word*)((local11 + 8))))) goto L_9D66;    // $9D57
    message_display(msg_we_re_at_our_limit);    // $9D5D
    confirm_prompt();    // $9D61
    return 0;    // $9D65
L_9D66:
    if (!(*(word*)(local11))) goto L_9DB8;    // $9D68
    ...
    if (!(number_input(1, *(word*)(local11)))) goto L_9DB6;    // $9D89
...
word driver_marry(void) {
    ...
    if (!(province_select_prompt(0x6F89))) goto L_9EF8;    // $9DFE
    *(byte*)((local8 + 2)) = (*(byte*)((local8 + 2)) - 1);    // $9E06
    ...
    draw_message(msg_lord_s_s_wants_d_gold_pay_fd45, ((ui_helper_d77e() * 9) + 0x77A8), ((fief_owner(battle_defending_province) * 9) + 0x77A8), local11);    // $9E51
...
L_9EC6:
    ...
    draw_message(msg_lord_s_they_ve_refused, ((ui_helper_d77e() * 9) + 0x77A8));    // $9EDF
...
word subhandler_A003(word arg1) {
    ...
    if (!(number_input(1, local10))) goto L_A063;    // $A03F
...
word subhandler_A068(word arg1) {
    ...
    if (!(number_input(1, local11))) goto L_A0E8;    // $A0B0
...
word subhandler_A113(word arg1) {
    if (!((arg1->men <= 0))) goto L_A12D;    // $A11E
...
L_A12D:
    ...
    if (!(number_input(1, local11))) goto L_A1AA;    // $A16A
...
word driver_trade(void) {
    if (!(effect_trade())) goto L_A249;    // $A1BE
...
word effect_hire_variant_pay(word fief) {
    ...
    if (!(number_input(1, max_affordable))) goto L_A5F2;    // $A581
    *(word*)(fief) = (*(word*)(fief) - math32_muladddiv(gold_men_hire_rate, amount));    // $A592
    ...
    draw_message(msg_lord_s_we_now_have_d_men, ((ui_helper_d77e() * 9) + 0x77A8), *(word*)(((selected_province_idx * 26) + 0x7011)));    // $A5D4
    confirm_prompt();    // $A5D8
    return 1;    // $A5DC
L_A5DD:
...
word driver_hire(void) {
    if (!(effect_war_combat_prep_c(selected_province_idx))) goto L_A635;    // $A600
...
L_A787:
    ...
    if (!((ui_helper_d77e() != fief_owner(local10)))) goto L_A833;    // $A79A
...
word driver_build(void) {
    ...
    if (!((*(word*)((local11 + 24)) <= *(word*)((local11 + 4))))) goto L_A87C;    // $A86D
...
L_A87C:
    ...
    if (!(number_input(1, *(word*)(local11)))) goto L_A8D2;    // $A89F
...
word give_transfer_apply(word arg1, word arg2, word arg3) {
    ...
    if (!(number_input(1, *(word*)(local11)))) goto L_A91C;    // $A8F5
    *(word*)(local11) = (*(word*)(local11) - local10);    // $A8FE
    if ((arg3 != 1)) goto L_A914;    // $A902
...
word give_eligibility_flags(word arg1, word arg2) {
    local11 = 0;    // $A924
    if ((arg2 <= 0)) goto L_A92D;    // $A928
    local11 = 2;    // $A92C
L_A92D:
    if ((arg1 <= 0)) goto L_A938;    // $A930
...
word driver_give(void) {
    ...
    if (!(effect_give_c(local9))) goto L_AAAC;    // $AA3B
    if ((local10 & local11)) goto L_AA5C;    // $AA41
    local10 = (local10 - 1);    // $AA46
    if (!((local10 - 1))) goto L_AA50;    // $AA47
...
L_AA53:
    ...
    return 0;    // $AA5B
L_AA5C:
    if ((local11 != 1)) goto L_AA75;    // $AA64
    goto L_AA79;    // $AA72
L_AA75:
L_AA79:
    if (!((*(word*)((local9 + 18)) >= *(word*)((local9 + 24))))) goto L_AA8A;    // $AA7B
    message_display(msg_we_re_at_our_limit);    // $AA81
    confirm_prompt();    // $AA85
    return 0;    // $AA89
L_AA8A:
    if (!(effect_give_b(local9, local11))) goto L_AAAC;    // $AA90
...
word driver_bribe(void) {
    ...
    if (!(province_select_prompt(0x6F89))) goto L_AB20;    // $AAE6
    ...
    if (!(number_input(1, (*(word*)(local11) + -10)))) goto L_AB20;    // $AB05
...
L_AB29:
    *(word*)(((local11 << 1) + arg2)) = *(byte*)((((selected_province_idx * 5) + local11) + 0x76A9));    // $AB3A
    ...
    if (!((*(word*)(((local11 << 1) + arg2)) > 0x270F))) goto L_AB59;    // $AB4D
...
word commit_arms_record_from_buffer(word arg1, word arg2) {
    ...
    local11 = 0;    // $ABCF
L_ABD0:
    if (!((*(byte*)((local10 + local11)) != *(word*)(((local11 << 1) + arg1))))) goto L_ABE1;    // $ABDC
    local9 = 1;    // $ABE0
L_ABE1:
    local11 = (local11 + 1);    // $ABE3
    if (((unsigned)local11 < (unsigned)5)) goto L_ABD0;    // $ABE7
    if (!((arg2 || !(local9)))) goto L_ABF4;    // $ABEF
    return 0;    // $ABF3
L_ABF4:
    local11 = 0;    // $ABF5
L_ABF6:
...
word driver_rest(void) {
    ...
    if (!(number_input(1, 10))) goto L_ADF4;    // $ADD9
...
word subhandler_B0D2(void) {
    ...
    if (!(number_input(1, 10))) goto L_B104;    // $B0F7
...
L_B17D:
    ...
    goto L_B199;    // $B182
L_B185:
    if (!((fief_owner(local10) == local11))) goto L_B197;    // $B18C
...
L_B1EC:
    ...
    if (!(((ui_cursor_row - 1) == 6))) goto L_B20A;    // $B1FA
...
word ai_seed_fief_collection_rate_6d2d(word arg1) {
    ...
    if (!(tax_helper_db12())) goto L_B2DA;    // $B2CD
    goto L_B2E2;    // $B2D7
L_B2DA:
L_B2E2:
...
word ai_calc_men_surplus_over_gold_and_rice(word out_gold_surplus, word out_rice_surplus) {
    ...
    *(word*)(out_rice_surplus) = (*(word*)((fief + 6)) - *(word*)((fief + 16)));    // $B315
    if (!((*(word*)(out_gold_surplus) < 0))) goto L_B320;    // $B31A
    *(word*)(out_gold_surplus) = 0;    // $B31F
L_B320:
    phi_ret_b32a = (*(word*)(out_rice_surplus) < 0);    // $B324
    if (!(phi_ret_b32a)) goto L_B32A;    // $B324
...
word ai_province_gold_to_rice_convert(word gold_surplus_ptr, word rice_surplus_ptr) {
    if (rng_mod(4)) goto L_B346;    // $B342
    return rng_mod(4);    // $B345
L_B346:
    fief = ((selected_province_idx * 26) + 0x7001);    // $B350
    if (!(((unsigned)rng_threshold_10_29() < (unsigned)gold_rice_exchange_rate))) goto L_B367;    // $B358
...
word ai_develop_town_handler(void) {
    ...
    if (!((*(word*)((fief + 4)) < *(word*)((fief + 24))))) goto L_B426;    // $B406
    if (rng_mod(3)) goto L_B426;    // $B40E
    if ((gain <= 0)) goto L_B426;    // $B414
...
word ai_develop_dam_and_grow(void) {
    ...
    if (!((*(word*)((((selected_province_idx * 26) + 0x7001) + 12)) > *(word*)((fief + 8))))) goto L_B4C9;    // $B459
...
word ai_state2_recruit_arm_train(void) {
    if (!(ai_try_war_attack())) goto L_B4E2;    // $B4DD
    return 1;    // $B4E1
L_B4E2:
...
L_B66E:
    if (!(fief_is_daimyo_capital[selected_province_idx])) goto L_B696;    // $B676
...
L_B696:
    ...
    if (!(ai_state2_recruit_arm_train())) goto L_B6A5;    // $B6A1
    return ai_state2_recruit_arm_train();    // $B6A4
L_B6A5:
    if (!(rng_mod(10))) goto L_B6B0;    // $B6AA
L_B6B0:
...
L_B7DA:
    ...
    goto L_B810;    // $B7E5
L_B7E8:
    if ((command != 17)) goto L_B7F2;    // $B7EC
L_B7F2:
    effect_view_c();    // $B7EF
...
word ai_econ_action_state0(void) {
    ...
    if (phi_ret_b89a) goto L_B89A;    // $B890
...
L_B8AA:
    ...
    if (!(war_helper_d972(selected_province_idx))) goto L_B8EE;    // $B8D6
    ai_turn_flags = (ai_turn_flags | (rng_mod(4) ? 0 : 1));    // $B8EB
L_B8EE:
    if (count_6da2_set()) goto L_B8FA;    // $B8F1
    if (!(get_6e09())) goto L_B90E;    // $B8F7
L_B8FA:
