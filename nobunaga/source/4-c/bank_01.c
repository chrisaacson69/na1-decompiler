...
word prompt_message_and_redraw(word prompt_id, word message_ptr) {
    ...
    if ((prompt_id == 255)) {    // $8008
        ...
        draw_message(msg_s_s_s, *(word*)((((prompt_id - 1) << 1) + lord_command_name_ptrs)), ((message_ptr == msg_no_fiefs) ? str_market_panel_nl1 : msg_fiefs), message_ptr);    // $8040
    }
...
// $83C7 draw_selected_province_stat
// (body @ $83CC)
...
word effect_view_a(word arg1) {
    ...
    do {    // $8511
        ...
        if (((unsigned)local11 < (unsigned)6)) {    // $8522
            ...
            draw_province_stat3_or_dashes(arg1, *(byte*)((local10 - 1)));    // $8543
        } else {
            ui_window_col = 16;    // $854C
            local9 = (local9 + 2);    // $8551
            draw_province_stat_or_dashes(arg1, *(word*)((local9 + -2)));    // $8557
        }
...
word draw_fief_view_label(word arg1) {
    ...
    if (fief_is_daimyo_capital[arg1]) {    // $85B9
        ...
        return redraw_window(*(word*)(((get_province_ai_state(arg1) << 1) + governance_state_label_ptrs)));    // $85E9
    }
}
    ...
    *(byte*)(local11) = -1;    // $8621
    ...
    while (1) {    // $8705
        ...
        if ((*(byte*)(local11) != 255)) {    // $8705
            ...
            draw_message(msg_fmt__4d_bb06, *(word*)((local9 + -2)));    // $86A2
            local8 = 0;    // $86A7
            do {    // $86A8
                ui_window_col = (local6 - 1);    // $86AA
                local9 = (local9 + 2);    // $86AF
                draw_message(msg_fmt__4d_bb0b, *(word*)(local9));    // $86B5
            ...
            if (((local10 == 4) || (*(byte*)((local11 + 1)) == 255))) {    // $86C2
                palette_swap(0);    // $86F5
...
word fief_info_display(word arg1) {
    ...
    if (!(fief_menu_info_mode_flag)) {    // $8723
        ...
        do {    // $8740
            ...
            redraw_window(*(word*)(((local11 << 1) + lord_command_name_ptrs)));    // $875B
        ...
        do {    // $876D
            ...
            redraw_window(*(word*)(((local11 << 1) + lord_command_name_ptrs)));    // $8789
...
word effect_build(word fief, word amount) {
    if ((amount < 1)) {    // $88AB
        ...
        add_effect_gain_clamped((gain << 1), (fief + 4));    // $8917
        return gain;    // $891C
    }
}
...
word play_result_jingle(word arg1) {
    ...
    return call_bank10_entry(AUDIO_UI_CONFIRM);    // $8BC0
}
...
word effect_move(word amount) {
    ...
    do {    // $8CC8
        ...
        *(word*)(target_stat_ptr) = scaled_force_transfer(*(word*)(target_stat_ptr), *(word*)((donor_stat_ptr + -2)), amount, *(word*)(target), *(word*)((target + 8)));    // $8CDF
...
word effect_bribe(word gold_amount) {
    ...
    if (bribe_success_check(selected_province_idx, battle_defending_province)) {    // $8D52
        ...
        *(word*)((own_fief + 8)) = (*(word*)((own_fief + 8)) + defect_amount);    // $8D95
        ...
        trigger_cutscene(CUTSCENE_BRIBE);    // $8D9D
...
word resolve_siege_assault_outcome(void) {
    ...
    trigger_cutscene(CUTSCENE_SIEGE_ASSAULT);    // $8E49
    ...
    if (!(get_province_ai_state(battle_defending_province))) {    // $9192
        ...
        if (((*(byte*)(local6) + *(byte*)((local2 + 5))) <= (*(byte*)(local5) + *(byte*)((local3 + 5))))) {    // $91A2
            ...
            if (local8) {    // $9260
                ...
                confirm_prompt();    // $9288
                trigger_cutscene(CUTSCENE_NINJA_ASSASSIN_RESULT);    // $928C
            ...
            if (province_select_prompt(deduped_owner_list)) {    // $96F8
                ...
                if (local10) {    // $970C
                    ...
                    if (number_input(1, local10)) {    // $9746
                        ...
                        trigger_cutscene(CUTSCENE_MOVE);    // $9798
                        ...
                        if (number_input(1, local10)) {    // $9906
                            ...
                            if (number_input(1, min_word(*(word*)((local11 + 6)), war_attacker_men))) {    // $9919
                                ...
                                *(word*)((local11 + 16)) = (*(word*)((local11 + 16)) - war_attacker_men);    // $997C
                                ...
                                trigger_cutscene(CUTSCENE_WAR);    // $998F
                                effect_war_a();    // $9993
                                return 1;    // $9997
                            }
                        }
...
word driver_tax(void) {
    ...
    if (!((!(number_input(1, (defender_owner_is_keyed_daimyo() ? 30 : 100))) || !((*(byte*)(local6) != local5))))) {    // $99D9
        if ((local5 > *(byte*)(local6))) {    // $99EA
            ...
            trigger_cutscene(CUTSCENE_TAX_PROTEST);    // $99F5
        } else {
            phi_9a08_0 = msg_the_peasants_are_delighted;    // $9A05
            trigger_cutscene(CUTSCENE_TAX_DELIGHTED);    // $9A01
        }
...
word driver_send(void) {
    ...
    if (province_select_helper(4, 0x6F89)) {    // $9A62
        ...
        if (province_select_prompt(0x6F89)) {    // $9A72
            ...
            local6 = ((local8 * 26) + 0x7001);    // $9A8E
            local7 = *(word*)((((local8 * 26) + 0x7001) + 24));    // $9A92
            local11 = 0;    // $9A94
            local10 = 0;    // $9A95
            ...
            if ((local11 || local10)) {    // $9B2C
                ...
                if (prompt_y_n()) {    // $9B34
                    ...
                    *(word*)((local6 + 6)) = (*(word*)((local6 + 6)) - local10);    // $9B69
                    trigger_cutscene(CUTSCENE_SEND);    // $9B6C
            ...
            if (!(*(word*)(local8))) {    // $9BBE
                ...
                if (number_input(1, local11)) {    // $9BCF
                    *(word*)(local8) = (*(word*)(local8) - local9);    // $9C0E
                    ...
                    add_effect_gain_clamped(local9, local10);    // $9C22
                    trigger_cutscene(CUTSCENE_DAM);    // $9C28
                ...
                if (prompt_y_n()) {    // $9CA0
                    if ((*(word*)(local11) < local10)) {    // $9CC6
                        ...
                        *(word*)(((battle_defending_province * 26) + 0x7001)) = (*(word*)(((battle_defending_province * 26) + 0x7001)) + local10);    // $9CF2
                        ...
                        trigger_cutscene(CUTSCENE_PACT);    // $9CF7
        ...
        if (*(word*)(local11)) {    // $9D66
            ...
            if (number_input(1, *(word*)(local11))) {    // $9D6B
                *(word*)(local11) = (*(word*)(local11) - local10);    // $9D92
                ...
                trigger_cutscene(CUTSCENE_GROW);    // $9D9B
                ...
                if (marriage_pact_handler()) {    // $9E01
                    ...
                    if (prompt_y_n()) {    // $9E1A
                        ...
                        if ((local11 <= *(word*)(local9))) {    // $9E5B
                            ...
                            trigger_cutscene(CUTSCENE_MARRY);    // $9E79
        ...
        if ((arg1->town > arg1->debt)) {    // $9F2F
            ...
            if (ratio_times10_capped((arg1->town - arg1->debt), (loan_rate + 10), (arg1->header - *(word*)(arg1)))) {    // $9F3B
                ...
                if (number_input(1, local10)) {    // $9F5C
                    ...
                    draw_selected_province_stat(*(word*)(arg1));    // $9F89
                    set_cursor(16, 8);    // $9F90
                    draw_selected_province_stat(arg1->debt);    // $9F98
                    return 1;    // $9F9D
                } else {
    ...
    if (effect_trade()) {    // $A1BB
        ...
        while (1) {    // $A1F0
            ...
            if ((*(local10))(((selected_province_idx * 26) + 0x7001))) {    // $A1F0
                trigger_cutscene(CUTSCENE_TRADE);    // $A216
            ...
            if (province_select_helper(255, 0x6F89)) {    // $A2FB
                ...
                if (province_select_prompt(0x6F89)) {    // $A30D
                    ...
                    if (number_input(1, 5)) {    // $A321
                        ...
                        trigger_cutscene(CUTSCENE_NINJA_ASSASSIN);    // $A36D
                        ...
                        if ((*(byte*)((fief_to_daimyo_record_addr(battle_defending_province) + 3)) < (*(byte*)((selected_province_daimyo_record() + 3)) + 30))) {    // $A36C
                            switch (mission) {    // $A399
                                ...
                                case 3:
                                    ...
                                    trigger_cutscene(CUTSCENE_NINJA_DAMS);    // $A4AD
                                ...
                                case 5:
                                    ...
                                    if (drain_amount) {    // $A529
                                        trigger_cutscene(CUTSCENE_NINJA_ARSON);    // $A538
                                        arg1->town = (arg1->town - drain_amount);    // $A543
                                        phi_a419_0 = 7;    // $A546
                                        phi_a419_1 = drain_amount;    // $A546
                                        report_fief_stat_decline(phi_a419_0, phi_a419_1);    // $A419
                                    } else {
                                        effect_ninja_failed(local8, unit_count);    // $A530
                                        return 1;    // $A535
                                    }
                            }
                        } else {
                            effect_ninja_failed(local8, unit_count);    // $A54B
                            return 1;    // $A550
                        }
                    }
                }
    ...
    if (ratio_times10_capped(*(word*)(fief), gold_men_hire_rate, (fief->header - fief->men))) {    // $A558
        ...
        if (number_input(1, max_affordable)) {    // $A573
            *(word*)(fief) = (*(word*)(fief) - math32_muladddiv(gold_men_hire_rate, amount));    // $A592
            ...
            trigger_cutscene(CUTSCENE_HIRE);    // $A5B0
...
word driver_train(void) {
    ...
    if ((*(word*)((local11 + 20)) < *(word*)((local11 + 24)))) {    // $A63C
        if ((*(word*)((local11 + 16)) <= 0)) {    // $A655
            ...
            trigger_cutscene(CUTSCENE_TRAIN);    // $A672
            effect_train();    // $A676
...
L_A76C:
    ...
    if ((local10 != selected_province_idx)) goto L_A787;    // $A777
L_A77A:
...
L_A7C6:
    *(word*)(((selected_province_idx * 26) + 0x7001)) = (*(word*)(((selected_province_idx * 26) + 0x7001)) - 10);    // $A7D5
    ...
    draw_selected_province_stat(*(word*)(((selected_province_idx * 26) + 0x7001)));    // $A7F1
L_A7F5:
...
L_A82B:
    ...
    trigger_cutscene(CUTSCENE_VIEW);    // $A82F
L_A833:
        ...
        if (*(word*)(local11)) {    // $A87C
            ...
            if (number_input(1, *(word*)(local11))) {    // $A881
                *(word*)(local11) = (*(word*)(local11) - local10);    // $A8A8
                ...
                trigger_cutscene(CUTSCENE_BUILD);    // $A8B2
        ...
        if (!((local10 & local11))) {    // $AA3E
            ...
            if ((*(word*)((local9 + 18)) >= *(word*)((local9 + 24)))) {    // $AA79
                ...
                if (effect_give_b(local9, local11)) {    // $AA8A
                    trigger_cutscene(CUTSCENE_GIVE);    // $AA94
...
word commit_arms_record_from_buffer(word arg1, word arg2) {
    ...
    if ((arg2 || !(local9))) {    // $ABEA
        ...
        trigger_cutscene(CUTSCENE_ASSIGN_ARMS);    // $AC0B
        return 1;    // $AC10
    }
}
...
L_AC53:
    ...
    if ((field_idx >= 0)) goto L_AC68;    // $AC60
    field_idx = 4;    // $AC64
...
L_AC7B:
    ...
    if (!((field_idx >= 5))) goto L_AC68;    // $AC88
    field_idx = 0;    // $AC8C
...
word driver_rest(void) {
    if (fief_is_daimyo_capital[selected_province_idx]) {    // $ADB8
        ...
        if (number_input(1, 10)) {    // $ADC3
            ...
            confirm_prompt();    // $ADE3
            trigger_cutscene(CUTSCENE_REST);    // $ADE8
            return 1;    // $ADED
        }
    } else {
...
L_AE56:
    ...
    local11 = *(byte*)((cell_ptr - 1));    // $AE5D
    cell_ptr = (cell_ptr + 1);    // $AE61
    local10 = *(byte*)((cell_ptr - 1));    // $AE65
    cell_ptr = (cell_ptr + 1);    // $AE69
    if (!((*(byte*)((cell_ptr - 1)) == selected_province_idx))) goto L_AE1D;    // $AE71
    found_flag = 1;    // $AE75
    goto L_AE78;    // $AE75
L_AE2A:
                ...
                if (province_select_prompt(0x6F89)) {    // $AF9C
                    ...
                    if (!(local10)) {    // $AFB0
                        ...
                        do {    // $AFCC
                            ...
                            redraw_window(*(word*)((((local9 + 1) << 1) + governance_state_label_ptrs)));    // $AFE8
                    ...
                    if (((submenu_prompt(6) + 1) != 6)) {    // $AFF5
                        if ((province_ai_state[battle_defending_province] == local11)) {    // $B001
                            draw_message(msg_it_s_already_a_s_state, *(word*)(((local11 << 1) + governance_policy_name_ptrs)));    // $B019
                            confirm_prompt();    // $B01D
                        } else {
                            draw_message(msg_it_s_currently_a_s_state_ok_to, *(word*)(((province_ai_state[battle_defending_province] << 1) + governance_policy_name_ptrs)), *(word*)(((local11 << 1) + governance_policy_name_ptrs)));    // $B03D
                            if (prompt_y_n()) {    // $B023
...
word setting_sound_on_off(void) {
    ...
    if ((local11 == 2)) {    // $B06B
        ...
        if (!(audio_wait_gate)) {    // $B082
            ...
            call_bank10_entry(AUDIO_UI_CONFIRM);    // $B097
        }
        return 0;    // $B09C
    }
}
    ...
    if ((*(word*)((((selected_province_idx * 26) + 0x7001) + 12)) > *(word*)((fief + 8)))) {    // $B430
        if (*(word*)((fief + 8))) {    // $B45C
            ...
            *(word*)(fief) = (*(word*)(fief) - local7);    // $B47F
            ...
            add_effect_gain_clamped(local7, (fief + 10));    // $B48E
            ...
            if ((command != 20)) {    // $B81B
                ...
                do {    // $B839
                    if (((unsigned)i < (unsigned)6)) {    // $B839
                        ...
                        draw_province_stat3_or_dashes(fief, *(byte*)((daimyo_byte_ptr - 1)));    // $B84E
                    } else {
                        set_cursor(16, (i + 1));    // $B85A
                        fief_word_ptr = (fief_word_ptr + 2);    // $B860
                        draw_province_stat_or_dashes(fief, *(word*)((fief_word_ptr + -2)));    // $B866
                    }
                    i = (i + 1);    // $B86C
...
word ai_econ_action_state0(void) {
    ...
    if (!(phi_ret_b89a)) {    // $B87A
        *(word*)((fief + 22)) = (*(word*)((fief + 22)) + 1);    // $B899
        phi_ret_b89a = *(word*)((fief + 22));    // $B899
    }
...
L_B98D:
    ...
    ai_per_fief_loop_index = turn_idx;    // $B996
    goto L_B9A7;    // $B999
L_B99C:
