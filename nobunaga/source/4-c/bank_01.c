...
word helper_dam_rounding(word arg1, word arg2) {
    local11 = arg1;    // $8883
    if (war_helper_d972(selected_province_idx)) {    // $8882
...
word ai_attack_announce_prompt(void) {
    ...
    ui_helper_d134(msg_invaded_s_in_fief_2d, ((fief_owner(battle_defending_province) * 9) + 0x77A8), (battle_defending_province + 1));    // $903E
...
word ai_try_war_attack(void) {
    ...
    if ((war_helper_d972(attacker_idx) || (!(*(word*)((fief + 16))) || !(*(word*)((fief + 6)))))) {    // $949F
        return 0;    // $94C4
    } else {
            ...
            if (province_select_helper(2, deduped_owner_list)) {    // $9884
                ...
                if (province_select_prompt(deduped_owner_list)) {    // $98A2
                    ...
                    if (candidate_list_6f4f_lookup(battle_defending_province, &local1)) {    // $98B6
                        ...
                        if (war_helper_d972(local9)) {    // $98DA
...
word driver_tax(void) {
    ...
    if (!((!(number_input(1, (tax_helper_db12() ? 30 : 100))) || !((*(byte*)(local6) != local5))))) {    // $99D9
        ...
        if (province_select_prompt(0x6F89)) {    // $9C71
            ...
            *(byte*)((selected_province_daimyo_record() + 2)) = (*(byte*)((selected_province_daimyo_record() + 2)) - 1);    // $9C93
            ...
            if (diplomacy_helper()) {    // $9C85
                ui_helper_d134(msg_lord_s_s_wants_d_gold_pay, ((ui_helper_d77e() * 9) + 0x77A8), ((fief_owner(battle_defending_province) * 9) + 0x77A8), local10);    // $9CBC
                if (ui_helper_d3a7()) {    // $9CA0
            ...
            if (province_select_prompt(0x6F89)) {    // $9DED
                *(byte*)((local8 + 2)) = (*(byte*)((local8 + 2)) - 1);    // $9E06
                ...
                if (marry_helper_e315()) {    // $9E01
                    ...
                    ui_helper_d134(msg_lord_s_s_wants_d_gold_pay_fd45, ((ui_helper_d77e() * 9) + 0x77A8), ((fief_owner(battle_defending_province) * 9) + 0x77A8), local11);    // $9E51
...
word driver_hire(void) {
    if (effect_war_combat_prep_c(selected_province_idx)) {    // $A5F9
        ...
        switch (ui_helper_d351(msg_men_ninja)) {    // $A603
            case 0:
...
word subhandler_B09D(void) {
    ...
    switch (ui_helper_d351(msg_on_off_bed0)) {    // $B0A2
        case 1:
...
word ai_calc_men_surplus_over_gold_and_rice(word out_gold_surplus, word out_rice_surplus) {
    ...
    *(word*)(out_rice_surplus) = (*(word*)((fief + 6)) - *(word*)((fief + 16)));    // $B315
    ...
    if ((*(word*)(out_rice_surplus) < 0)) {    // $B320
