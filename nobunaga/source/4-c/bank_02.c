...
// $82A9 cur_unit_col_ptr
// (body @ $82AE)

word cur_unit_col_ptr(void) {
    return unit_col_ptr(cur_combat_side, cur_combat_unit_slot);    // $82B8
}

// $82B9 cur_unit_row_ptr
// (body @ $82BE)

word cur_unit_row_ptr(void) {
    return unit_row_ptr(cur_combat_side, cur_combat_unit_slot);    // $82C8
}

// $82C9 unit_strength_ptr
// (body @ $82CE)
...
word consume_daily_battle_rice(word strength_ptrs, word remainder_accum) {
    side = 0;    // $8311
    do {    // $8312
        daily_rice = *(word*)((side_resource_ptr(side) + 4));    // $8319
        ...
        *(word*)(((side << 1) + remainder_accum)) = (*(word*)(((side << 1) + remainder_accum)) + rice_remainder);    // $832D
        if (((unsigned)*(word*)(((side << 1) + remainder_accum)) >= (unsigned)30)) {    // $8312
        ...
        *(word*)(*(word*)(((side << 1) + strength_ptrs))) = (*(word*)(*(word*)(((side << 1) + strength_ptrs))) - drain);    // $834C
        if ((*(word*)(*(word*)(((side << 1) + strength_ptrs))) <= 0)) {    // $8342
...
// $836A side_has_rice_for_day
// (body @ $836F)

word side_has_rice_for_day(word arg1) {
    local11 = *(word*)((side_resource_ptr(arg1) + 4));    // $8376
    local10 = ((unsigned)*(word*)((side_resource_ptr(arg1) + 4)) / (unsigned)15);    // $8379
    if (((unsigned)local11 % (unsigned)15)) {    // $836F
        local10 = (local10 + 1);    // $8382
    }
    return ((unsigned)local10 <= (unsigned)*(word*)((side_resource_ptr(arg1) + 2)));    // $838E
}
...
word lookup_terrain_attr_record(word arg1, word arg2) {
    ...
    return ((local11 << 4) + terrain_attr_table);    // $840A
}
...
word read_dpad_dir_code(void) {
    switch (poll_input()) {    // $848D
        ...
        case 2:
            ...
            erase_cursor_advance_phase(phi_84ef_0);    // $84EF
        default:
            phi_val_84bf = 0;    // $84F4
            break;
    }
...
word wait_button_press_debounced(word arg1, word arg2) {
    set_tactical_cursor_pos(arg1, arg2);    // $8568
    while (1) {    // $856C
    ...
    switch (poll_input()) {    // $85AC
        case 64:
            if (!(is_cell_valid_for_phase(0))) {    // $85CD
                ...
                erase_cursor_advance_phase(phi_85ef_0);    // $85EF
...
word poll_cursor_input_until_button(word arg1, word arg2) {
    set_tactical_cursor_pos(arg1, arg2);    // $862A
    while (1) {    // $862E
...
word draw_tactical_terrain_feature(word arg1, word arg2) {
    phi_ret_8821 = is_cell_clear_of_bits(arg1, arg2, 2);    // $87C3
...
word upload_map_cell_tiles(word arg1, word arg2) {
    ...
    return ppu_upload_block_wrap(5, ((arg1 * 49) + daimyo_banner_chr), ((arg2 * 48) + 5392), 3);    // $885D
}
        ...
        do {    // $890C
            ...
            do {    // $8934
                ...
                do {    // $8936
                    ...
                    *(byte*)(((((local11 * 88) + ((local7 << 1) << 1)) + local8) + 0x7BFD)) = *(byte*)((local6 - 1));    // $894C
...
word draw_unit_count_digits(word arg1, word arg2) {
    local9 = *(byte*)(unit_col_ptr(arg1, arg2));    // $89EB
    local8 = *(byte*)(unit_row_ptr(arg1, arg2));    // $89F3
    if ((((unsigned)local9 > (unsigned)10) || ((unsigned)local8 > (unsigned)4))) {    // $89E4
        ...
        if (!(is_cell_valid_for_phase(local9))) {    // $8A01
            phi_ret_8b24 = erase_cursor_advance_phase(local9);    // $8A0E
        } else {
            calc_tactical_cell_coords(&local9, &local8);    // $8A19
            *(byte*)(((arg1 * 9) + 0x6FE5)) = (test_6f65_bit7(arg1) ? 178 : 179);    // $8A47
            local11 = min_word(*(word*)(unit_strength_ptr(arg1, arg2)), 0x270F);    // $8A57
            local7 = 0;    // $8A59
...
word draw_unit_counts_in_valid_cells(void) {
    ...
    do {    // $8B5F
        local9 = 0;    // $8B60
        do {    // $8B61
            local11 = *(byte*)(unit_col_ptr(local10, local9));    // $8B68
...
word combat_unit_window_refresh(void) {
    if ((combat_unit_window_mode_flag == 2)) {    // $8BEF
        ...
        do {    // $8BFD
            ...
            draw_message(msg_gold_4d_rice_4d_men_4d, *(word*)(side_resource_ptr(local11)), *(word*)((side_resource_ptr(local11) + 2)), *(word*)((side_resource_ptr(local11) + 4)));    // $8C4F
...
word draw_unit_roster_columns(word arg1) {
    ...
    local9 = side_resource_ptr(arg1);    // $8C83
        ...
        switch (ui_cursor_row) {    // $8C88
            ...
            case 11:
                if ((!(is_no_province_selected()) || arg1)) {    // $8CB1
                    ...
                    phi_8cc4_1 = *(byte*)((local11 - 1));    // $8CC1
            ...
            case 17:
                if ((!(is_no_province_selected()) || arg1)) {    // $8CF4
                    ...
                    phi_8cc4_1 = *(word*)((local10 + -2));    // $8D08
                    draw_message(phi_8cc4_0, phi_8cc4_1);    // $8CC4
                } else {
...
word ai_sum_battle_strength(void) {
    mem_7BEC = 0;    // $8E62
    battle_side_strength_mod = 0;    // $8E65
    ...
    while (1) {    // $8EA5
        ...
        if ((i < 5)) {    // $8EA5
            ...
            *(word*)(((((*(byte*)((attacker_stat_ptr - 1)) <= *(byte*)((defender_stat_ptr - 1))) ? 1 : 0) << 1) + 0x7BEA)) = (*(word*)(((((*(byte*)((attacker_stat_ptr - 1)) <= *(byte*)((defender_stat_ptr - 1))) ? 1 : 0) << 1) + 0x7BEA)) + *(byte*)((weight_ptr - 1)));    // $8EA2
    ...
    do {    // $8EC4
        ...
        *(word*)(((((*(word*)((attacker_fief_field + -2)) <= *(word*)((defender_fief_field + -2))) ? 1 : 0) << 1) + 0x7BEA)) = (*(word*)(((((*(word*)((attacker_fief_field + -2)) <= *(word*)((defender_fief_field + -2))) ? 1 : 0) << 1) + 0x7BEA)) + *(byte*)((weight_ptr - 1)));    // $8EEA
        i = (i + 1);    // $8EED
    } while ((i <= 7));
    return (i <= 7);    // $8EF4
}
...
word validate_dir_code_and_dispatch(word arg1, word arg2, word arg3) {
    if ((((unsigned)arg3 <= (unsigned)51) || ((unsigned)arg3 >= (unsigned)55))) {    // $8F2D
        arg3 = (arg3 - 49);    // $8F40
        if (((unsigned)arg3 >= (unsigned)6)) {    // $8F3B
            arg3 = (arg3 - 3);    // $8F4A
        }
...
word remove_unit(word arg1, word arg2) {
    war_side_state_flag[arg1] = (war_side_state_flag[arg1] & unit_presence_clear_masks[arg2]);    // $8FAC
    *(byte*)(unit_row_ptr(arg1, arg2)) = -56;    // $8FBD
    *(byte*)(unit_col_ptr(arg1, arg2)) = -56;    // $8FBE
    return -56;    // $8FBF
}
...
word side_has_unit_at_cell(word arg1, word arg2, word arg3) {
    ...
    do {    // $8FC7
        if ((*(byte*)(unit_col_ptr(arg1, local11)) == arg2)) {    // $8FC7
            if ((*(byte*)(unit_row_ptr(arg1, local11)) == arg3)) {    // $8FD3
                return 1;    // $8FE0
            }
        }
        ...
        if ((*(byte*)(src_cursor) != 255)) {    // $90F0
            if (!(province_state_is_FF(*(byte*)(src_cursor)))) {    // $90D0
                if ((fief_owner(*(byte*)(src_cursor)) == target_owner)) {    // $90DA
                    ...
                    *(byte*)((dst_ptr - 1)) = *(byte*)(src_cursor);    // $90ED
                }
            }
...
word paged_flee_fief_list_display(void) {
    ...
    while ((*(byte*)(local9) != 255)) {    // $9188
        ...
        draw_message(msg_fmt__2d_b5fd, (*(byte*)((local9 - 1)) + 1));    // $914E
        ...
        *(word*)(local9) = pct_op(local11, *(byte*)(local6));    // $920D
        ...
        do {    // $927B
            if (!(*(word*)(((local7 << 1) + local9)))) {    // $927B
                remove_unit(local8, local7);    // $9285
            }
...
word clear_all_unit_positions(void) {
    ...
    do {    // $92A3
        local10 = 0;    // $92A4
        do {    // $92A5
            *(byte*)(unit_row_ptr(local11, local10)) = -56;    // $92B5
            *(byte*)(unit_col_ptr(local11, local10)) = -56;    // $92B6
...
// $936A draw_combat_message
// (body @ $936F)

word draw_combat_message(word arg1, word arg2) {
    message_display(combat_msg_blank_str);    // $9372
    arg2 = (arg2 + 1);    // $9378
    return draw_message(*(word*)(((arg1 << 1) + combat_message_table)), arg2);    // $9386
}

// $9387 draw_unit_type_label
// (body @ $938C)

word draw_unit_type_label(void) {
    return draw_message(msg_unit_d_s, (cur_combat_unit_slot + 1), *(word*)(((((unsigned)(wrap_index_0_2_to_zero(cur_combat_unit_slot) + 1) % (unsigned)3) << 1) + unit_type_name_table)));    // $93A9
}
    ...
    if (get_province_ai_state(arg1)) {    // $93EA
        if (!(local8)) {    // $940B
            if (((unsigned)arg2 > (unsigned)7)) {    // $940F
                ...
                if (local7) {    // $9419
                    if ((arg2 == 1)) {    // $941D
                        if (!(is_unit_present(local7, 0))) {    // $9423
            ...
            if ((arg2 == 1)) {    // $9439
                if (!(side_has_rice_for_day(local7))) {    // $943F
                    arg2 = (arg2 + 1);    // $9449
                }
            }
            arg2 = (arg2 - 1);    // $944C
        }
        local6 = *(word*)(((arg2 << 1) + battle_conclusion_msgs_loser));    // $9453
            ...
            if (((unsigned)arg2 <= (unsigned)2)) {    // $948A
                ...
                if ((arg2 == 3)) {    // $94B4
                    ...
                    if (!(get_province_ai_state(local9))) {    // $94BA
                        ...
                        arg2 = (arg2 - 4);    // $94D9
                        if (((unsigned)arg2 <= (unsigned)3)) {    // $94D5
...
word announce_combat_side_daimyo_and_status(word arg1, word arg2) {
    ...
    if (get_province_ai_state(get_battle_side_province(cur_combat_side))) {    // $94FB
        ...
        if (!(is_unit_present(cur_combat_side, cur_combat_unit_slot))) {    // $9544
            if ((local10 == cur_combat_side)) {    // $9554
                phi_push_9560 = 7;    // $955F
            } else {
                phi_push_9560 = 5;    // $95BB
            }
            draw_combat_message(phi_push_9560, cur_combat_unit_slot);    // $9561
            phi_ret_9568 = clear_rect_left_lower_alt();    // $9565
        } else {
            phi_ret_9568 = is_unit_present((cur_combat_side ^ 1), arg2);    // $95AE
...
// $95BE erase_cursor_advance_phase
// (body @ $95C3)
...
word find_free_tactical_placement_cell(word arg1, word arg2) {
    ...
    do {    // $964E
        local10 = 0;    // $964F
        while (1) {    // $9650
            if (!(is_cell_clear_of_bits(local11, local10, 32))) {    // $9650
...
// $9735 tile_blocked_for_placement
// (body @ $973A)

word tile_blocked_for_placement(word arg1, word arg2) {
    if (!(cur_combat_side)) {    // $973A
        if (is_cell_clear_of_bits(arg1, arg2, 32)) {    // $9740
            if (!(is_cell_clear_of_bits(arg1, arg2, 8))) {    // $974B
                return 1;    // $9756
            } else {
...
word commit_unit_dest_tile_if_valid(word arg1, word arg2) {
    if (!((is_any_unit_at_tile(arg1, arg2) || is_map_cell_blocked(arg1, arg2) || tile_blocked_for_placement(arg1, arg2) || !(is_coord_in_combat_rect(arg1, arg2))))) {    // $9797
...
word commit_unit_move_and_redraw_count(word arg1, word arg2) {
    ...
    if (phi_ret_97f7) {    // $97DE
        ...
        phi_ret_97f7 = draw_unit_count_digits(cur_combat_side, (cur_combat_unit_slot - 1));    // $97F3
    }
    return phi_ret_97f7;    // $97F7
}

// $97F8 is_cur_unit_absent
// (body @ $97FD)

word is_cur_unit_absent(void) {
    return (is_unit_present(cur_combat_side, cur_combat_unit_slot) ? 0 : 1);    // $980F
}
    ...
    while (1) {    // $9855
        ...
        if (((unsigned)slot_idx < (unsigned)6)) {    // $9855
            if (((unsigned)cur_combat_unit_slot < (unsigned)max_slots)) {    // $985C
                if (is_cur_unit_absent()) {    // $9819
                    cur_combat_unit_slot = (cur_combat_unit_slot + 1);    // $9823
                } else {
                    tile_x = *(byte*)(unit_col_ptr(cur_combat_side, 0));    // $9832
                    tile_y = *(byte*)(unit_row_ptr(cur_combat_side, 0));    // $983C
        ...
        while (1) {    // $98EC
            ...
            if (((unsigned)unit_idx < (unsigned)cur_combat_unit_slot)) {    // $98EC
                if (((unsigned)cur_combat_unit_slot < (unsigned)5)) {    // $98F5
                    if (is_cur_unit_absent()) {    // $988B
                        cur_combat_unit_slot = (cur_combat_unit_slot + 1);    // $9895
                    } else {
                        unit_x = *(byte*)(unit_col_ptr(cur_combat_side, unit_idx));    // $98A4
                        unit_y = *(byte*)(unit_row_ptr(cur_combat_side, unit_idx));    // $98AE
                        dir = 0;    // $98B0
                        while (1) {    // $98B1
                            cand_x = unit_x;    // $98B2
                            cand_y = unit_y;    // $98B4
                            if (sub_8003(&cand_x, &cand_y, dir)) {    // $98B1
                                if (commit_unit_dest_tile_if_valid(cand_x, cand_y)) {    // $98C5
                                    ...
                                    draw_unit_count_digits(cur_combat_side, (cur_combat_unit_slot - 1));    // $98DA
                                    break;
                                } else {
                                    dir = (dir + 1);    // $98E3
...
word seek_enemy_adjacent_cell_and_commit_move(word arg1, word arg2) {
    ...
    if (((unsigned)local11 >= (unsigned)6)) {    // $9931
        if (commit_unit_dest_tile_if_valid(arg1, arg2)) {    // $9937
            ...
            draw_unit_count_digits(cur_combat_side, (cur_combat_unit_slot - 1));    // $994C
            return 1;    // $9951
        }
    }
    return 0;    // $9953
...
L_9A21:
    if (is_cur_unit_absent()) goto L_9AF5;    // $9A24
...
L_9A6F:
    ...
    goto L_9A81;    // $9A72
L_9A75:
    if (is_cell_clear_of_bits(local10, local9, 2)) goto L_9A95;    // $9A7C
...
L_9AC8:
    ...
    erase_cursor_advance_phase(local10);    // $9AD1
L_9AD5:
...
word validate_phase_unit_cells_draw_cursor(word arg1) {
    ...
    local10 = *(byte*)(unit_col_ptr(local8, arg1));    // $9B6A
    local9 = *(byte*)(unit_row_ptr(local8, arg1));    // $9B72
    if (!(is_cell_valid_for_phase(local10))) {    // $9B4F
        erase_cursor_advance_phase(local10);    // $9B7C
    }
    local11 = 0;    // $9B81
    do {    // $9B82
        set_tactical_cursor_pos(*(byte*)(cur_unit_col_ptr()), *(byte*)(cur_unit_row_ptr()));    // $9B8C
        draw_tactical_cursor_region(1);    // $9B91
        draw_tactical_cursor_region(0);    // $9B96
        set_tactical_cursor_pos(local10, local9);    // $9B9C
...
word ai_terrain_strength_term(word side, word unit_slot) {
    ...
    switch ((read_map_cell(*(byte*)(unit_col_ptr(side, unit_slot)), *(byte*)(unit_row_ptr(side, unit_slot))) & 254)) {    // $9BB9
        case 32:
...
word ai_province_stat_diff_term(word side, word unit_field) {
    ...
    while (((unsigned)i < (unsigned)3)) {    // $9C5F
        ...
        fief = (fief + 2);    // $9C3B
        stat_diff = (*(word*)((fief + -2)) - *(word*)((ref_fief + -2)));    // $9C41
        if (((*(word*)((fief + -2)) - *(word*)((ref_fief + -2))) > 0)) {    // $9C32
            total = (total + pct_op(*(word*)(unit_strength_ptr(side, unit_field)), (stat_diff / 100)));    // $9C5B
        }
        i = (i + 1);    // $9C5E
    }
    return (total * 3);    // $9C68
...
word ai_strength_term_gated_table_word(word unit, word idx, word gate_idx) {
    if (((unsigned)wrap_index_0_2_to_zero(idx) > (unsigned)wrap_index_0_2_to_zero(gate_idx))) {    // $9C6E
        return *(word*)(unit_strength_ptr(unit, idx));    // $9C85
    } else {
        return 0;    // $9C87
    }
}
...
word ai_eval_battle_strength_total(word side, word unit_slot, word other_unit_slot) {
    ...
    base_strength = *(word*)(unit_strength_ptr(side, unit_slot));    // $9C97
...
word apply_pct_reduction_to_unit_strength(word arg1, word arg2, word arg3) {
    local11 = unit_strength_ptr(arg1, arg2);    // $9D0E
...
word reduce_defending_province_town_chaos(word arg1, word arg2) {
    ...
    if (!((!(is_cell_clear_of_bits(*(byte*)(cur_unit_col_ptr()), *(byte*)(cur_unit_row_ptr()), 8)) || !(is_cell_clear_of_bits(*(byte*)(unit_col_ptr(local11, arg2)), *(byte*)(unit_row_ptr(local11, arg2)), 8))))) {    // $9DAD
        return is_cell_clear_of_bits(*(byte*)(unit_col_ptr(local11, arg2)), *(byte*)(unit_row_ptr(local11, arg2)), 8);    // $9DDD
    } else {
...
word resolve_attack_apply_casualties(word arg1, word arg2) {
    *(word*)(side_resource_ptr(cur_combat_side)) = (*(word*)(side_resource_ptr(cur_combat_side)) - arg2);    // $9E84
    ...
    if (!((combat_casualty_skip_flag_7bf3 || (local11 <= local10)))) {    // $9E78
        arg2 = (arg2 / *(word*)(unit_strength_ptr(local7, arg1)));    // $9EF3
        if ((arg2 > 0)) {    // $9EE9
            local11 = pct_op(*(word*)(unit_strength_ptr(local7, arg1)), math32_2arg((local11 - local10), local11));    // $9F10
            if (((*(word*)((side_resource_ptr(cur_combat_side) + 4)) + local11) > 0x270F)) {    // $9EFA
                local11 = (0x270F - *(word*)((side_resource_ptr(cur_combat_side) + 4)));    // $9F32
            }
            if (!(local11)) {    // $9F33
                ...
                *(word*)((side_resource_ptr(cur_combat_side) + 4)) = (*(word*)((side_resource_ptr(cur_combat_side) + 4)) + local11);    // $9F91
                ...
                if (get_province_ai_state(local9)) {    // $9FA9
                    message_display(combat_message_table);    // $9FB4
...
word unit_type_count_gt3_and_equals_arg1(word arg1) {
    ...
    while (1) {    // $A034
        ...
        if (((unsigned)local10 < (unsigned)5)) {    // $A034
            if (is_unit_present(cur_combat_side, local10)) {    // $A024
...
word is_unit_at_coords(word arg1, word arg2, word arg3, word arg4) {
    return (is_unit_present(arg3, arg4) && ((*(byte*)(unit_col_ptr(arg3, arg4)) == arg1) && (*(byte*)(unit_row_ptr(arg3, arg4)) == arg2)));    // $A079
}
...
word ai_place_units_near_enemy_loop(void) {
    dir = 0;    // $A19A
    do {    // $A19B
        tile_x = *(byte*)(cur_unit_col_ptr());    // $A19F
        tile_y = *(byte*)(cur_unit_row_ptr());    // $A1A4
        if (sub_8003(&tile_x, &tile_y, dir)) {    // $A19B
            ...
            while (1) {    // $A1C2
                ...
                if (!((*(byte*)((target_list_ptr - 1)) < 5))) {    // $A1C2
                    i = (i + 1);    // $A1CE
...
word bfs_path_distance_to_target(word arg1, word arg2) {
    local5 = *(byte*)(cur_unit_col_ptr());    // $A22A
    local4 = *(byte*)(cur_unit_row_ptr());    // $A22F
...
L_A24A:
    ...
    *(byte*)((local3 - 1)) = ((read_map_cell(local9, local8) & 194) ? 128 : 0);    // $A263
    ...
    local11 = 0;    // $A27F
L_A280:
    if (!(is_unit_present(cur_combat_side, local11))) goto L_A2AC;    // $A288
    *(byte*)((((*(byte*)(unit_row_ptr(cur_combat_side, local11)) * 11) + *(byte*)(unit_col_ptr(cur_combat_side, local11))) + &dist_grid)) = -128;    // $A2AB
L_A2AC:
...
word ai_step_unit_toward_target(word unit_x, word unit_y) {
    ...
    if (((unsigned)bfs_path_distance_to_target(unit_x, unit_y) > (unsigned)0)) {    // $A3C2
        unit_x = *(byte*)(cur_unit_col_ptr());    // $A3D2
        unit_y = *(byte*)(cur_unit_row_ptr());    // $A3D7
        steps_to_target = (steps_to_target - 1);    // $A3DA
        if (!((!(sub_8003(&unit_x, &unit_y, steps_to_target)) || !(place_unit_at_tile_if_free(unit_x, unit_y))))) {    // $A3CE
            return 1;    // $A3F5
        } else {
            return 0;    // $A3F7
        }
...
word ai_select_weak_reachable_enemy_target(void) {
    if (!(cur_combat_unit_slot)) {    // $A3FD
        ...
        list_cursor = build_reachable_enemy_target_list(*(byte*)(unit_col_ptr(cur_combat_side, 0)), *(byte*)(unit_row_ptr(cur_combat_side, 0)), &target_list_buf);    // $A421
        i = 0;    // $A423
        do {    // $A424
...
word ai_decide_unit_action_attack_or_advance(void) {
    ...
    target_unit_type = find_flagged_present_unit_type(build_reachable_enemy_target_list(*(byte*)(cur_unit_col_ptr()), *(byte*)(cur_unit_row_ptr()), &reachable_enemy_list));    // $A562
    if (((unsigned)find_flagged_present_unit_type(build_reachable_enemy_target_list(*(byte*)(cur_unit_col_ptr()), *(byte*)(cur_unit_row_ptr()), &reachable_enemy_list)) >= (unsigned)5)) {    // $A565
...
word ai_advance_units_toward_reachable_enemies(void) {
    if (ai_select_weak_reachable_enemy_target()) {    // $A5A9
        ...
        target_ptr = build_reachable_enemy_target_list(*(byte*)(unit_col_ptr(cur_combat_side, 0)), *(byte*)(unit_row_ptr(cur_combat_side, 0)), &target_count);    // $A5D2
        i = 0;    // $A5D4
        do {    // $A5D5
            if ((*(byte*)(target_ptr) < 5)) {    // $A5D5
                if (ai_step_unit_toward_target(*(byte*)(unit_col_ptr(enemy_side, *(byte*)(target_ptr))), *(byte*)(unit_row_ptr(enemy_side, *(byte*)(target_ptr))))) {    // $A5DC
                    return ai_step_unit_toward_target(*(byte*)(unit_col_ptr(enemy_side, *(byte*)(target_ptr))), *(byte*)(unit_row_ptr(enemy_side, *(byte*)(target_ptr))));    // $A5F7
                }
            }
            target_ptr = (target_ptr + 1);    // $A5FA
            i = (i + 1);    // $A5FE
        } while (((unsigned)i < (unsigned)6));
        phi_ret_a624 = ai_step_unit_toward_target(*(byte*)(unit_col_ptr(cur_combat_side, 0)), *(byte*)(unit_row_ptr(cur_combat_side, 0)));    // $A61E
...
word ai_advance_units_into_free_adjacent_cells(void) {
    if (ai_select_weak_reachable_enemy_target()) {    // $A62A
        ...
        origin_x = *(byte*)(cur_unit_col_ptr());    // $A635
        origin_y = *(byte*)(cur_unit_row_ptr());    // $A63A
        ...
        local11 = 0;    // $A685
        do {    // $A686
            if (is_unit_present(enemy_side, local11)) {    // $A686
                if (free_cell_found) {    // $A68F
                    if (!(local11)) {    // $A693
                        if (ai_step_unit_toward_target(*(byte*)(unit_col_ptr(enemy_side, 0)), *(byte*)(unit_row_ptr(enemy_side, 0)))) {    // $A697
                            return ai_step_unit_toward_target(*(byte*)(unit_col_ptr(enemy_side, 0)), *(byte*)(unit_row_ptr(enemy_side, 0)));    // $A6AE
                        }
                    }
                }
...
word ai_rng_resolve_combat_apply_casualties(void) {
    ...
    if (rng_mod((const_two + 1))) {    // $A726
        if (!((*(word*)(side_resource_ptr(cur_combat_side)) <= *(word*)((side_resource_ptr(cur_combat_side) + 4))))) {    // $A738
            if (!(is_no_province_selected())) {    // $A74F
                if (get_province_ai_state(get_battle_side_province(enemy_side))) {    // $A755
                    if (!(cur_combat_unit_slot)) {    // $A762
                        if (!((*(word*)((side_resource_ptr(cur_combat_side) + 4)) > (*(word*)((side_resource_ptr(enemy_side) + 4)) / 2)))) {    // $A768
                            if (!(((unsigned)*(word*)(((get_battle_side_province(enemy_side) * 26) + 0x7013)) > (unsigned)(const_two * 100)))) {    // $A780
                                ...
                                while (((unsigned)unit_type < (unsigned)5)) {    // $A7C4
                                    if (is_unit_present(enemy_side, unit_type)) {    // $A7A0
                                        if ((max_strength < *(word*)(unit_strength_ptr(enemy_side, unit_type)))) {    // $A7A9
                                            strongest_unit_type = unit_type;    // $A7B8
                                            max_strength = *(word*)(unit_strength_ptr(enemy_side, unit_type));    // $A7C0
                                        }
                                    }
                                    unit_type = (unit_type + 1);    // $A7C3
                                }
                                return resolve_attack_apply_casualties(strongest_unit_type, (*(word*)(side_resource_ptr(cur_combat_side)) - *(word*)((side_resource_ptr(cur_combat_side) + 4))));    // $A7E4
                            }
                        }
                    }
                }
...
word ai_own_double_lt_enemy_total(void) {
    ...
    while (((unsigned)i < (unsigned)6)) {    // $A83A
        if ((*(byte*)(target_ptr) < 5)) {    // $A813
            if (is_unit_present(enemy_side, *(byte*)(target_ptr))) {    // $A81A
                enemy_strength_total = (enemy_strength_total + *(word*)(unit_strength_ptr(enemy_side, *(byte*)(target_ptr))));    // $A831
            }
        }
        i = (i + 1);    // $A834
...
word player_move_unit_with_occupancy_check_loop(void) {
    ...
    while (1) {    // $A97F
        ...
        local7 = *(byte*)(cur_unit_col_ptr());    // $A98A
        local6 = *(byte*)(cur_unit_row_ptr());    // $A98F
        ...
        if (!((prompt_unit_move_direction_at_tile() == 48))) {    // $A97F
            if (validate_dir_code_and_dispatch(&local7, &local6, local8)) {    // $A99F
                if (is_tile_in_bounds(local7, local6)) {    // $A9AF
                    local10 = 0;    // $A9B9
                    while (1) {    // $A9BA
                        if ((*(byte*)(unit_col_ptr(local11, local10)) == local7)) {    // $A9BA
                            if (!((*(byte*)(unit_row_ptr(local11, local10)) == local6))) {    // $A9C6
    ...
    if ((is_no_province_selected() || (ai_turn_planner_resume_flag == 1))) {    // $AA00
        ...
        if (cur_combat_unit_slot) {    // $AA32
            ...
            if (prompt_province_selection(1, 5)) {    // $AA38
                ...
                if (!(is_unit_present((cur_combat_side ^ 1), target_idx))) {    // $AA49
                    phi_aa5e_0 = mem_B1C2;    // $AA5B
                    message_display(phi_aa5e_0);    // $AA5E
                } else {
                    local11 = (*(word*)(side_resource_ptr(cur_combat_side)) - *(word*)((side_resource_ptr(cur_combat_side) + 4)));    // $AA7B
                    if ((local11 <= 0)) {    // $AA67
...
word redraw_combat_side_window(void) {
    ...
    if (!(cur_combat_unit_slot)) {    // $AB3C
        redraw_window(*(word*)((((test_6f65_bit7(cur_combat_side) ? 18 : 19) << 1) + combat_message_table)));    // $AB61
    }
...
word check_commander_alive_both_sides(void) {
    if (!(is_unit_present(0, 0))) {    // $AB93
        battle_winner_province_sel = selected_province_idx;    // $AB9F
        return 5;    // $ABA3
    } else {
        if (!(is_unit_present(1, 0))) {    // $ABA4
...
word ai_run_all_units_combat_actions(word battle_phase) {
    ...
    while (1) {    // $AC72
        if (((unsigned)cur_combat_unit_slot < (unsigned)5)) {    // $AC72
            if (is_unit_present(cur_combat_side, cur_combat_unit_slot)) {    // $ABC5
                ...
                draw_unit_type_label();    // $AC12
                local10 = *(byte*)(cur_unit_col_ptr());    // $AC19
                if (!(is_cell_valid_for_phase(*(byte*)(cur_unit_col_ptr())))) {    // $AC06
                    erase_cursor_advance_phase(local10);    // $AC23
                }
                local10 = 1;    // $AC28
                do {    // $AC29
                    set_tactical_cursor_pos(*(byte*)(cur_unit_col_ptr()), *(byte*)(cur_unit_row_ptr()));    // $AC33
                ...
                action_result = ai_select_unit_combat_action(battle_phase, (unit_iter - 1));    // $AC56
...
word combat_command_dispatch_loop_per_unit(void) {
    ...
    while (1) {    // $AD2E
        if (((unsigned)cur_combat_unit_slot < (unsigned)5)) {    // $AD2E
            if (is_unit_present(cur_combat_side, cur_combat_unit_slot)) {    // $AC8C
                do {    // $AC99
                    ...
                    unit_cell = *(byte*)(cur_unit_col_ptr());    // $ACCE
...
word halve_defender_morale_for_breaching_attackers(void) {
    ...
    local11 = 0;    // $AD97
    while (1) {    // $AD98
        if (is_unit_present(0, local11)) {    // $AD98
            if (!(is_cell_clear_of_bits(*(byte*)(unit_col_ptr(0, local11)), *(byte*)(unit_row_ptr(0, local11)), 32))) {    // $ADA1
    ...
    if (is_no_province_selected()) {    // $AE69
        ...
        if (test_6f65_bit7(local7)) {    // $AE70
            ...
            if (local7) {    // $AEB6
                ...
                *(byte*)((local8 - 1)) = battle_defending_province;    // $AEC2
            } else {
...
word battle_init_driver(void) {
    ...
    if (result) {    // $B021
        ...
        side = 0;    // $B034
        do {    // $B035
            *(word*)(((side << 1) + &side_unit_ptr)) = (side_resource_ptr(side) + 2);    // $B044
