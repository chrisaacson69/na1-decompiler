...
word get_6f5d_or_ff(void) {
    ...
    if ((selected_record_idx_9e3c != 255)) {    // $CCFE
...
word ui_get_menu_count_7fcf(void) {
    ...
    if (((unsigned)(ui_cursor_row + 1) > (unsigned)27)) {    // $CDB4
            ...
            if ((mem_7FE1 == 255)) {    // $D1EE
                ...
                if (((unsigned)local11 >= (unsigned)8)) {    // $D214
                    ...
                    while (1) {    // $D220
                        ...
                        if (!((*(byte*)((local11 + 0x7FD5)) != ui_helper_d772(battle_defending_province)))) {    // $D220
                            break;
                        } else {
                            continue;
                        }
...
L_D16A:
    ...
    if (((unsigned)local11 > (unsigned)1)) {    // $D16B
        while (1) {    // $D1CA
            ...
            if ((*(byte*)((local11 + 0x7FD5)) != ui_helper_d772(local10))) {    // $D1CA
...
word reassign_fiefs_to_conqueror(void) {
    ...
    while (1) {    // $DF33
        ...
        if (((unsigned)local11 < (unsigned)scenario_fief_count)) {    // $DF33
            if ((ui_helper_d772(local11) == local9)) {    // $DEF6
...
word update_arms_table_dffe(word arg1, word arg2) {
    ...
    if (((unsigned)*(byte*)(((arg1 * 5) + 0x76AB)) > (unsigned)local11)) {    // $E003
...
word find_fiefs_of_owner(word arg1) {
    ...
    while (1) {    // $E44A
        ...
        if (((unsigned)local11 < (unsigned)scenario_fief_count)) {    // $E44A
            if ((ui_helper_d772(local11) == arg1)) {    // $E439
...
word marry_helper_e4dc(word arg1) {
    ...
    while (1) {    // $E501
        ...
        if ((*(byte*)(local11) != 255)) {    // $E501
            if ((ui_helper_d772(*(byte*)(local11)) != arg1)) {    // $E4EB
...
word find_record_9e3c(word arg1) {
    if (((unsigned)selected_record_idx_9e3c <= (unsigned)8)) {    // $E559
...
word map_helper_e5f2(word arg1) {
    if ((arg1 != selected_record_idx_9e3c)) {    // $E5F7
