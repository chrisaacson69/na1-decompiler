...
reset_handler:   sei                         ; 3C000:  78
            ...
            hex 8d 73 00 ; sta kernel_var_73    ; 3C03F:  8d 73 00
            lda #$00                    ; 3C042:  a9 00
...
b15_c072:   sta $0600,x                 ; 3C072:  9d 00 06
            ...
            lda #$ff                    ; 3C07E:  a9 ff
            sta ptr1_lo                     ; 3C080:  85 02
            lda #$05                    ; 3C082:  a9 05
            sta ptr1_hi                     ; 3C084:  85 03
            lda #$20                    ; 3C086:  a9 20
...
b15_c586:   pla                         ; 3C586:  68
            ...
            pla                         ; 3C58A:  68
            hex 8d 73 00 ; sta kernel_var_73    ; 3C58B:  8d 73 00
...
b15_c711:   hex ad 69 00 ; lda brk_jmp_target_hi    ; 3C711:  ad 69 00
...
b15_c7c9:   hex ee 79 00 ; inc music_voice_idx    ; 3C7C9:  ee 79 00
...
b15_c877:   hex ad 79 00 ; lda music_voice_idx    ; 3C877:  ad 79 00
            asl a                       ; 3C87A:  0a
            clc                         ; 3C87B:  18
...
b15_c894:   hex ad 73 00 ; lda kernel_var_73    ; 3C894:  ad 73 00
            pha                         ; 3C897:  48
            ldy #$05                    ; 3C898:  a0 05
...
b15_c906:   hex ad 79 00 ; lda music_voice_idx    ; 3C906:  ad 79 00
            asl a                       ; 3C909:  0a
            clc                         ; 3C90A:  18
...
tab_b15_cb10: ; 189 bytes
            ...
            sta $09                     ; 3CBD1:  85 09
            ldy #$03                    ; 3CBD3:  a0 03
            lda (ptr1_lo),y                 ; 3CBD5:  b1 02
            bmi b15_cc34                ; 3CBD7:  30 5b
            sta $44                     ; 3CBD9:  85 44
            dey                         ; 3CBDB:  88
            lda (ptr1_lo),y                 ; 3CBDC:  b1 02
            sta $45                     ; 3CBDE:  85 45
            lda #$00                    ; 3CBE0:  a9 00
            sta $40                     ; 3CBE2:  85 40
            sta $41                     ; 3CBE4:  85 41
...
vm_entry:   pla                         ; 3E823:  68
            ...
            sta $09                     ; 3E827:  85 09
            pla                         ; 3E829:  68
            sta ptr0_lo                     ; 3E82A:  85 00
            pla                         ; 3E82C:  68
            sta ptr0_hi                     ; 3E82D:  85 01
            ldy #$07                    ; 3E82F:  a0 07
            sec                         ; 3E831:  38
            lda ptr1_lo                     ; 3E832:  a5 02
            sbc #$09                    ; 3E834:  e9 09
            sta $0c                     ; 3E836:  85 0c
            lda ptr1_hi                     ; 3E838:  a5 03
            sbc #$00                    ; 3E83A:  e9 00
            sta $0d                     ; 3E83C:  85 0d
b15_e83e:   hex b9 00 00 ; lda ptr0_lo,y  ; 3E83E:  b9 00 00
            ...
            clc                         ; 3E848:  18
            lda $0c                     ; 3E849:  a5 0c
            sta ptr2_lo                     ; 3E84B:  85 04
            adc ($08),y                 ; 3E84D:  71 08
            sta ptr1_lo                     ; 3E84F:  85 02
            iny                         ; 3E851:  c8
            lda $0d                     ; 3E852:  a5 0d
            sta ptr2_hi                     ; 3E854:  85 05
            adc ($08),y                 ; 3E856:  71 08
            sta ptr1_hi                     ; 3E858:  85 03
            clc                         ; 3E85A:  18
            lda $08                     ; 3E85B:  a5 08
            adc #$03                    ; 3E85D:  69 03
            sta ptr3_lo                     ; 3E85F:  85 06
            lda $09                     ; 3E861:  a5 09
            adc #$00                    ; 3E863:  69 00
...
vm_op_load_tail:   clc                         ; 3E8AD:  18
            ...
            lda #$ff                    ; 3E8B2:  a9 ff
            adc ptr2_hi                     ; 3E8B4:  65 05
            sta ptr0_hi                     ; 3E8B6:  85 01
            lda (ptr0_lo),y                 ; 3E8B8:  b1 00
            sta $08                     ; 3E8BA:  85 08
            iny                         ; 3E8BC:  c8
            ...
            ldy #$0b                    ; 3E8D0:  a0 0b
b15_e8d2:   lda (ptr2_lo),y                 ; 3E8D2:  b1 04
            sta $08                     ; 3E8D4:  85 08
            iny                         ; 3E8D6:  c8
...
b15_e90c:   clc                         ; 3E90C:  18
            adc ptr2_lo                     ; 3E90D:  65 04
            sta ptr0_lo                     ; 3E90F:  85 00
            lda #$ff                    ; 3E911:  a9 ff
            adc ptr2_hi                     ; 3E913:  65 05
            sta ptr0_hi                     ; 3E915:  85 01
            lda (ptr0_lo),y                 ; 3E917:  b1 00
            sta $0c                     ; 3E919:  85 0c
            iny                         ; 3E91B:  c8
            ...
            ldy #$0b                    ; 3E92F:  a0 0b
b15_e931:   lda (ptr2_lo),y                 ; 3E931:  b1 04
            sta $0c                     ; 3E933:  85 0c
            iny                         ; 3E935:  c8
...
b15_e96b:   clc                         ; 3E96B:  18
            adc ptr2_lo                     ; 3E96C:  65 04
            sta ptr0_lo                     ; 3E96E:  85 00
            lda #$ff                    ; 3E970:  a9 ff
            adc ptr2_hi                     ; 3E972:  65 05
            sta ptr0_hi                     ; 3E974:  85 01
            lda $08                     ; 3E976:  a5 08
            sta (ptr0_lo),y                 ; 3E978:  91 00
            iny                         ; 3E97A:  c8
            lda $09                     ; 3E97B:  a5 09
...
b15_e9ca:   clc                         ; 3E9CA:  18
            adc ptr2_lo                     ; 3E9CB:  65 04
            sta ptr0_lo                     ; 3E9CD:  85 00
            lda #$ff                    ; 3E9CF:  a9 ff
            adc ptr2_hi                     ; 3E9D1:  65 05
            sta ptr0_hi                     ; 3E9D3:  85 01
            iny                         ; 3E9D5:  c8
            lda (ptr0_lo),y                 ; 3E9D6:  b1 00
            tax                         ; 3E9D8:  aa
            dey                         ; 3E9D9:  88
            lda (ptr0_lo),y                 ; 3E9DA:  b1 00
            ...
            ldy #$0c                    ; 3E9EB:  a0 0c
b15_e9ed:   lda (ptr2_lo),y                 ; 3E9ED:  b1 04
            tax                         ; 3E9EF:  aa
            dey                         ; 3E9F0:  88
            lda (ptr2_lo),y                 ; 3E9F1:  b1 04
...
b15_ea37:   lda (ptr0_lo),y                 ; 3EA37:  b1 00
            sta $08                     ; 3EA39:  85 08
            iny                         ; 3EA3B:  c8
...
b15_ea7d:   iny                         ; 3EA7D:  c8
            lda (ptr0_lo),y                 ; 3EA7E:  b1 00
            tax                         ; 3EA80:  aa
            dey                         ; 3EA81:  88
            lda (ptr0_lo),y                 ; 3EA82:  b1 00
...
vm_call_native:   sec                         ; 3EB57:  38
            ...
            dec ptr1_hi                     ; 3EB60:  c6 03
b15_eb62:   lda ptr3_lo                     ; 3EB62:  a5 06
            sta (ptr1_lo),y                 ; 3EB64:  91 02
            iny                         ; 3EB66:  c8
            lda ptr3_hi                     ; 3EB67:  a5 07
            sta (ptr1_lo),y                 ; 3EB69:  91 02
            jsr tab_b15_eb7a            ; 3EB6B:  20 7a eb
            clc                         ; 3EB6E:  18
            lda ptr1_lo                     ; 3EB6F:  a5 02
            adc #$02                    ; 3EB71:  69 02
            sta ptr1_lo                     ; 3EB73:  85 02
            bcc b15_eb79                ; 3EB75:  90 02
            inc ptr1_hi                     ; 3EB77:  e6 03
...
b15_ec0f:   jsr b15_ef97                ; 3EC0F:  20 97 ef
            ...
            lda (ptr3_lo),y                 ; 3EC1D:  b1 06
            tax                         ; 3EC1F:  aa
            iny                         ; 3EC20:  c8
            lda (ptr3_lo),y                 ; 3EC21:  b1 06
            sta $0c                     ; 3EC23:  85 0c
            clc                         ; 3EC25:  18
            lda ptr3_lo                     ; 3EC26:  a5 06
            adc #$02                    ; 3EC28:  69 02
            sta ptr3_lo                     ; 3EC2A:  85 06
            bcc b15_ec30                ; 3EC2C:  90 02
            inc ptr3_hi                     ; 3EC2E:  e6 07
...
b15_ec3c:   dex                         ; 3EC3C:  ca
            lda (ptr3_lo),y                 ; 3EC3D:  b1 06
            cmp $08                     ; 3EC3F:  c5 08
            bne b15_ec4a                ; 3EC41:  d0 07
            iny                         ; 3EC43:  c8
            lda (ptr3_lo),y                 ; 3EC44:  b1 06
            cmp $09                     ; 3EC46:  c5 09
            beq b15_ec57                ; 3EC48:  f0 0d
b15_ec4a:   clc                         ; 3EC4A:  18
            lda ptr3_lo                     ; 3EC4B:  a5 06
            adc #$04                    ; 3EC4D:  69 04
            sta ptr3_lo                     ; 3EC4F:  85 06
            bcc b15_ec30                ; 3EC51:  90 dd
            inc ptr3_hi                     ; 3EC53:  e6 07
            bcs b15_ec30                ; 3EC55:  b0 d9
b15_ec57:   iny                         ; 3EC57:  c8
            lda (ptr3_lo),y                 ; 3EC58:  b1 06
            tax                         ; 3EC5A:  aa
            iny                         ; 3EC5B:  c8
            ...
            sta $08                     ; 3EC6A:  85 08
            iny                         ; 3EC6C:  c8
            lda (ptr3_lo),y                 ; 3EC6D:  b1 06
            adc $09                     ; 3EC6F:  65 09
            sta $09                     ; 3EC71:  85 09
            iny                         ; 3EC73:  c8
            lda $08                     ; 3EC74:  a5 08
            cmp (ptr3_lo),y                 ; 3EC76:  d1 06
            iny                         ; 3EC78:  c8
            lda $09                     ; 3EC79:  a5 09
            sbc (ptr3_lo),y                 ; 3EC7B:  f1 06
            iny                         ; 3EC7D:  c8
            bcs b15_ec91                ; 3EC7E:  b0 11
            lda $08                     ; 3EC80:  a5 08
            asl a                       ; 3EC82:  0a
            rol $09                     ; 3EC83:  26 09
            adc ptr3_lo                     ; 3EC85:  65 06
            sta ptr3_lo                     ; 3EC87:  85 06
            lda $09                     ; 3EC89:  a5 09
            adc ptr3_hi                     ; 3EC8B:  65 07
            sta ptr3_hi                     ; 3EC8D:  85 07
            ldy #$06                    ; 3EC8F:  a0 06
b15_ec91:   lda (ptr3_lo),y                 ; 3EC91:  b1 06
            tax                         ; 3EC93:  aa
            iny                         ; 3EC94:  c8
...
b15_ecdb:   lda (ptr1_lo),y                 ; 3ECDB:  b1 02
            sta $0c                     ; 3ECDD:  85 0c
            iny                         ; 3ECDF:  c8
            lda (ptr1_lo),y                 ; 3ECE0:  b1 02
            sta $0d                     ; 3ECE2:  85 0d
            clc                         ; 3ECE4:  18
            lda ptr1_lo                     ; 3ECE5:  a5 02
            adc #$02                    ; 3ECE7:  69 02
            sta ptr1_lo                     ; 3ECE9:  85 02
            bcc b15_ecef                ; 3ECEB:  90 02
            inc ptr1_hi                     ; 3ECED:  e6 03
b15_ecef:   rts                         ; 3ECEF:  60

            ldy #$00                    ; 3ECF0:  a0 00
            sty ptr0_lo                     ; 3ECF2:  84 00
            sty ptr0_hi                     ; 3ECF4:  84 01
            ldy #$10                    ; 3ECF6:  a0 10
b15_ecf8:   lda $08                     ; 3ECF8:  a5 08
            lsr a                       ; 3ECFA:  4a
            bcc b15_ed0a                ; 3ECFB:  90 0d
            clc                         ; 3ECFD:  18
            lda ptr0_lo                     ; 3ECFE:  a5 00
            adc $0c                     ; 3ED00:  65 0c
            sta ptr0_lo                     ; 3ED02:  85 00
            lda ptr0_hi                     ; 3ED04:  a5 01
            adc $0d                     ; 3ED06:  65 0d
            sta ptr0_hi                     ; 3ED08:  85 01
b15_ed0a:   ror ptr0_hi                     ; 3ED0A:  66 01
            ror ptr0_lo                     ; 3ED0C:  66 00
            ror $09                     ; 3ED0E:  66 09
            ror $08                     ; 3ED10:  66 08
            dey                         ; 3ED12:  88
...
b15_ed2e:   ldy #$00                    ; 3ED2E:  a0 00
            sty ptr0_lo                     ; 3ED30:  84 00
            sty ptr0_hi                     ; 3ED32:  84 01
            ldy #$10                    ; 3ED34:  a0 10
b15_ed36:   asl $08                     ; 3ED36:  06 08
            rol $09                     ; 3ED38:  26 09
            rol ptr0_lo                     ; 3ED3A:  26 00
            rol ptr0_hi                     ; 3ED3C:  26 01
            sec                         ; 3ED3E:  38
            lda ptr0_lo                     ; 3ED3F:  a5 00
            sbc $0c                     ; 3ED41:  e5 0c
            tax                         ; 3ED43:  aa
            lda ptr0_hi                     ; 3ED44:  a5 01
            sbc $0d                     ; 3ED46:  e5 0d
            bcc b15_ed50                ; 3ED48:  90 06
            stx ptr0_lo                     ; 3ED4A:  86 00
            sta ptr0_hi                     ; 3ED4C:  85 01
            inc $08                     ; 3ED4E:  e6 08
b15_ed50:   dey                         ; 3ED50:  88
            ...
            lda ptr0_lo                     ; 3ED5A:  a5 00
            sta $08                     ; 3ED5C:  85 08
            lda ptr0_hi                     ; 3ED5E:  a5 01
            sta $09                     ; 3ED60:  85 09
            lda $0b                     ; 3ED62:  a5 0b
...
b15_ef48:   dec $08                     ; 3EF48:  c6 08
            ...
            sta $0c                     ; 3EF79:  85 0c
            lda ptr2_hi                     ; 3EF7B:  a5 05
            sta $0d                     ; 3EF7D:  85 0d
b15_ef7f:   lda ($0c),y                 ; 3EF7F:  b1 0c
            hex 99 00 00 ; sta ptr0_lo,y  ; 3EF81:  99 00 00
            dey                         ; 3EF84:  88
            bpl b15_ef7f                ; 3EF85:  10 f8
            inc ptr0_lo                     ; 3EF87:  e6 00
            bne b15_ef8f                ; 3EF89:  d0 04
            inc ptr0_hi                     ; 3EF8B:  e6 01
            ldx #$00                    ; 3EF8D:  a2 00
b15_ef8f:   jmp (ptr0_lo)                 ; 3EF8F:  6c 00 00
...
b15_ef97:   ldx #$00                    ; 3EF97:  a2 00
            ...
            dex                         ; 3EF9D:  ca
b15_ef9e:   inc ptr3_lo                     ; 3EF9E:  e6 06
            bne b15_efa4                ; 3EFA0:  d0 02
            inc ptr3_hi                     ; 3EFA2:  e6 07
b15_efa4:   clc                         ; 3EFA4:  18
            rts                         ; 3EFA5:  60

b15_efa6:   clc                         ; 3EFA6:  18
            ldx #$00                    ; 3EFA7:  a2 00
            lda (ptr3_lo),y                 ; 3EFA9:  b1 06
            bpl b15_efae                ; 3EFAB:  10 01
            dex                         ; 3EFAD:  ca
b15_efae:   adc ptr2_lo                     ; 3EFAE:  65 04
            sta ptr0_lo                     ; 3EFB0:  85 00
            txa                         ; 3EFB2:  8a
            adc ptr2_hi                     ; 3EFB3:  65 05
            sta ptr0_hi                     ; 3EFB5:  85 01
            inc ptr3_lo                     ; 3EFB7:  e6 06
            bne b15_efbd                ; 3EFB9:  d0 02
            inc ptr3_hi                     ; 3EFBB:  e6 07
b15_efbd:   clc                         ; 3EFBD:  18
            rts                         ; 3EFBE:  60

b15_efbf:   iny                         ; 3EFBF:  c8
            lda (ptr3_lo),y                 ; 3EFC0:  b1 06
            tax                         ; 3EFC2:  aa
            dey                         ; 3EFC3:  88
            lda (ptr3_lo),y                 ; 3EFC4:  b1 06
            pha                         ; 3EFC6:  48
            clc                         ; 3EFC7:  18
            lda ptr3_lo                     ; 3EFC8:  a5 06
            adc #$02                    ; 3EFCA:  69 02
            sta ptr3_lo                     ; 3EFCC:  85 06
            bcc b15_efd3                ; 3EFCE:  90 03
            inc ptr3_hi                     ; 3EFD0:  e6 07
            clc                         ; 3EFD2:  18
...
vm_read_word_into_ptr0:   lda (ptr3_lo),y                 ; 3EFD5:  b1 06
            ...
            sta ptr0_hi                     ; 3EFDC:  85 01
            dey                         ; 3EFDE:  88
            clc                         ; 3EFDF:  18
            lda ptr3_lo                     ; 3EFE0:  a5 06
            adc #$02                    ; 3EFE2:  69 02
            sta ptr3_lo                     ; 3EFE4:  85 06
            bcc b15_efeb                ; 3EFE6:  90 03
            inc ptr3_hi                     ; 3EFE8:  e6 07
            clc                         ; 3EFEA:  18
b15_efeb:   rts                         ; 3EFEB:  60

b15_efec:   clc                         ; 3EFEC:  18
            lda (ptr3_lo),y                 ; 3EFED:  b1 06
            adc ptr2_lo                     ; 3EFEF:  65 04
            sta ptr0_lo                     ; 3EFF1:  85 00
            iny                         ; 3EFF3:  c8
            lda (ptr3_lo),y                 ; 3EFF4:  b1 06
            adc ptr2_hi                     ; 3EFF6:  65 05
            sta ptr0_hi                     ; 3EFF8:  85 01
            dey                         ; 3EFFA:  88
            clc                         ; 3EFFB:  18
            lda ptr3_lo                     ; 3EFFC:  a5 06
            adc #$02                    ; 3EFFE:  69 02
            sta ptr3_lo                     ; 3F000:  85 06
            bcc b15_f007                ; 3F002:  90 03
            inc ptr3_hi                     ; 3F004:  e6 07
            clc                         ; 3F006:  18
b15_f007:   rts                         ; 3F007:  60

b15_f008:   tay                         ; 3F008:  a8
            sec                         ; 3F009:  38
            lda ptr1_lo                     ; 3F00A:  a5 02
            sbc #$02                    ; 3F00C:  e9 02
            sta ptr1_lo                     ; 3F00E:  85 02
            bcs b15_f014                ; 3F010:  b0 02
            dec ptr1_hi                     ; 3F012:  c6 03
b15_f014:   tya                         ; 3F014:  98
            ldy #$00                    ; 3F015:  a0 00
            sta (ptr1_lo),y                 ; 3F017:  91 02
            iny                         ; 3F019:  c8
            txa                         ; 3F01A:  8a
...
b15_f228:   lda (ptr1_lo),y                 ; 3F228:  b1 02
            ...
            lda (ptr3_lo),y                 ; 3F246:  b1 06
            inc ptr3_lo                     ; 3F248:  e6 06
            bne b15_f24e                ; 3F24A:  d0 02
            inc ptr3_hi                     ; 3F24C:  e6 07
b15_f24e:   asl a                       ; 3F24E:  0a
            tax                         ; 3F24F:  aa
            lda b15_f260+1,x            ; 3F250:  bd 61 f2
            sta ptr0_lo                     ; 3F253:  85 00
            lda b15_f260+2,x            ; 3F255:  bd 62 f2
            sta ptr0_hi                     ; 3F258:  85 01
            lda #$e8                    ; 3F25A:  a9 e8
            pha                         ; 3F25C:  48
            lda #$66                    ; 3F25D:  a9 66
            pha                         ; 3F25F:  48
b15_f260:   jmp (ptr0_lo)                 ; 3F260:  6c 00 00
...
b15_f328:   asl $08                     ; 3F328:  06 08
            ...
            lda $10                     ; 3F339:  a5 10
            sbc $0c                     ; 3F33B:  e5 0c
            sta ptr0_lo                     ; 3F33D:  85 00
            lda $11                     ; 3F33F:  a5 11
            sbc $0d                     ; 3F341:  e5 0d
            sta ptr0_hi                     ; 3F343:  85 01
            lda $12                     ; 3F345:  a5 12
            sbc $0e                     ; 3F347:  e5 0e
            tax                         ; 3F349:  aa
            lda $13                     ; 3F34A:  a5 13
            ...
            stx $12                     ; 3F350:  86 12
            sta $13                     ; 3F352:  85 13
            lda ptr0_lo                     ; 3F354:  a5 00
            sta $10                     ; 3F356:  85 10
            lda ptr0_hi                     ; 3F358:  a5 01
            sta $11                     ; 3F35A:  85 11
            inc $08                     ; 3F35C:  e6 08
...
b15_f552:   lda (ptr0_lo),y                 ; 3F552:  b1 00
...
b15_f560:   lda (ptr0_lo),y                 ; 3F560:  b1 00
...
b15_f58e:   sec                         ; 3F58E:  38
            ...
            sbc #$04                    ; 3F591:  e9 04
            sta ptr1_lo                     ; 3F593:  85 02
            bcs b15_f599                ; 3F595:  b0 02
            dec ptr1_hi                     ; 3F597:  c6 03
b15_f599:   ldy #$03                    ; 3F599:  a0 03
b15_f59b:   lda (ptr0_lo),y                 ; 3F59B:  b1 00
            sta (ptr1_lo),y                 ; 3F59D:  91 02
            dey                         ; 3F59F:  88
            bpl b15_f59b                ; 3F5A0:  10 f9
            rts                         ; 3F5A2:  60

            lda #$08                    ; 3F5A3:  a9 08
            sta ptr0_lo                     ; 3F5A5:  85 00
            sty ptr0_hi                     ; 3F5A7:  84 01
            jmp b15_f58e                ; 3F5A9:  4c 8e f5

            ldy #$03                    ; 3F5AC:  a0 03
b15_f5ae:   lda (ptr1_lo),y                 ; 3F5AE:  b1 02
            hex 99 0c 00 ; sta $000c,y  ; 3F5B0:  99 0c 00
            dey                         ; 3F5B3:  88
            bpl b15_f5ae                ; 3F5B4:  10 f8
            clc                         ; 3F5B6:  18
            lda ptr1_lo                     ; 3F5B7:  a5 02
            adc #$04                    ; 3F5B9:  69 04
            sta ptr1_lo                     ; 3F5BB:  85 02
            bcc b15_f5c1                ; 3F5BD:  90 02
            inc ptr1_hi                     ; 3F5BF:  e6 03
b15_f5c1:   rts                         ; 3F5C1:  60

            lda $08                     ; 3F5C2:  a5 08
            sta ptr0_lo                     ; 3F5C4:  85 00
            lda $09                     ; 3F5C6:  a5 09
            sta ptr0_hi                     ; 3F5C8:  85 01
            jmp b15_f550                ; 3F5CA:  4c 50 f5

b15_f5cd:   pha                         ; 3F5CD:  48
            hex b9 00 00 ; lda ptr0_lo,y  ; 3F5CE:  b9 00 00
            sta ptr0_lo                     ; 3F5D1:  85 00
            hex b9 01 00 ; lda ptr0_hi,y  ; 3F5D3:  b9 01 00
            sta ptr0_hi                     ; 3F5D6:  85 01
            ldy #$00                    ; 3F5D8:  a0 00
            lda (ptr0_lo),y                 ; 3F5DA:  b1 00
            sta $08                     ; 3F5DC:  85 08
            iny                         ; 3F5DE:  c8
            lda (ptr0_lo),y                 ; 3F5DF:  b1 00
            sta $09                     ; 3F5E1:  85 09
            txa                         ; 3F5E3:  8a
...
b15_f603:   jsr b15_f5cd                ; 3F603:  20 cd f5
            ...
            lsr a                       ; 3F60C:  4a
            and $09                     ; 3F60D:  25 09
            sta ptr0_lo                     ; 3F60F:  85 00
            lda $0a                     ; 3F611:  a5 0a
            eor #$ff                    ; 3F613:  49 ff
            sta $0a                     ; 3F615:  85 0a
            ror a                       ; 3F617:  6a
            and $08                     ; 3F618:  25 08
            ora ptr0_lo                     ; 3F61A:  05 00
...
b15_f62c:   pha                         ; 3F62C:  48
            hex b9 00 00 ; lda ptr0_lo,y  ; 3F62D:  b9 00 00
            sta ptr0_lo                     ; 3F630:  85 00
            hex b9 01 00 ; lda ptr0_hi,y  ; 3F632:  b9 01 00
            sta ptr0_hi                     ; 3F635:  85 01
            pla                         ; 3F637:  68
...
b15_f656:   hex b9 0a 00 ; lda $000a,y  ; 3F656:  b9 0a 00
            eor #$ff                    ; 3F659:  49 ff
            and (ptr0_lo),y                 ; 3F65B:  31 00
            hex 19 08 00 ; ora $0008,y  ; 3F65D:  19 08 00
            sta (ptr0_lo),y                 ; 3F660:  91 00
            dey                         ; 3F662:  88
...
b15_f929:   jmp ($4100)                 ; 3F929:  6c 00 41
            ...
            hex 6e 73 00 ; ror kernel_var_73    ; 3FC6B:  6e 73 00
            eor #$74                    ; 3FC6E:  49 74
