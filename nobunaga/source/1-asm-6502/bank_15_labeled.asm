...
reset_handler:   sei                         ; 3C000:  78
            ...
            hex 8d 73 00 ; sta prg_bank_shadow    ; 3C03F:  8d 73 00
            lda #$00                    ; 3C042:  a9 00
...
b15_c05e:   hex 9d 90 00 ; sta palette_alt,x  ; 3C05E:  9d 90 00
            ...
            lda #$ff                    ; 3C069:  a9 ff
            hex 8d 74 00 ; sta palette_dirty    ; 3C06B:  8d 74 00
            ldx #$00                    ; 3C06E:  a2 00
            lda #$f8                    ; 3C070:  a9 f8
b15_c072:   sta oam_shadow,x                 ; 3C072:  9d 00 06
            ...
            lda #$ff                    ; 3C07E:  a9 ff
            sta vm_sp_lo                     ; 3C080:  85 02
            lda #$05                    ; 3C082:  a9 05
            sta vm_sp_hi                     ; 3C084:  85 03
            lda #$20                    ; 3C086:  a9 20
            sta ppu_queue_a_lo                     ; 3C088:  85 1c
            lda #$00                    ; 3C08A:  a9 00
            sta ppu_queue_a_hi                     ; 3C08C:  85 1d
            lda #$30                    ; 3C08E:  a9 30
            sta ppu_queue_b_lo                     ; 3C090:  85 1e
            lda #$00                    ; 3C092:  a9 00
            sta ppu_queue_b_hi                     ; 3C094:  85 1f
            lda #$1f                    ; 3C096:  a9 1f
            ...
            ldx #$00                    ; 3C0A0:  a2 00
            lda #$00                    ; 3C0A2:  a9 00
b15_c0a4:   sta audio_mute_triangle,x                 ; 3C0A4:  9d 20 07
            inx                         ; 3C0A7:  e8
            cpx #$05                    ; 3C0A8:  e0 05
            bne b15_c0a4                ; 3C0AA:  d0 f8
            ldx #$00                    ; 3C0AC:  a2 00
b15_c0ae:   lda #$00                    ; 3C0AE:  a9 00
            sta v0_trigger,x                 ; 3C0B0:  9d 34 07
            txa                         ; 3C0B3:  8a
            clc                         ; 3C0B4:  18
            adc #$09                    ; 3C0B5:  69 09
            tax                         ; 3C0B7:  aa
            ...
            lda #$04                    ; 3C0BC:  a9 04
            hex 8d 83 00 ; sta clock_a_hi    ; 3C0BE:  8d 83 00
            hex 8d 85 00 ; sta clock_b_hi    ; 3C0C1:  8d 85 00
            lda #$d2                    ; 3C0C4:  a9 d2
            hex 8d 84 00 ; sta clock_a_lo    ; 3C0C6:  8d 84 00
            hex 8d 86 00 ; sta clock_b_lo    ; 3C0C9:  8d 86 00
            lda #$00                    ; 3C0CC:  a9 00
            hex 8d 89 00 ; sta skip_wallclock    ; 3C0CE:  8d 89 00
            jsr nmi_on                ; 3C0D1:  20 8a c6
            jsr reset_ppu_init                ; 3C0D4:  20 57 c7
            jmp $8000                   ; 3C0D7:  4c 00 80

nmi_handler:   pha                         ; 3C0DA:  48
            txa                         ; 3C0DB:  8a
            pha                         ; 3C0DC:  48
            tya                         ; 3C0DD:  98
            pha                         ; 3C0DE:  48
            ...
            jsr music_driver         ; 3C101:  20 a5 c7
            hex ad 89 00 ; lda skip_wallclock    ; 3C104:  ad 89 00
            bne b15_c12b                ; 3C107:  d0 22
            clc                         ; 3C109:  18
            hex ad 86 00 ; lda clock_b_lo    ; 3C10A:  ad 86 00
            adc #$02                    ; 3C10D:  69 02
            hex 8d 86 00 ; sta clock_b_lo    ; 3C10F:  8d 86 00
            hex ad 85 00 ; lda clock_b_hi    ; 3C112:  ad 85 00
            adc #$00                    ; 3C115:  69 00
            hex 8d 85 00 ; sta clock_b_hi    ; 3C117:  8d 85 00
            clc                         ; 3C11A:  18
            hex ad 84 00 ; lda clock_a_lo    ; 3C11B:  ad 84 00
            adc #$02                    ; 3C11E:  69 02
            hex 8d 84 00 ; sta clock_a_lo    ; 3C120:  8d 84 00
            hex ad 83 00 ; lda clock_a_hi    ; 3C123:  ad 83 00
            adc #$00                    ; 3C126:  69 00
...
irq_handler:   pha                         ; 3C139:  48
            ...
            lda #$00                    ; 3C146:  a9 00
            hex 8d 66 00 ; sta brk_scratch_lo    ; 3C148:  8d 66 00
            hex 8d 67 00 ; sta brk_scratch_hi    ; 3C14B:  8d 67 00
            lda #$c1                    ; 3C14E:  a9 c1
            pha                         ; 3C150:  48
            lda #$6c                    ; 3C151:  a9 6c
            pha                         ; 3C153:  48
            ...
            tya                         ; 3C15D:  98
            adc #$73                    ; 3C15E:  69 73
            hex 8d 68 00 ; sta brk_jmp_target_lo    ; 3C160:  8d 68 00
            txa                         ; 3C163:  8a
            adc #$c1                    ; 3C164:  69 c1
            hex 8d 69 00 ; sta brk_jmp_target_hi    ; 3C166:  8d 69 00
            jmp (brk_jmp_target_lo)                 ; 3C169:  6c 68 00
...
syscall_dispatch_table: hex 4c 00 c0 4c 64 c2 4c 4b ; 3C173:  4c 00 c0 4c 64 c2 4c 4b
...
b15_c1d7:   lda b15_c226,y              ; 3C1D7:  b9 26 c2
            hex 8d 75 00 ; sta mul_acc_lo    ; 3C1DA:  8d 75 00
            lda #$08                    ; 3C1DD:  a9 08
...
b15_c1e5:   hex 3e 8a 00 ; rol $008a,x  ; 3C1E5:  3e 8a 00
            ...
            hex 0e 75 00 ; asl mul_acc_lo    ; 3C1EB:  0e 75 00
            bcc b15_c1ff                ; 3C1EE:  90 0f
            ldx #$05                    ; 3C1F0:  a2 05
            clc                         ; 3C1F2:  18
b15_c1f3:   hex bd 83 00 ; lda clock_a_hi,x  ; 3C1F3:  bd 83 00
...
b15_c20a:   hex bd 8a 00 ; lda $008a,x  ; 3C20A:  bd 8a 00
            eor #$ff                    ; 3C20D:  49 ff
            adc #$00                    ; 3C20F:  69 00
            hex 9d 83 00 ; sta clock_a_hi,x  ; 3C211:  9d 83 00
            dex                         ; 3C214:  ca
            bpl b15_c20a                ; 3C215:  10 f3
            hex ad 83 00 ; lda clock_a_hi    ; 3C217:  ad 83 00
            and #$7f                    ; 3C21A:  29 7f
            hex 8d 67 00 ; sta brk_scratch_hi    ; 3C21C:  8d 67 00
            hex ad 84 00 ; lda clock_a_lo    ; 3C21F:  ad 84 00
            hex 8d 66 00 ; sta brk_scratch_lo    ; 3C222:  8d 66 00
            rts                         ; 3C225:  60

b15_c226:   cmp $87                     ; 3C226:  c5 87
            ora ($0e,x)                 ; 3C228:  01 0e
            bcc b15_c20a+2              ; 3C22A:  90 e0
syscall_memcpy_banked: hex ad 73 00 ; lda prg_bank_shadow    ; 3C22C:  ad 73 00
            pha                         ; 3C22F:  48
...
syscall_ppu_upload_block: hex ad 73 00 ; lda prg_bank_shadow    ; 3C264:  ad 73 00
            pha                         ; 3C267:  48
            ...
            hex 8d 69 00 ; sta brk_jmp_target_hi    ; 3C27D:  8d 69 00
            hex ad 54 00 ; lda $0054    ; 3C280:  ad 54 00
            hex 8d 68 00 ; sta brk_jmp_target_lo    ; 3C283:  8d 68 00
            ldy #$00                    ; 3C286:  a0 00
...
b15_c29f:   lda (brk_jmp_target_lo),y                 ; 3C29F:  b1 68
            sta PPUDATA                 ; 3C2A1:  8d 07 20
            iny                         ; 3C2A4:  c8
            bne b15_c2aa                ; 3C2A5:  d0 03
            hex ee 69 00 ; inc brk_jmp_target_hi    ; 3C2A7:  ee 69 00
...
syscall_set_sprite: jsr nmi_off                ; 3C2CB:  20 4f c5
            hex ad 52 00 ; lda $0052    ; 3C2CE:  ad 52 00
            asl a                       ; 3C2D1:  0a
            asl a                       ; 3C2D2:  0a
            tax                         ; 3C2D3:  aa
            hex ad 56 00 ; lda $0056    ; 3C2D4:  ad 56 00
            sta oam_shadow,x                 ; 3C2D7:  9d 00 06
...
syscall_fill_attr_quadrant: jsr ppu_safe_gate                ; 3C2F0:  20 93 c6
...
b15_c308:   sta PPUDATA                 ; 3C308:  8d 07 20
            ...
            jsr screen_on                ; 3C30E:  20 58 c5
            rts                         ; 3C311:  60

syscall_fill_nametable: jsr ppu_safe_gate                ; 3C312:  20 93 c6
...
b15_c32c:   sta PPUDATA                 ; 3C32C:  8d 07 20
            ...
            jsr screen_on                ; 3C335:  20 58 c5
            rts                         ; 3C338:  60

syscall_call_bank: hex ad 73 00 ; lda prg_bank_shadow    ; 3C339:  ad 73 00
            pha                         ; 3C33C:  48
...
syscall_noop_02: hex 60                      ; 3C34B:  60

syscall_palette_write: hex ad 80 00 ; lda skip_vblank_wait    ; 3C34C:  ad 80 00
...
b15_c35d:   hex ae 52 00 ; ldx $0052    ; 3C35D:  ae 52 00
            ...
            sta palette_shadow,x                 ; 3C363:  9d 00 07
            lda #$ff                    ; 3C366:  a9 ff
...
b15_c37b:   lda palette_shadow,x                 ; 3C37B:  bd 00 07
            ...
            lda #$ff                    ; 3C38D:  a9 ff
            hex 8d 74 00 ; sta palette_dirty    ; 3C38F:  8d 74 00
b15_c392:   hex ad 74 00 ; lda palette_dirty    ; 3C392:  ad 74 00
...
syscall_read_controller: hex ae 52 00 ; ldx $0052    ; 3C39E:  ae 52 00
...
syscall_audio_load_voice: jsr nmi_off                ; 3C3AD:  20 4f c5
...
syscall_audio_control: hex ae 52 00 ; ldx $0052    ; 3C3CF:  ae 52 00
...
b15_c3f0:   lda audio_mute_triangle,x                 ; 3C3F0:  bd 20 07
...
b15_c40a:   lda #$00                    ; 3C40A:  a9 00
            sta v0_trigger,x                 ; 3C40C:  9d 34 07
            txa                         ; 3C40F:  8a
            clc                         ; 3C410:  18
            adc #$09                    ; 3C411:  69 09
            tax                         ; 3C413:  aa
...
syscall_noop_0b: hex 60                      ; 3C427:  60

syscall_ppu_copy_rect: hex ad 73 00 ; lda prg_bank_shadow    ; 3C428:  ad 73 00
            pha                         ; 3C42B:  48
...
syscall_ppu_fill_rect: lda #$00                    ; 3C437:  a9 00
b15_c439:   hex 8d 82 00 ; sta $0082    ; 3C439:  8d 82 00
            ...
            txa                         ; 3C44A:  8a
            adc #$00                    ; 3C44B:  69 00
            hex 8d 68 00 ; sta brk_jmp_target_lo    ; 3C44D:  8d 68 00
            hex ad 52 00 ; lda $0052    ; 3C450:  ad 52 00
            asl a                       ; 3C453:  0a
            asl a                       ; 3C454:  0a
            clc                         ; 3C455:  18
            adc #$20                    ; 3C456:  69 20
            hex 6d 68 00 ; adc brk_jmp_target_lo    ; 3C458:  6d 68 00
            hex 8d 68 00 ; sta brk_jmp_target_lo    ; 3C45B:  8d 68 00
            hex 8c 69 00 ; sty brk_jmp_target_hi    ; 3C45E:  8c 69 00
            ...
            hex 8d 75 00 ; sta mul_acc_lo    ; 3C478:  8d 75 00
            ldx #$00                    ; 3C47B:  a2 00
b15_c47d:   jsr ppu_safe_gate                ; 3C47D:  20 93 c6
            ...
            hex ad 75 00 ; lda mul_acc_lo    ; 3C48C:  ad 75 00
...
b15_c4b5:   sta PPUDATA                 ; 3C4B5:  8d 07 20
            ...
            hex ad 69 00 ; lda brk_jmp_target_hi    ; 3C4BD:  ad 69 00
            clc                         ; 3C4C0:  18
            adc #$20                    ; 3C4C1:  69 20
            hex 8d 69 00 ; sta brk_jmp_target_hi    ; 3C4C3:  8d 69 00
            hex ad 68 00 ; lda brk_jmp_target_lo    ; 3C4C6:  ad 68 00
            adc #$00                    ; 3C4C9:  69 00
            hex 8d 68 00 ; sta brk_jmp_target_lo    ; 3C4CB:  8d 68 00
            jsr screen_on                ; 3C4CE:  20 58 c5
            hex ce 6c 00 ; dec $006c    ; 3C4D1:  ce 6c 00
            bne b15_c47d                ; 3C4D4:  d0 a7
            hex ad 82 00 ; lda $0082    ; 3C4D6:  ad 82 00
            beq b15_c4df                ; 3C4D9:  f0 04
            pla                         ; 3C4DB:  68
ui_unused:  jsr set_prg_bank                ; 3C4DC:  20 77 c5
b15_c4df:   rts                         ; 3C4DF:  60

syscall_ppu_render_rect: hex ee 58 00 ; inc $0058    ; 3C4E0:  ee 58 00
...
b15_c50f:   hex ad 5c 00 ; lda $005c    ; 3C50F:  ad 5c 00
            ...
            jsr ppu_rect_attr_addr                ; 3C518:  20 40 c6
            jsr ppu_rect_attr_shift                ; 3C51B:  20 73 c6
            jsr ppu_rect_attr_rmw                ; 3C51E:  20 11 c7
            jsr screen_on                ; 3C521:  20 58 c5
...
syscall_noop_0e: hex 60 60                   ; 3C535:  60 60
...
wait_vblank:   hex ad 80 00 ; lda skip_vblank_wait    ; 3C537:  ad 80 00
            ...
            tya                         ; 3C53F:  98
            pha                         ; 3C540:  48
            jsr music_driver         ; 3C541:  20 a5 c7
            pla                         ; 3C544:  68
            tay                         ; 3C545:  a8
            pla                         ; 3C546:  68
            tax                         ; 3C547:  aa
...
set_prg_bank:   hex cd 73 00 ; cmp prg_bank_shadow    ; 3C577:  cd 73 00
...
b15_c586:   pla                         ; 3C586:  68
            ...
            pla                         ; 3C58A:  68
            hex 8d 73 00 ; sta prg_bank_shadow    ; 3C58B:  8d 73 00
...
syscall_sram_block_with_checksum:   lda vm_sp_hi                     ; 3C5AA:  a5 03
            cmp #$02                    ; 3C5AC:  c9 02
...
b15_c5ed:   lda $0200,y                 ; 3C5ED:  b9 00 02
            ...
            clc                         ; 3C5F2:  18
            hex 6d 66 00 ; adc brk_scratch_lo    ; 3C5F3:  6d 66 00
            hex 8d 66 00 ; sta brk_scratch_lo    ; 3C5F6:  8d 66 00
            hex ad 67 00 ; lda brk_scratch_hi    ; 3C5F9:  ad 67 00
            adc #$00                    ; 3C5FC:  69 00
            hex 8d 67 00 ; sta brk_scratch_hi    ; 3C5FE:  8d 67 00
            iny                         ; 3C601:  c8
            tya                         ; 3C602:  98
...
syscall_set_chr_bank0_reg: jsr nmi_off                ; 3C60C:  20 4f c5
            lda #$00                    ; 3C60F:  a9 00
...
b15_c635:   lda JOY1,x                  ; 3C635:  bd 16 40
            lsr a                       ; 3C638:  4a
            hex 7e 6e 00 ; ror p1_buttons,x  ; 3C639:  7e 6e 00
            dey                         ; 3C63C:  88
            bne b15_c635                ; 3C63D:  d0 f6
            rts                         ; 3C63F:  60

ppu_rect_attr_addr:   hex ad 56 00 ; lda $0056    ; 3C640:  ad 56 00
            lsr a                       ; 3C643:  4a
            lsr a                       ; 3C644:  4a
            asl a                       ; 3C645:  0a
            asl a                       ; 3C646:  0a
            asl a                       ; 3C647:  0a
            hex 8d 68 00 ; sta brk_jmp_target_lo    ; 3C648:  8d 68 00
            hex ad 54 00 ; lda $0054    ; 3C64B:  ad 54 00
            lsr a                       ; 3C64E:  4a
            lsr a                       ; 3C64F:  4a
            clc                         ; 3C650:  18
            hex 6d 68 00 ; adc brk_jmp_target_lo    ; 3C651:  6d 68 00
            hex 8d 68 00 ; sta brk_jmp_target_lo    ; 3C654:  8d 68 00
            hex ad 52 00 ; lda $0052    ; 3C657:  ad 52 00
            asl a                       ; 3C65A:  0a
            asl a                       ; 3C65B:  0a
            adc #$20                    ; 3C65C:  69 20
            hex 8d 69 00 ; sta brk_jmp_target_hi    ; 3C65E:  8d 69 00
            clc                         ; 3C661:  18
            lda #$c0                    ; 3C662:  a9 c0
            hex 6d 68 00 ; adc brk_jmp_target_lo    ; 3C664:  6d 68 00
            hex 8d 68 00 ; sta brk_jmp_target_lo    ; 3C667:  8d 68 00
            lda #$03                    ; 3C66A:  a9 03
            hex 6d 69 00 ; adc brk_jmp_target_hi    ; 3C66C:  6d 69 00
            hex 8d 69 00 ; sta brk_jmp_target_hi    ; 3C66F:  8d 69 00
            rts                         ; 3C672:  60

ppu_rect_attr_shift:   hex ad 54 00 ; lda $0054    ; 3C673:  ad 54 00
            and #$03                    ; 3C676:  29 03
            lsr a                       ; 3C678:  4a
            hex 8d 75 00 ; sta mul_acc_lo    ; 3C679:  8d 75 00
            hex ad 56 00 ; lda $0056    ; 3C67C:  ad 56 00
            and #$03                    ; 3C67F:  29 03
            lsr a                       ; 3C681:  4a
            asl a                       ; 3C682:  0a
            hex 6d 75 00 ; adc mul_acc_lo    ; 3C683:  6d 75 00
            hex 8d 75 00 ; sta mul_acc_lo    ; 3C686:  8d 75 00
            rts                         ; 3C689:  60
...
mul_xy_by_3:   lda #$00                    ; 3C6AD:  a9 00
            hex 8d 75 00 ; sta mul_acc_lo    ; 3C6AF:  8d 75 00
            hex 8d 76 00 ; sta mul_acc_hi    ; 3C6B2:  8d 76 00
            cpx #$00                    ; 3C6B5:  e0 00
b15_c6b7:   beq b15_c6cd                ; 3C6B7:  f0 14
            clc                         ; 3C6B9:  18
            tya                         ; 3C6BA:  98
            hex 6d 75 00 ; adc mul_acc_lo    ; 3C6BB:  6d 75 00
            hex 8d 75 00 ; sta mul_acc_lo    ; 3C6BE:  8d 75 00
            hex ad 76 00 ; lda mul_acc_hi    ; 3C6C1:  ad 76 00
            adc #$00                    ; 3C6C4:  69 00
            hex 8d 76 00 ; sta mul_acc_hi    ; 3C6C6:  8d 76 00
            dex                         ; 3C6C9:  ca
            jmp b15_c6b7                ; 3C6CA:  4c b7 c6

b15_c6cd:   hex ac 75 00 ; ldy mul_acc_lo    ; 3C6CD:  ac 75 00
            hex ae 76 00 ; ldx mul_acc_hi    ; 3C6D0:  ae 76 00
            rts                         ; 3C6D3:  60
...
palette_upload:   hex ad 74 00 ; lda palette_dirty    ; 3C6D4:  ad 74 00
            ...
            tax                         ; 3C6E6:  aa
b15_c6e7:   lda palette_shadow,x                 ; 3C6E7:  bd 00 07
...
ppu_rect_attr_rmw:   hex ad 69 00 ; lda brk_jmp_target_hi    ; 3C711:  ad 69 00
            sta PPUADDR                 ; 3C714:  8d 06 20
            hex ad 68 00 ; lda brk_jmp_target_lo    ; 3C717:  ad 68 00
            sta PPUADDR                 ; 3C71A:  8d 06 20
            lda PPUDATA                 ; 3C71D:  ad 07 20
            lda PPUDATA                 ; 3C720:  ad 07 20
            hex 8d 76 00 ; sta mul_acc_hi    ; 3C723:  8d 76 00
            lda #$fc                    ; 3C726:  a9 fc
            hex ae 75 00 ; ldx mul_acc_lo    ; 3C728:  ae 75 00
...
b15_c73b:   hex 2d 76 00 ; and mul_acc_hi    ; 3C73B:  2d 76 00
            hex 0d 58 00 ; ora $0058    ; 3C73E:  0d 58 00
            hex 8d 76 00 ; sta mul_acc_hi    ; 3C741:  8d 76 00
            hex ad 69 00 ; lda brk_jmp_target_hi    ; 3C744:  ad 69 00
            sta PPUADDR                 ; 3C747:  8d 06 20
            hex ad 68 00 ; lda brk_jmp_target_lo    ; 3C74A:  ad 68 00
            sta PPUADDR                 ; 3C74D:  8d 06 20
            hex ad 76 00 ; lda mul_acc_hi    ; 3C750:  ad 76 00
            sta PPUDATA                 ; 3C753:  8d 07 20
            rts                         ; 3C756:  60

reset_ppu_init:   jsr ppu_safe_gate                ; 3C757:  20 93 c6
            lda #$00                    ; 3C75A:  a9 00
...
music_driver:   jsr music_trigger_pass                ; 3C7A5:  20 ac c7
            jsr music_sequencer_pass                ; 3C7A8:  20 17 c8
            rts                         ; 3C7AB:  60

music_trigger_pass: lda #$00                    ; 3C7AC:  a9 00
...
b15_c7bb:   jsr music_voice_check                ; 3C7BB:  20 de c7
            jsr music_advance_voice                ; 3C7BE:  20 c9 c7
            hex ad 79 00 ; lda music_voice_idx    ; 3C7C1:  ad 79 00
            cmp #$05                    ; 3C7C4:  c9 05
            bne b15_c7bb                ; 3C7C6:  d0 f3
            rts                         ; 3C7C8:  60

music_advance_voice:   hex ee 79 00 ; inc music_voice_idx    ; 3C7C9:  ee 79 00
            hex ad 7a 00 ; lda music_ptr_lo    ; 3C7CC:  ad 7a 00
            clc                         ; 3C7CF:  18
            adc #$09                    ; 3C7D0:  69 09
            hex 8d 7a 00 ; sta music_ptr_lo    ; 3C7D2:  8d 7a 00
            hex ad 7b 00 ; lda music_ptr_hi    ; 3C7D5:  ad 7b 00
            adc #$00                    ; 3C7D8:  69 00
...
music_voice_play:   tax                         ; 3C7EF:  aa
            ...
            adc #$05                    ; 3C7F3:  69 05
            ldy #$00                    ; 3C7F5:  a0 00
            sta (music_ptr_lo),y                 ; 3C7F7:  91 7a
            txa                         ; 3C7F9:  8a
            asl a                       ; 3C7FA:  0a
            asl a                       ; 3C7FB:  0a
            tax                         ; 3C7FC:  aa
            lda audio_mute_triangle                   ; 3C7FD:  ad 20 07
            beq b15_c809                ; 3C800:  f0 07
            hex ad 79 00 ; lda music_voice_idx    ; 3C802:  ad 79 00
            cmp #$02                    ; 3C805:  c9 02
            beq b15_c816                ; 3C807:  f0 0d
b15_c809:   ldy #$01                    ; 3C809:  a0 01
b15_c80b:   lda (music_ptr_lo),y                 ; 3C80B:  b1 7a
...
music_sequencer_pass: lda #$00                    ; 3C817:  a9 00
            hex 8d 79 00 ; sta music_voice_idx    ; 3C819:  8d 79 00
            lda #$34                    ; 3C81C:  a9 34
            hex 8d 7a 00 ; sta music_ptr_lo    ; 3C81E:  8d 7a 00
            lda #$07                    ; 3C821:  a9 07
            hex 8d 7b 00 ; sta music_ptr_hi    ; 3C823:  8d 7b 00
b15_c826:   hex ad 79 00 ; lda music_voice_idx    ; 3C826:  ad 79 00
            tax                         ; 3C829:  aa
            lda audio_mute_triangle,x                 ; 3C82A:  bd 20 07
            beq b15_c832                ; 3C82D:  f0 03
            jsr music_voice_step                ; 3C82F:  20 3d c8
b15_c832:   jsr music_advance_voice                ; 3C832:  20 c9 c7
            hex ad 79 00 ; lda music_voice_idx    ; 3C835:  ad 79 00
            cmp #$05                    ; 3C838:  c9 05
            bne b15_c826                ; 3C83A:  d0 ea
            rts                         ; 3C83C:  60

music_voice_step:   ldy #$00                    ; 3C83D:  a0 00
            lda (music_ptr_lo),y                 ; 3C83F:  b1 7a
            cmp #$05                    ; 3C841:  c9 05
            bcc b15_c850                ; 3C843:  90 0b
            jsr music_dec_duration                ; 3C845:  20 c4 c8
            bne tab_b15_c856            ; 3C848:  d0 0c
b15_c84a:   jsr music_next_event                ; 3C84A:  20 ce c8
            jmp tab_b15_c856            ; 3C84D:  4c 56 c8

b15_c850:   jsr music_load_note                ; 3C850:  20 57 c8
            jmp b15_c84a                ; 3C853:  4c 4a c8

tab_b15_c856: ; 1 bytes
            hex 60                      ; 3C856:  60

music_load_note:   jsr music_load_voice_cfg                ; 3C857:  20 77 c8
            jsr music_read_stream_byte                ; 3C85A:  20 94 c8
            ldy #$00                    ; 3C85D:  a0 00
            sta (music_ptr_lo),y                 ; 3C85F:  91 7a
            jsr music_read_stream_byte                ; 3C861:  20 94 c8
            ldy #$01                    ; 3C864:  a0 01
            sta (music_ptr_lo),y                 ; 3C866:  91 7a
            jsr music_read_stream_byte                ; 3C868:  20 94 c8
            ldy #$02                    ; 3C86B:  a0 02
            sta (music_ptr_lo),y                 ; 3C86D:  91 7a
            jsr music_read_stream_byte                ; 3C86F:  20 94 c8
            ldy #$04                    ; 3C872:  a0 04
            sta (music_ptr_lo),y                 ; 3C874:  91 7a
            rts                         ; 3C876:  60

music_load_voice_cfg:   hex ad 79 00 ; lda music_voice_idx    ; 3C877:  ad 79 00
            asl a                       ; 3C87A:  0a
            clc                         ; 3C87B:  18
            ...
            iny                         ; 3C88A:  c8
            sta (music_ptr_lo),y                 ; 3C88B:  91 7a
            iny                         ; 3C88D:  c8
            lda $0727,x                 ; 3C88E:  bd 27 07
            sta (music_ptr_lo),y                 ; 3C891:  91 7a
            rts                         ; 3C893:  60

music_read_stream_byte:   hex ad 73 00 ; lda prg_bank_shadow    ; 3C894:  ad 73 00
            pha                         ; 3C897:  48
            ldy #$05                    ; 3C898:  a0 05
            ...
            clc                         ; 3C8A6:  18
            adc #$01                    ; 3C8A7:  69 01
            sta (music_ptr_lo),y                 ; 3C8A9:  91 7a
            iny                         ; 3C8AB:  c8
            lda (music_ptr_lo),y                 ; 3C8AC:  b1 7a
            hex 8d 7d 00 ; sta $007d    ; 3C8AE:  8d 7d 00
            adc #$00                    ; 3C8B1:  69 00
            sta (music_ptr_lo),y                 ; 3C8B3:  91 7a
            ldx #$00                    ; 3C8B5:  a2 00
...
music_dec_duration:   ldy #$08                    ; 3C8C4:  a0 08
            lda (music_ptr_lo),y                 ; 3C8C6:  b1 7a
            tax                         ; 3C8C8:  aa
            dex                         ; 3C8C9:  ca
            txa                         ; 3C8CA:  8a
            sta (music_ptr_lo),y                 ; 3C8CB:  91 7a
            rts                         ; 3C8CD:  60

music_next_event:   jsr music_read_stream_byte                ; 3C8CE:  20 94 c8
            cmp #$f0                    ; 3C8D1:  c9 f0
            bcs b15_c8de                ; 3C8D3:  b0 09
            jsr music_set_pitch                ; 3C8D5:  20 29 c9
            jsr music_set_duration                ; 3C8D8:  20 90 c9
            jmp b15_c8e3                ; 3C8DB:  4c e3 c8

b15_c8de:   jsr music_handle_command                ; 3C8DE:  20 e4 c8
            bcc music_next_event                ; 3C8E1:  90 eb
b15_c8e3:   rts                         ; 3C8E3:  60

music_handle_command:   cmp #$f0                    ; 3C8E4:  c9 f0
            beq b15_c8eb                ; 3C8E6:  f0 03
            jmp music_restart_stream                ; 3C8E8:  4c 06 c9

b15_c8eb:   ldy #$00                    ; 3C8EB:  a0 00
            lda (music_ptr_lo),y                 ; 3C8ED:  b1 7a
            sec                         ; 3C8EF:  38
            sbc #$05                    ; 3C8F0:  e9 05
            asl a                       ; 3C8F2:  0a
            asl a                       ; 3C8F3:  0a
            ...
            hex ae 79 00 ; ldx music_voice_idx    ; 3C8FA:  ae 79 00
            lda #$00                    ; 3C8FD:  a9 00
            sta audio_mute_triangle,x                 ; 3C8FF:  9d 20 07
            sta (music_ptr_lo),y                 ; 3C902:  91 7a
            sec                         ; 3C904:  38
            rts                         ; 3C905:  60

music_restart_stream:   hex ad 79 00 ; lda music_voice_idx    ; 3C906:  ad 79 00
            asl a                       ; 3C909:  0a
            clc                         ; 3C90A:  18
            ...
            sta (music_ptr_lo),y                 ; 3C91A:  91 7a
            iny                         ; 3C91C:  c8
            lda $0727,x                 ; 3C91D:  bd 27 07
            sta (music_ptr_lo),y                 ; 3C920:  91 7a
            ldy #$00                    ; 3C922:  a0 00
            lda #$00                    ; 3C924:  a9 00
            sta (music_ptr_lo),y                 ; 3C926:  91 7a
            rts                         ; 3C928:  60

music_set_pitch:   jsr music_note_to_period                ; 3C929:  20 4b c9
            ldy #$04                    ; 3C92C:  a0 04
            lda (music_ptr_lo),y                 ; 3C92E:  b1 7a
            and #$f8                    ; 3C930:  29 f8
            hex 0d 7f 00 ; ora $007f    ; 3C932:  0d 7f 00
            sta (music_ptr_lo),y                 ; 3C935:  91 7a
            dey                         ; 3C937:  88
            hex ad 7e 00 ; lda $007e    ; 3C938:  ad 7e 00
            sta (music_ptr_lo),y                 ; 3C93B:  91 7a
            ldy #$00                    ; 3C93D:  a0 00
            lda (music_ptr_lo),y                 ; 3C93F:  b1 7a
            cmp #$05                    ; 3C941:  c9 05
            bcc b15_c94a                ; 3C943:  90 05
            sec                         ; 3C945:  38
            sbc #$04                    ; 3C946:  e9 04
            sta (music_ptr_lo),y                 ; 3C948:  91 7a
b15_c94a:   rts                         ; 3C94A:  60

music_note_to_period:   pha                         ; 3C94B:  48
            and #$0f                    ; 3C94C:  29 0f
            asl a                       ; 3C94E:  0a
            tax                         ; 3C94F:  aa
...
tab_b15_c96f: ; 25 bytes
            ...
            brk                         ; 3C98E:  00
            hex 00                      ; 3C98F:  00
music_set_duration:   jsr music_read_stream_byte                ; 3C990:  20 94 c8
            asl a                       ; 3C993:  0a
            asl a                       ; 3C994:  0a
            asl a                       ; 3C995:  0a
            ldy #$08                    ; 3C996:  a0 08
            sta (music_ptr_lo),y                 ; 3C998:  91 7a
            rts                         ; 3C99A:  60
...
call_bank10_entry: hex 20 23 e8 00 00 0c a8 e5 ; 3CA03:  20 23 e8 00 00 0c a8 e5
...
to_upper:   hex 20 23 e8 00 00 a0 0b 00 ; 3CB30:  20 23 e8 00 00 a0 0b 00
...
swap_byte:  hex 20 23 e8 ff ff 0c d3 a2 ; 3CB80:  20 23 e8 ff ff 0c d3 a2
...
sqrt_int:   lda #$ff                    ; 3CBCD:  a9 ff
            sta $08                     ; 3CBCF:  85 08
            sta $09                     ; 3CBD1:  85 09
            ldy #$03                    ; 3CBD3:  a0 03
            lda (vm_sp_lo),y                 ; 3CBD5:  b1 02
            bmi b15_cc34                ; 3CBD7:  30 5b
            sta $44                     ; 3CBD9:  85 44
            dey                         ; 3CBDB:  88
            lda (vm_sp_lo),y                 ; 3CBDC:  b1 02
            sta $45                     ; 3CBDE:  85 45
            lda #$00                    ; 3CBE0:  a9 00
            sta $40                     ; 3CBE2:  85 40
            sta $41                     ; 3CBE4:  85 41
...
palette_swap: hex 20 23 e8 00 00 3c 8d 12 ; 3CC35:  20 23 e8 00 00 3c 8d 12
...
clear_rect_lower_right: hex 20 23 e8 00 00 61 8d 19 ; 3CCBA:  20 23 e8 00 00 61 8d 19
...
fill_nametable_wrap: jsr vm_entry                ; 3CF50:  20 23 e8
            brk                         ; 3CF53:  00
            hex 00                      ; 3CF54:  00
            ...
            rol $f2                     ; 3CF59:  26 f2
            asl $cf                     ; 3CF5B:  06 cf
fill_attr_wrap: jsr vm_entry                ; 3CF5D:  20 23 e8
            brk                         ; 3CF60:  00
            hex 00                      ; 3CF61:  00
            rts                         ; 3CF62:  60
...
prompt_y_n: hex 20 23 e8 fe ff 8e 95 f6 ; 3D3A7:  20 23 e8 fe ff 8e 95 f6
...
fief_owner: hex 20 23 e8 00 00 0c 8c 15 ; 3D772:  20 23 e8 00 00 0c 8c 15
...
fief_to_daimyo_record_addr: hex 20 23 e8 00 00 3c e9 72 ; 3D7DA:  20 23 e8 00 00 3c e9 72
            hex d7 02 b3 e9 cd d7 02 cf ; 3D7E2:  d7 02 b3 e9 cd d7 02 cf
selected_province_daimyo_record: hex 20 23 e8 00 00 aa 5f 6f ; 3D7EA:  20 23 e8 00 00 aa 5f 6f
...
draw_province_lord_name: hex 20 23 e8 00 00 0c 8c f7 ; 3DB6E:  20 23 e8 00 00 0c 8c f7
...
clear_fief_pair_matrix: hex 20 23 e8 fe ff 8d 1d e9 ; 3E1E7:  20 23 e8 fe ff 8d 1d e9
...
copy_arms_record_5: hex 20 23 e8 fc ff 40 2a 0c ; 3E2AF:  20 23 e8 fc ff 40 2a 0c
...
redraw_fief_on_map: hex 20 23 e8 d8 ff a4 5d 6f ; 3E554:  20 23 e8 d8 ff a4 5d 6f
...
render_section_for_selected_province: hex 20 23 e8 00 00 a4 9d 6d ; 3E694:  20 23 e8 00 00 a4 9d 6d
...
draw_daimyo_portrait: hex 20 23 e8 d4 ff 40 85 da ; 3E76F:  20 23 e8 d4 ff 40 85 da
...
vm_entry:   pla                         ; 3E823:  68
            ...
            sta $09                     ; 3E827:  85 09
            pla                         ; 3E829:  68
            sta scratch_ptr_lo                     ; 3E82A:  85 00
            pla                         ; 3E82C:  68
            sta scratch_ptr_hi                     ; 3E82D:  85 01
            ldy #$07                    ; 3E82F:  a0 07
            sec                         ; 3E831:  38
            lda vm_sp_lo                     ; 3E832:  a5 02
            sbc #$09                    ; 3E834:  e9 09
            sta $0c                     ; 3E836:  85 0c
            lda vm_sp_hi                     ; 3E838:  a5 03
            sbc #$00                    ; 3E83A:  e9 00
            sta $0d                     ; 3E83C:  85 0d
b15_e83e:   hex b9 00 00 ; lda scratch_ptr_lo,y  ; 3E83E:  b9 00 00
            ...
            clc                         ; 3E848:  18
            lda $0c                     ; 3E849:  a5 0c
            sta vm_fp_lo                     ; 3E84B:  85 04
            adc ($08),y                 ; 3E84D:  71 08
            sta vm_sp_lo                     ; 3E84F:  85 02
            iny                         ; 3E851:  c8
            lda $0d                     ; 3E852:  a5 0d
            sta vm_fp_hi                     ; 3E854:  85 05
            adc ($08),y                 ; 3E856:  71 08
            sta vm_sp_hi                     ; 3E858:  85 03
            clc                         ; 3E85A:  18
            lda $08                     ; 3E85B:  a5 08
            adc #$03                    ; 3E85D:  69 03
            sta vm_ip_lo                     ; 3E85F:  85 06
            lda $09                     ; 3E861:  a5 09
            adc #$00                    ; 3E863:  69 00
            sta vm_ip_hi                     ; 3E865:  85 07
vm_dispatch:   ldy #$00                    ; 3E867:  a0 00
            lda (vm_ip_lo),y                 ; 3E869:  b1 06
            inc vm_ip_lo                     ; 3E86B:  e6 06
            bne b15_e871                ; 3E86D:  d0 02
            inc vm_ip_hi                     ; 3E86F:  e6 07
b15_e871:   tax                         ; 3E871:  aa
            lda tab_b15_f026,x          ; 3E872:  bd 26 f0
            sta scratch_ptr_lo                     ; 3E875:  85 00
            lda tab_b15_f026+256,x      ; 3E877:  bd 26 f1
            sta scratch_ptr_hi                     ; 3E87A:  85 01
            jmp (scratch_ptr_lo)                 ; 3E87C:  6c 00 00

vm_op_00_load_offset: lda #$e8                    ; 3E87F:  a9 e8
            bne vm_op_load_tail                ; 3E881:  d0 2a
vm_op_01_loadA_local_neg: lda #$ea                    ; 3E883:  a9 ea
            bne vm_op_load_tail                ; 3E885:  d0 26
vm_op_02_loadA_local_neg: lda #$ec                    ; 3E887:  a9 ec
            bne vm_op_load_tail                ; 3E889:  d0 22
vm_op_03_loadA_local_neg: lda #$ee                    ; 3E88B:  a9 ee
            bne vm_op_load_tail                ; 3E88D:  d0 1e
vm_op_04_loadA_local_neg: lda #$f0                    ; 3E88F:  a9 f0
            bne vm_op_load_tail                ; 3E891:  d0 1a
vm_op_05_loadA_local_neg: lda #$f2                    ; 3E893:  a9 f2
            bne vm_op_load_tail                ; 3E895:  d0 16
vm_op_06_loadA_local_neg: lda #$f4                    ; 3E897:  a9 f4
            bne vm_op_load_tail                ; 3E899:  d0 12
vm_op_07_loadA_local_neg: lda #$f6                    ; 3E89B:  a9 f6
            bne vm_op_load_tail                ; 3E89D:  d0 0e
vm_op_08_loadA_local_neg: lda #$f8                    ; 3E89F:  a9 f8
            bne vm_op_load_tail                ; 3E8A1:  d0 0a
vm_op_09_loadA_local_neg: lda #$fa                    ; 3E8A3:  a9 fa
            bne vm_op_load_tail                ; 3E8A5:  d0 06
vm_op_0A_loadA_local_neg: lda #$fc                    ; 3E8A7:  a9 fc
            bne vm_op_load_tail                ; 3E8A9:  d0 02
vm_op_0B_loadA_local_neg: lda #$fe                    ; 3E8AB:  a9 fe
vm_op_load_tail:   clc                         ; 3E8AD:  18
            adc vm_fp_lo                     ; 3E8AE:  65 04
            sta scratch_ptr_lo                     ; 3E8B0:  85 00
            lda #$ff                    ; 3E8B2:  a9 ff
            adc vm_fp_hi                     ; 3E8B4:  65 05
            sta scratch_ptr_hi                     ; 3E8B6:  85 01
            lda (scratch_ptr_lo),y                 ; 3E8B8:  b1 00
            sta $08                     ; 3E8BA:  85 08
            iny                         ; 3E8BC:  c8
            lda (scratch_ptr_lo),y                 ; 3E8BD:  b1 00
            sta $09                     ; 3E8BF:  85 09
            jmp vm_dispatch                ; 3E8C1:  4c 67 e8

vm_op_0F_loadA_local_pos: ldy #$11                    ; 3E8C4:  a0 11
            bne b15_e8d2                ; 3E8C6:  d0 0a
vm_op_0E_loadA_local_pos: ldy #$0f                    ; 3E8C8:  a0 0f
            bne b15_e8d2                ; 3E8CA:  d0 06
vm_op_0D_loadA_local_pos: ldy #$0d                    ; 3E8CC:  a0 0d
            bne b15_e8d2                ; 3E8CE:  d0 02
vm_op_0C_loadA_local_pos: ldy #$0b                    ; 3E8D0:  a0 0b
b15_e8d2:   lda (vm_fp_lo),y                 ; 3E8D2:  b1 04
            sta $08                     ; 3E8D4:  85 08
            iny                         ; 3E8D6:  c8
            lda (vm_fp_lo),y                 ; 3E8D7:  b1 04
            sta $09                     ; 3E8D9:  85 09
            jmp vm_dispatch                ; 3E8DB:  4c 67 e8

vm_op_10_loadB_local_neg: lda #$e8                    ; 3E8DE:  a9 e8
            bne b15_e90c                ; 3E8E0:  d0 2a
vm_op_11_loadB_local_neg: lda #$ea                    ; 3E8E2:  a9 ea
            bne b15_e90c                ; 3E8E4:  d0 26
vm_op_12_loadB_local_neg: lda #$ec                    ; 3E8E6:  a9 ec
            bne b15_e90c                ; 3E8E8:  d0 22
vm_op_13_loadB_local_neg: lda #$ee                    ; 3E8EA:  a9 ee
            bne b15_e90c                ; 3E8EC:  d0 1e
vm_op_14_loadB_local_neg: lda #$f0                    ; 3E8EE:  a9 f0
            bne b15_e90c                ; 3E8F0:  d0 1a
vm_op_15_loadB_local_neg: lda #$f2                    ; 3E8F2:  a9 f2
            bne b15_e90c                ; 3E8F4:  d0 16
vm_op_16_loadB_local_neg: lda #$f4                    ; 3E8F6:  a9 f4
            bne b15_e90c                ; 3E8F8:  d0 12
vm_op_17_loadB_local_neg: lda #$f6                    ; 3E8FA:  a9 f6
            bne b15_e90c                ; 3E8FC:  d0 0e
vm_op_18_loadB_local_neg: lda #$f8                    ; 3E8FE:  a9 f8
            bne b15_e90c                ; 3E900:  d0 0a
vm_op_19_loadB_local_neg: lda #$fa                    ; 3E902:  a9 fa
            bne b15_e90c                ; 3E904:  d0 06
vm_op_1A_loadB_local_neg: lda #$fc                    ; 3E906:  a9 fc
            bne b15_e90c                ; 3E908:  d0 02
vm_op_1B_loadB_local_neg: lda #$fe                    ; 3E90A:  a9 fe
b15_e90c:   clc                         ; 3E90C:  18
            adc vm_fp_lo                     ; 3E90D:  65 04
            sta scratch_ptr_lo                     ; 3E90F:  85 00
            lda #$ff                    ; 3E911:  a9 ff
            adc vm_fp_hi                     ; 3E913:  65 05
            sta scratch_ptr_hi                     ; 3E915:  85 01
            lda (scratch_ptr_lo),y                 ; 3E917:  b1 00
            sta $0c                     ; 3E919:  85 0c
            iny                         ; 3E91B:  c8
            lda (scratch_ptr_lo),y                 ; 3E91C:  b1 00
            sta $0d                     ; 3E91E:  85 0d
            jmp vm_dispatch                ; 3E920:  4c 67 e8

vm_op_1F_loadB_local_pos: ldy #$11                    ; 3E923:  a0 11
            bne b15_e931                ; 3E925:  d0 0a
vm_op_1E_loadB_local_pos: ldy #$0f                    ; 3E927:  a0 0f
            bne b15_e931                ; 3E929:  d0 06
vm_op_1D_loadB_local_pos: ldy #$0d                    ; 3E92B:  a0 0d
            bne b15_e931                ; 3E92D:  d0 02
vm_op_1C_loadB_local_pos: ldy #$0b                    ; 3E92F:  a0 0b
b15_e931:   lda (vm_fp_lo),y                 ; 3E931:  b1 04
            sta $0c                     ; 3E933:  85 0c
            iny                         ; 3E935:  c8
            lda (vm_fp_lo),y                 ; 3E936:  b1 04
            sta $0d                     ; 3E938:  85 0d
            jmp vm_dispatch                ; 3E93A:  4c 67 e8

vm_op_20_storeA_local_neg: lda #$e8                    ; 3E93D:  a9 e8
            bne b15_e96b                ; 3E93F:  d0 2a
vm_op_21_storeA_local_neg: lda #$ea                    ; 3E941:  a9 ea
            bne b15_e96b                ; 3E943:  d0 26
vm_op_22_storeA_local_neg: lda #$ec                    ; 3E945:  a9 ec
            bne b15_e96b                ; 3E947:  d0 22
vm_op_23_storeA_local_neg: lda #$ee                    ; 3E949:  a9 ee
            bne b15_e96b                ; 3E94B:  d0 1e
vm_op_24_storeA_local_neg: lda #$f0                    ; 3E94D:  a9 f0
            bne b15_e96b                ; 3E94F:  d0 1a
vm_op_25_storeA_local_neg: lda #$f2                    ; 3E951:  a9 f2
            bne b15_e96b                ; 3E953:  d0 16
vm_op_26_storeA_local_neg: lda #$f4                    ; 3E955:  a9 f4
            bne b15_e96b                ; 3E957:  d0 12
vm_op_27_storeA_local_neg: lda #$f6                    ; 3E959:  a9 f6
            bne b15_e96b                ; 3E95B:  d0 0e
vm_op_28_storeA_local_neg: lda #$f8                    ; 3E95D:  a9 f8
            bne b15_e96b                ; 3E95F:  d0 0a
vm_op_29_storeA_local_neg: lda #$fa                    ; 3E961:  a9 fa
            bne b15_e96b                ; 3E963:  d0 06
vm_op_2A_storeA_local_neg: lda #$fc                    ; 3E965:  a9 fc
            bne b15_e96b                ; 3E967:  d0 02
vm_op_2B_storeA_local_neg: lda #$fe                    ; 3E969:  a9 fe
b15_e96b:   clc                         ; 3E96B:  18
            adc vm_fp_lo                     ; 3E96C:  65 04
            sta scratch_ptr_lo                     ; 3E96E:  85 00
            lda #$ff                    ; 3E970:  a9 ff
            adc vm_fp_hi                     ; 3E972:  65 05
            sta scratch_ptr_hi                     ; 3E974:  85 01
            lda $08                     ; 3E976:  a5 08
            sta (scratch_ptr_lo),y                 ; 3E978:  91 00
            iny                         ; 3E97A:  c8
            lda $09                     ; 3E97B:  a5 09
            sta (scratch_ptr_lo),y                 ; 3E97D:  91 00
            jmp vm_dispatch                ; 3E97F:  4c 67 e8

vm_op_2F_storeA_local_pos: ldy #$11                    ; 3E982:  a0 11
            bne b15_e990                ; 3E984:  d0 0a
vm_op_2E_storeA_local_pos: ldy #$0f                    ; 3E986:  a0 0f
            bne b15_e990                ; 3E988:  d0 06
vm_op_2D_storeA_local_pos: ldy #$0d                    ; 3E98A:  a0 0d
            bne b15_e990                ; 3E98C:  d0 02
vm_op_2C_storeA_local_pos: ldy #$0b                    ; 3E98E:  a0 0b
b15_e990:   lda $08                     ; 3E990:  a5 08
            sta (vm_fp_lo),y                 ; 3E992:  91 04
            iny                         ; 3E994:  c8
            lda $09                     ; 3E995:  a5 09
            sta (vm_fp_lo),y                 ; 3E997:  91 04
            jmp vm_dispatch                ; 3E999:  4c 67 e8

vm_op_30_storeB_local_neg: lda #$e8                    ; 3E99C:  a9 e8
            bne b15_e9ca                ; 3E99E:  d0 2a
vm_op_31_storeB_local_neg: lda #$ea                    ; 3E9A0:  a9 ea
            bne b15_e9ca                ; 3E9A2:  d0 26
vm_op_32_storeB_local_neg: lda #$ec                    ; 3E9A4:  a9 ec
            bne b15_e9ca                ; 3E9A6:  d0 22
vm_op_33_storeB_local_neg: lda #$ee                    ; 3E9A8:  a9 ee
            bne b15_e9ca                ; 3E9AA:  d0 1e
vm_op_34_storeB_local_neg: lda #$f0                    ; 3E9AC:  a9 f0
            bne b15_e9ca                ; 3E9AE:  d0 1a
vm_op_35_storeB_local_neg: lda #$f2                    ; 3E9B0:  a9 f2
            bne b15_e9ca                ; 3E9B2:  d0 16
vm_op_36_storeB_local_neg: lda #$f4                    ; 3E9B4:  a9 f4
            bne b15_e9ca                ; 3E9B6:  d0 12
vm_op_37_storeB_local_neg: lda #$f6                    ; 3E9B8:  a9 f6
            bne b15_e9ca                ; 3E9BA:  d0 0e
vm_op_38_storeB_local_neg: lda #$f8                    ; 3E9BC:  a9 f8
            bne b15_e9ca                ; 3E9BE:  d0 0a
vm_op_39_storeB_local_neg: lda #$fa                    ; 3E9C0:  a9 fa
            bne b15_e9ca                ; 3E9C2:  d0 06
vm_op_3A_storeB_local_neg: lda #$fc                    ; 3E9C4:  a9 fc
            bne b15_e9ca                ; 3E9C6:  d0 02
vm_op_3B_storeB_local_neg: lda #$fe                    ; 3E9C8:  a9 fe
b15_e9ca:   clc                         ; 3E9CA:  18
            adc vm_fp_lo                     ; 3E9CB:  65 04
            sta scratch_ptr_lo                     ; 3E9CD:  85 00
            lda #$ff                    ; 3E9CF:  a9 ff
            adc vm_fp_hi                     ; 3E9D1:  65 05
            sta scratch_ptr_hi                     ; 3E9D3:  85 01
            iny                         ; 3E9D5:  c8
            lda (scratch_ptr_lo),y                 ; 3E9D6:  b1 00
            tax                         ; 3E9D8:  aa
            dey                         ; 3E9D9:  88
            lda (scratch_ptr_lo),y                 ; 3E9DA:  b1 00
            jmp vm_push16_AX                ; 3E9DC:  4c 08 f0

vm_op_3F_storeB_local_pos: ldy #$12                    ; 3E9DF:  a0 12
            bne b15_e9ed                ; 3E9E1:  d0 0a
vm_op_3E_storeB_local_pos: ldy #$10                    ; 3E9E3:  a0 10
            bne b15_e9ed                ; 3E9E5:  d0 06
vm_op_3D_storeB_local_pos: ldy #$0e                    ; 3E9E7:  a0 0e
            bne b15_e9ed                ; 3E9E9:  d0 02
vm_op_3C_storeB_local_pos: ldy #$0c                    ; 3E9EB:  a0 0c
b15_e9ed:   lda (vm_fp_lo),y                 ; 3E9ED:  b1 04
            tax                         ; 3E9EF:  aa
            dey                         ; 3E9F0:  88
            lda (vm_fp_lo),y                 ; 3E9F1:  b1 04
            jmp vm_push16_AX                ; 3E9F3:  4c 08 f0

vm_op_clearA_shared: txa                         ; 3E9F6:  8a
            and #$0f                    ; 3E9F7:  29 0f
            sta $08                     ; 3E9F9:  85 08
            sty $09                     ; 3E9FB:  84 09
            jmp vm_dispatch                ; 3E9FD:  4c 67 e8

vm_op_40_clearA_40: sty $08                     ; 3EA00:  84 08
            sty $09                     ; 3EA02:  84 09
            jmp vm_dispatch                ; 3EA04:  4c 67 e8

vm_op_setB_imm4_shared: txa                         ; 3EA07:  8a
            and #$0f                    ; 3EA08:  29 0f
            sta $0c                     ; 3EA0A:  85 0c
            sty $0d                     ; 3EA0C:  84 0d
            jmp vm_dispatch                ; 3EA0E:  4c 67 e8

vm_op_50_setB_imm4_50: sty $0c                     ; 3EA11:  84 0c
            sty $0d                     ; 3EA13:  84 0d
            jmp vm_dispatch                ; 3EA15:  4c 67 e8

vm_op_push_imm4_shared: txa                         ; 3EA18:  8a
            and #$0f                    ; 3EA19:  29 0f
            ldx #$00                    ; 3EA1B:  a2 00
            jmp vm_push16_AX                ; 3EA1D:  4c 08 f0

vm_op_addA_imm4_shared: txa                         ; 3EA20:  8a
            and #$0f                    ; 3EA21:  29 0f
            clc                         ; 3EA23:  18
            adc $08                     ; 3EA24:  65 08
            sta $08                     ; 3EA26:  85 08
            bcc vm_op_70_nop                ; 3EA28:  90 02
            inc $09                     ; 3EA2A:  e6 09
vm_op_70_nop:   jmp vm_dispatch                ; 3EA2C:  4c 67 e8

vm_op_82_bb: jsr vm_addr_ptr2_plus_word                ; 3EA2F:  20 ec ef
            bcc b15_ea37                ; 3EA32:  90 03
vm_op_81_byte: jsr vm_addr_ptr2_plus_sbyte                ; 3EA34:  20 a6 ef
b15_ea37:   lda (scratch_ptr_lo),y                 ; 3EA37:  b1 00
            sta $08                     ; 3EA39:  85 08
            iny                         ; 3EA3B:  c8
            lda (scratch_ptr_lo),y                 ; 3EA3C:  b1 00
            sta $09                     ; 3EA3E:  85 09
            jmp vm_dispatch                ; 3EA40:  4c 67 e8

vm_op_A4_loadA_mem_word: jsr vm_read_word_into_ptr0                ; 3EA43:  20 d5 ef
            bcc b15_ea37                ; 3EA46:  90 ef
vm_op_83_byte: jsr vm_addr_ptr2_plus_sbyte                ; 3EA48:  20 a6 ef
b15_ea4b:   lda (scratch_ptr_lo),y                 ; 3EA4B:  b1 00
            sta $0c                     ; 3EA4D:  85 0c
            iny                         ; 3EA4F:  c8
            lda (scratch_ptr_lo),y                 ; 3EA50:  b1 00
            sta $0d                     ; 3EA52:  85 0d
            jmp vm_dispatch                ; 3EA54:  4c 67 e8

vm_op_84_bwb: jsr vm_addr_ptr2_plus_word                ; 3EA57:  20 ec ef
            bcc b15_ea4b                ; 3EA5A:  90 ef
vm_op_A6_loadB_mem_word: jsr vm_read_word_into_ptr0                ; 3EA5C:  20 d5 ef
            bcc b15_ea4b                ; 3EA5F:  90 ea
vm_op_85_byte: jsr vm_addr_ptr2_plus_sbyte                ; 3EA61:  20 a6 ef
b15_ea64:   lda $08                     ; 3EA64:  a5 08
            sta (scratch_ptr_lo),y                 ; 3EA66:  91 00
            iny                         ; 3EA68:  c8
            lda $09                     ; 3EA69:  a5 09
            sta (scratch_ptr_lo),y                 ; 3EA6B:  91 00
            jmp vm_dispatch                ; 3EA6D:  4c 67 e8

vm_op_86_bwb: jsr vm_addr_ptr2_plus_word                ; 3EA70:  20 ec ef
            bcc b15_ea64                ; 3EA73:  90 ef
vm_op_A8_loadA_mem_word: jsr vm_read_word_into_ptr0                ; 3EA75:  20 d5 ef
            bcc b15_ea64                ; 3EA78:  90 ea
vm_op_87_byte: jsr vm_addr_ptr2_plus_sbyte                ; 3EA7A:  20 a6 ef
b15_ea7d:   iny                         ; 3EA7D:  c8
            lda (scratch_ptr_lo),y                 ; 3EA7E:  b1 00
            tax                         ; 3EA80:  aa
            dey                         ; 3EA81:  88
            lda (scratch_ptr_lo),y                 ; 3EA82:  b1 00
            jmp vm_push16_AX                ; 3EA84:  4c 08 f0

vm_op_88_bwb: jsr vm_addr_ptr2_plus_word                ; 3EA87:  20 ec ef
            bcc b15_ea7d                ; 3EA8A:  90 f1
vm_op_AA:   jsr vm_read_word_into_ptr0                ; 3EA8C:  20 d5 ef
            bcc b15_ea7d                ; 3EA8F:  90 ec
vm_op_DE_loadA_frameaddr: jsr vm_fetch_word                ; 3EA91:  20 bf ef
            adc vm_fp_lo                     ; 3EA94:  65 04
            sta $08                     ; 3EA96:  85 08
            txa                         ; 3EA98:  8a
            adc vm_fp_hi                     ; 3EA99:  65 05
            sta $09                     ; 3EA9B:  85 09
            jmp vm_dispatch                ; 3EA9D:  4c 67 e8

vm_op_DF_loadB_frameaddr: jsr vm_fetch_word                ; 3EAA0:  20 bf ef
            adc vm_fp_lo                     ; 3EAA3:  65 04
            sta $0c                     ; 3EAA5:  85 0c
            txa                         ; 3EAA7:  8a
            adc vm_fp_hi                     ; 3EAA8:  65 05
            sta $0d                     ; 3EAAA:  85 0d
            jmp vm_dispatch                ; 3EAAC:  4c 67 e8

vm_op_89_loadA_imm_sbyte: jsr vm_fetch_sbyte                ; 3EAAF:  20 97 ef
b15_eab2:   sta $08                     ; 3EAB2:  85 08
            stx $09                     ; 3EAB4:  86 09
            jmp vm_dispatch                ; 3EAB6:  4c 67 e8

vm_op_8A_loadA_imm_word: jsr vm_fetch_word                ; 3EAB9:  20 bf ef
            bcc b15_eab2                ; 3EABC:  90 f4
vm_op_8B_loadB_imm_byte: jsr vm_fetch_sbyte                ; 3EABE:  20 97 ef
b15_eac1:   sta $0c                     ; 3EAC1:  85 0c
            stx $0d                     ; 3EAC3:  86 0d
            jmp vm_dispatch                ; 3EAC5:  4c 67 e8

vm_op_8C_loadB_imm_word: jsr vm_fetch_word                ; 3EAC8:  20 bf ef
            bcc b15_eac1                ; 3EACB:  90 f4
vm_op_8D_sbyte: jsr vm_fetch_sbyte                ; 3EACD:  20 97 ef
            jmp vm_push16_AX                ; 3EAD0:  4c 08 f0

vm_op_8E_push_imm_word: jsr vm_fetch_word                ; 3EAD3:  20 bf ef
            jmp vm_push16_AX                ; 3EAD6:  4c 08 f0

vm_op_8F_addA_imm_sbyte: jsr vm_fetch_sbyte                ; 3EAD9:  20 97 ef
...
vm_op_90_bb: jsr vm_fetch_word                ; 3EAE8:  20 bf ef
            bcc b15_eadc                ; 3EAEB:  90 ef
vm_op_A0_A3_byte: jsr vm_addr_ptr2_plus_word                ; 3EAED:  20 ec ef
b15_eaf0:   lda (scratch_ptr_lo),y                 ; 3EAF0:  b1 00
            sta $08                     ; 3EAF2:  85 08
            sty $09                     ; 3EAF4:  84 09
            jmp vm_dispatch                ; 3EAF6:  4c 67 e8

vm_op_A5_loadA_mem_byte: jsr vm_read_word_into_ptr0                ; 3EAF9:  20 d5 ef
            bcc b15_eaf0                ; 3EAFC:  90 f2
vm_op_A1_A3_byte: jsr vm_addr_ptr2_plus_word                ; 3EAFE:  20 ec ef
b15_eb01:   lda (scratch_ptr_lo),y                 ; 3EB01:  b1 00
            sta $0c                     ; 3EB03:  85 0c
            sty $0d                     ; 3EB05:  84 0d
            jmp vm_dispatch                ; 3EB07:  4c 67 e8

vm_op_A7_loadA_addr_word: jsr vm_read_word_into_ptr0                ; 3EB0A:  20 d5 ef
            bcc b15_eb01                ; 3EB0D:  90 f2
vm_op_A2_A3_byte: jsr vm_addr_ptr2_plus_word                ; 3EB0F:  20 ec ef
b15_eb12:   lda $08                     ; 3EB12:  a5 08
            sta (scratch_ptr_lo),y                 ; 3EB14:  91 00
            jmp vm_dispatch                ; 3EB16:  4c 67 e8

vm_op_A9_storeA_mem_byte: jsr vm_read_word_into_ptr0                ; 3EB19:  20 d5 ef
            bcc b15_eb12                ; 3EB1C:  90 f4
vm_op_A3_A3_byte: jsr vm_addr_ptr2_plus_word                ; 3EB1E:  20 ec ef
b15_eb21:   lda (scratch_ptr_lo),y                 ; 3EB21:  b1 00
            ldx #$00                    ; 3EB23:  a2 00
            jmp vm_push16_AX                ; 3EB25:  4c 08 f0

vm_op_AB_word: jsr vm_read_word_into_ptr0                ; 3EB28:  20 d5 ef
            bcc b15_eb21                ; 3EB2B:  90 f4
vm_op_EA_host_call_indirect: lda $08                     ; 3EB2D:  a5 08
            sta scratch_ptr_lo                     ; 3EB2F:  85 00
            lda $09                     ; 3EB31:  a5 09
            sta scratch_ptr_hi                     ; 3EB33:  85 01
            jmp b15_eb3b                ; 3EB35:  4c 3b eb

vm_op_E9_host_call: jsr vm_read_word_into_ptr0                ; 3EB38:  20 d5 ef
b15_eb3b:   jsr vm_call_native                ; 3EB3B:  20 57 eb
            ldy #$00                    ; 3EB3E:  a0 00
            jmp vm_dispatch_with_ptr1_adjust                ; 3EB40:  4c 9e eb

vm_op_DD_host_call_indirect_simple: lda $08                     ; 3EB43:  a5 08
            sta scratch_ptr_lo                     ; 3EB45:  85 00
            lda $09                     ; 3EB47:  a5 09
            sta scratch_ptr_hi                     ; 3EB49:  85 01
            jmp b15_eb51                ; 3EB4B:  4c 51 eb

vm_op_AC_host_call_simple: jsr vm_read_word_into_ptr0                ; 3EB4E:  20 d5 ef
b15_eb51:   jsr vm_call_native                ; 3EB51:  20 57 eb
            jmp vm_dispatch                ; 3EB54:  4c 67 e8

vm_call_native:   sec                         ; 3EB57:  38
            lda vm_sp_lo                     ; 3EB58:  a5 02
            sbc #$02                    ; 3EB5A:  e9 02
            sta vm_sp_lo                     ; 3EB5C:  85 02
            bcs b15_eb62                ; 3EB5E:  b0 02
            dec vm_sp_hi                     ; 3EB60:  c6 03
b15_eb62:   lda vm_ip_lo                     ; 3EB62:  a5 06
            sta (vm_sp_lo),y                 ; 3EB64:  91 02
            iny                         ; 3EB66:  c8
            lda vm_ip_hi                     ; 3EB67:  a5 07
            sta (vm_sp_lo),y                 ; 3EB69:  91 02
            jsr tab_b15_eb7a            ; 3EB6B:  20 7a eb
            clc                         ; 3EB6E:  18
            lda vm_sp_lo                     ; 3EB6F:  a5 02
            adc #$02                    ; 3EB71:  69 02
            sta vm_sp_lo                     ; 3EB73:  85 02
            bcc b15_eb79                ; 3EB75:  90 02
            inc vm_sp_hi                     ; 3EB77:  e6 03
b15_eb79:   rts                         ; 3EB79:  60

tab_b15_eb7a: ; 3 bytes
indirect_jmp_trampoline: hex 6c 00 00                ; 3EB7A:  6c 00 00

vm_op_AD_byte: jsr vm_fetch_word                ; 3EB7D:  20 bf ef
            ldy #$00                    ; 3EB80:  a0 00
            stx scratch_ptr_lo                     ; 3EB82:  86 00
            tax                         ; 3EB84:  aa
            bne b15_eb8e                ; 3EB85:  d0 07
b15_eb87:   dec scratch_ptr_lo                     ; 3EB87:  c6 00
...
vm_dispatch_with_ptr1_adjust:   jsr vm_fetch_sbyte                ; 3EB9E:  20 97 ef
            adc vm_sp_lo                     ; 3EBA1:  65 02
            sta vm_sp_lo                     ; 3EBA3:  85 02
            bcc b15_eba9                ; 3EBA5:  90 02
            inc vm_sp_hi                     ; 3EBA7:  e6 03
b15_eba9:   jmp vm_dispatch                ; 3EBA9:  4c 67 e8

vm_op_AF:   jsr vm_fetch_word                ; 3EBAC:  20 bf ef
            adc vm_sp_lo                     ; 3EBAF:  65 02
            sta vm_sp_lo                     ; 3EBB1:  85 02
            txa                         ; 3EBB3:  8a
            adc vm_sp_hi                     ; 3EBB4:  65 03
            sta vm_sp_hi                     ; 3EBB6:  85 03
            jmp vm_dispatch                ; 3EBB8:  4c 67 e8

vm_op_D6_jump_abs:   jsr vm_fetch_word                ; 3EBBB:  20 bf ef
            sta vm_ip_lo                     ; 3EBBE:  85 06
            stx vm_ip_hi                     ; 3EBC0:  86 07
            jmp vm_dispatch                ; 3EBC2:  4c 67 e8

vm_op_D7_branch_nz_abs: lda $08                     ; 3EBC5:  a5 08
            ora $09                     ; 3EBC7:  05 09
            bne vm_op_D6_jump_abs                ; 3EBC9:  d0 f0
b15_ebcb:   jsr vm_fetch_word                ; 3EBCB:  20 bf ef
            jmp vm_dispatch                ; 3EBCE:  4c 67 e8

vm_op_D8_branch_z_abs: lda $08                     ; 3EBD1:  a5 08
            ora $09                     ; 3EBD3:  05 09
            beq vm_op_D6_jump_abs                ; 3EBD5:  f0 e4
            bne b15_ebcb                ; 3EBD7:  d0 f2
vm_op_E3:   jsr vm_fetch_sbyte                ; 3EBD9:  20 97 ef
            adc vm_ip_lo                     ; 3EBDC:  65 06
            sta vm_ip_lo                     ; 3EBDE:  85 06
            bcs b15_ebe4                ; 3EBE0:  b0 02
            dec vm_ip_hi                     ; 3EBE2:  c6 07
b15_ebe4:   jmp vm_dispatch                ; 3EBE4:  4c 67 e8

vm_op_E4_branch_nz_rel: lda $08                     ; 3EBE7:  a5 08
            ora $09                     ; 3EBE9:  05 09
            bne vm_op_E3                ; 3EBEB:  d0 ec
b15_ebed:   jsr vm_fetch_sbyte                ; 3EBED:  20 97 ef
            jmp vm_dispatch                ; 3EBF0:  4c 67 e8

vm_op_E5_branch_z_rel: lda $08                     ; 3EBF3:  a5 08
            ora $09                     ; 3EBF5:  05 09
            beq vm_op_E3                ; 3EBF7:  f0 e0
            bne b15_ebed                ; 3EBF9:  d0 f2
vm_op_E6_jump_rel_fwd:   jsr vm_fetch_sbyte                ; 3EBFB:  20 97 ef
            adc vm_ip_lo                     ; 3EBFE:  65 06
            sta vm_ip_lo                     ; 3EC00:  85 06
            bcc b15_ec06                ; 3EC02:  90 02
            inc vm_ip_hi                     ; 3EC04:  e6 07
b15_ec06:   jmp vm_dispatch                ; 3EC06:  4c 67 e8

vm_op_E7_branch_nz_rel_fwd: lda $08                     ; 3EC09:  a5 08
            ora $09                     ; 3EC0B:  05 09
            bne vm_op_E6_jump_rel_fwd                ; 3EC0D:  d0 ec
b15_ec0f:   jsr vm_fetch_sbyte                ; 3EC0F:  20 97 ef
            jmp vm_dispatch                ; 3EC12:  4c 67 e8

vm_op_E8_branch_z_rel_fwd: lda $08                     ; 3EC15:  a5 08
            ora $09                     ; 3EC17:  05 09
            beq vm_op_E6_jump_rel_fwd                ; 3EC19:  f0 e0
            bne b15_ec0f                ; 3EC1B:  d0 f2
vm_op_D9_switch: lda (vm_ip_lo),y                 ; 3EC1D:  b1 06
            tax                         ; 3EC1F:  aa
            iny                         ; 3EC20:  c8
            lda (vm_ip_lo),y                 ; 3EC21:  b1 06
            sta $0c                     ; 3EC23:  85 0c
            clc                         ; 3EC25:  18
            lda vm_ip_lo                     ; 3EC26:  a5 06
            adc #$02                    ; 3EC28:  69 02
            sta vm_ip_lo                     ; 3EC2A:  85 06
            bcc b15_ec30                ; 3EC2C:  90 02
            inc vm_ip_hi                     ; 3EC2E:  e6 07
...
b15_ec3c:   dex                         ; 3EC3C:  ca
            lda (vm_ip_lo),y                 ; 3EC3D:  b1 06
            cmp $08                     ; 3EC3F:  c5 08
            bne b15_ec4a                ; 3EC41:  d0 07
            iny                         ; 3EC43:  c8
            lda (vm_ip_lo),y                 ; 3EC44:  b1 06
            cmp $09                     ; 3EC46:  c5 09
            beq b15_ec57                ; 3EC48:  f0 0d
b15_ec4a:   clc                         ; 3EC4A:  18
            lda vm_ip_lo                     ; 3EC4B:  a5 06
            adc #$04                    ; 3EC4D:  69 04
            sta vm_ip_lo                     ; 3EC4F:  85 06
            bcc b15_ec30                ; 3EC51:  90 dd
            inc vm_ip_hi                     ; 3EC53:  e6 07
            bcs b15_ec30                ; 3EC55:  b0 d9
b15_ec57:   iny                         ; 3EC57:  c8
            lda (vm_ip_lo),y                 ; 3EC58:  b1 06
            tax                         ; 3EC5A:  aa
            iny                         ; 3EC5B:  c8
            lda (vm_ip_lo),y                 ; 3EC5C:  b1 06
            sta vm_ip_hi                     ; 3EC5E:  85 07
            stx vm_ip_lo                     ; 3EC60:  86 06
            jmp vm_dispatch                ; 3EC62:  4c 67 e8

vm_op_D5_switch: clc                         ; 3EC65:  18
            lda (vm_ip_lo),y                 ; 3EC66:  b1 06
            adc $08                     ; 3EC68:  65 08
            sta $08                     ; 3EC6A:  85 08
            iny                         ; 3EC6C:  c8
            lda (vm_ip_lo),y                 ; 3EC6D:  b1 06
            adc $09                     ; 3EC6F:  65 09
            sta $09                     ; 3EC71:  85 09
            iny                         ; 3EC73:  c8
            lda $08                     ; 3EC74:  a5 08
            cmp (vm_ip_lo),y                 ; 3EC76:  d1 06
            iny                         ; 3EC78:  c8
            lda $09                     ; 3EC79:  a5 09
            sbc (vm_ip_lo),y                 ; 3EC7B:  f1 06
            iny                         ; 3EC7D:  c8
            bcs b15_ec91                ; 3EC7E:  b0 11
            lda $08                     ; 3EC80:  a5 08
            asl a                       ; 3EC82:  0a
            rol $09                     ; 3EC83:  26 09
            adc vm_ip_lo                     ; 3EC85:  65 06
            sta vm_ip_lo                     ; 3EC87:  85 06
            lda $09                     ; 3EC89:  a5 09
            adc vm_ip_hi                     ; 3EC8B:  65 07
            sta vm_ip_hi                     ; 3EC8D:  85 07
            ldy #$06                    ; 3EC8F:  a0 06
b15_ec91:   lda (vm_ip_lo),y                 ; 3EC91:  b1 06
            tax                         ; 3EC93:  aa
            iny                         ; 3EC94:  c8
            lda (vm_ip_lo),y                 ; 3EC95:  b1 06
            sta vm_ip_hi                     ; 3EC97:  85 07
            stx vm_ip_lo                     ; 3EC99:  86 06
            jmp vm_dispatch                ; 3EC9B:  4c 67 e8

vm_op_B0_loadA_ind_word: lda ($08),y                 ; 3EC9E:  b1 08
            tax                         ; 3ECA0:  aa
            iny                         ; 3ECA1:  c8
...
vm_op_D3_loadA_ind_byte: lda ($08),y                 ; 3ECAB:  b1 08
            sta $08                     ; 3ECAD:  85 08
            sty $09                     ; 3ECAF:  84 09
            jmp vm_dispatch                ; 3ECB1:  4c 67 e8

vm_op_B1_storeA_ind_word: jsr vm_pop_operand16                ; 3ECB4:  20 db ec
            lda $09                     ; 3ECB7:  a5 09
...
vm_op_D4_storeA_ind_byte: jsr vm_pop_operand16                ; 3ECC3:  20 db ec
            dey                         ; 3ECC6:  88
            lda $08                     ; 3ECC7:  a5 08
            sta ($0c),y                 ; 3ECC9:  91 0c
            jmp vm_dispatch                ; 3ECCB:  4c 67 e8

vm_op_B3_pushA: lda $08                     ; 3ECCE:  a5 08
            ldx $09                     ; 3ECD0:  a6 09
            jmp vm_push16_AX                ; 3ECD2:  4c 08 f0

vm_op_B4_popB: jsr vm_pop_operand16                ; 3ECD5:  20 db ec
            jmp vm_dispatch                ; 3ECD8:  4c 67 e8

vm_pop_operand16:   lda (vm_sp_lo),y                 ; 3ECDB:  b1 02
            sta $0c                     ; 3ECDD:  85 0c
            iny                         ; 3ECDF:  c8
            lda (vm_sp_lo),y                 ; 3ECE0:  b1 02
            sta $0d                     ; 3ECE2:  85 0d
            clc                         ; 3ECE4:  18
            lda vm_sp_lo                     ; 3ECE5:  a5 02
            adc #$02                    ; 3ECE7:  69 02
            sta vm_sp_lo                     ; 3ECE9:  85 02
            bcc b15_ecef                ; 3ECEB:  90 02
            inc vm_sp_hi                     ; 3ECED:  e6 03
b15_ecef:   rts                         ; 3ECEF:  60

vm_op_B5_mul: ldy #$00                    ; 3ECF0:  a0 00
            sty scratch_ptr_lo                     ; 3ECF2:  84 00
            sty scratch_ptr_hi                     ; 3ECF4:  84 01
            ldy #$10                    ; 3ECF6:  a0 10
b15_ecf8:   lda $08                     ; 3ECF8:  a5 08
            lsr a                       ; 3ECFA:  4a
            bcc b15_ed0a                ; 3ECFB:  90 0d
            clc                         ; 3ECFD:  18
            lda scratch_ptr_lo                     ; 3ECFE:  a5 00
            adc $0c                     ; 3ED00:  65 0c
            sta scratch_ptr_lo                     ; 3ED02:  85 00
            lda scratch_ptr_hi                     ; 3ED04:  a5 01
            adc $0d                     ; 3ED06:  65 0d
            sta scratch_ptr_hi                     ; 3ED08:  85 01
b15_ed0a:   ror scratch_ptr_hi                     ; 3ED0A:  66 01
            ror scratch_ptr_lo                     ; 3ED0C:  66 00
            ror $09                     ; 3ED0E:  66 09
            ror $08                     ; 3ED10:  66 08
            dey                         ; 3ED12:  88
...
vm_op_B8_div_unsigned: jsr udiv16                ; 3ED18:  20 2e ed
            jmp vm_dispatch                ; 3ED1B:  4c 67 e8

vm_op_B6_div_signed: jsr sdiv16_setup_signs                ; 3ED1E:  20 7a ed
            jsr udiv16                ; 3ED21:  20 2e ed
            lda $0a                     ; 3ED24:  a5 0a
            bpl tab_b15_ed2b            ; 3ED26:  10 03
            jmp vm_op_CB                ; 3ED28:  4c 09 ef

tab_b15_ed2b: ; 3 bytes
            hex 4c 67 e8                ; 3ED2B:  4c 67 e8

udiv16:   ldy #$00                    ; 3ED2E:  a0 00
            sty scratch_ptr_lo                     ; 3ED30:  84 00
            sty scratch_ptr_hi                     ; 3ED32:  84 01
            ldy #$10                    ; 3ED34:  a0 10
b15_ed36:   asl $08                     ; 3ED36:  06 08
            rol $09                     ; 3ED38:  26 09
            rol scratch_ptr_lo                     ; 3ED3A:  26 00
            rol scratch_ptr_hi                     ; 3ED3C:  26 01
            sec                         ; 3ED3E:  38
            lda scratch_ptr_lo                     ; 3ED3F:  a5 00
            sbc $0c                     ; 3ED41:  e5 0c
            tax                         ; 3ED43:  aa
            lda scratch_ptr_hi                     ; 3ED44:  a5 01
            sbc $0d                     ; 3ED46:  e5 0d
            bcc b15_ed50                ; 3ED48:  90 06
            stx scratch_ptr_lo                     ; 3ED4A:  86 00
            sta scratch_ptr_hi                     ; 3ED4C:  85 01
            inc $08                     ; 3ED4E:  e6 08
b15_ed50:   dey                         ; 3ED50:  88
            bne b15_ed36                ; 3ED51:  d0 e3
            rts                         ; 3ED53:  60

vm_op_B9_mod_signed: jsr sdiv16_setup_signs                ; 3ED54:  20 7a ed
            jsr udiv16                ; 3ED57:  20 2e ed
            lda scratch_ptr_lo                     ; 3ED5A:  a5 00
            sta $08                     ; 3ED5C:  85 08
            lda scratch_ptr_hi                     ; 3ED5E:  a5 01
            sta $09                     ; 3ED60:  85 09
            lda $0b                     ; 3ED62:  a5 0b
            bpl tab_b15_ed69            ; 3ED64:  10 03
            jmp vm_op_CB                ; 3ED66:  4c 09 ef

tab_b15_ed69: ; 3 bytes
            hex 4c 67 e8                ; 3ED69:  4c 67 e8

vm_op_BA_mod_unsigned: jsr udiv16                ; 3ED6C:  20 2e ed
            lda scratch_ptr_lo                     ; 3ED6F:  a5 00
            sta $08                     ; 3ED71:  85 08
            lda scratch_ptr_hi                     ; 3ED73:  a5 01
            sta $09                     ; 3ED75:  85 09
            jmp vm_dispatch                ; 3ED77:  4c 67 e8

sdiv16_setup_signs:   lda $09                     ; 3ED7A:  a5 09
            sta $0b                     ; 3ED7C:  85 0b
            eor $0d                     ; 3ED7E:  45 0d
            sta $0a                     ; 3ED80:  85 0a
            lda $09                     ; 3ED82:  a5 09
...
vm_op_BD_shl_by_regB: ldx $0c                     ; 3EDC1:  a6 0c
...
vm_op_BF_ashr_by_regB: lda $09                     ; 3EDD5:  a5 09
            bpl vm_op_BE_lshr_by_regB                ; 3EDD7:  10 15
            ldx $0c                     ; 3EDD9:  a6 0c
...
vm_op_BE_lshr_by_regB:   ldx $0c                     ; 3EDEE:  a6 0c
...
vm_op_DA_bitand: lda $08                     ; 3EE02:  a5 08
            and $0c                     ; 3EE04:  25 0c
            sta $08                     ; 3EE06:  85 08
            lda $09                     ; 3EE08:  a5 09
            and $0d                     ; 3EE0A:  25 0d
...
vm_op_DB_bitor: lda $08                     ; 3EE11:  a5 08
            ora $0c                     ; 3EE13:  05 0c
            sta $08                     ; 3EE15:  85 08
            lda $09                     ; 3EE17:  a5 09
            ora $0d                     ; 3EE19:  05 0d
...
vm_op_DC_bitxor: lda $08                     ; 3EE20:  a5 08
            eor $0c                     ; 3EE22:  45 0c
            sta $08                     ; 3EE24:  85 08
            lda $09                     ; 3EE26:  a5 09
            eor $0d                     ; 3EE28:  45 0d
...
vm_op_C0_cmp_eq: lda $09                     ; 3EE2F:  a5 09
            cmp $0d                     ; 3EE31:  c5 0d
            sty $09                     ; 3EE33:  84 09
...
vm_op_C1_cmp_ne: lda $09                     ; 3EE43:  a5 09
            cmp $0d                     ; 3EE45:  c5 0d
            sty $09                     ; 3EE47:  84 09
...
vm_op_C2_cmp_slt: lda $08                     ; 3EE57:  a5 08
            cmp $0c                     ; 3EE59:  c5 0c
            lda $09                     ; 3EE5B:  a5 09
            sbc $0d                     ; 3EE5D:  e5 0d
            sty $09                     ; 3EE5F:  84 09
...
vm_op_C4_cmp_sgt: lda $0c                     ; 3EE6E:  a5 0c
            cmp $08                     ; 3EE70:  c5 08
            lda $0d                     ; 3EE72:  a5 0d
            sbc $09                     ; 3EE74:  e5 09
            sty $09                     ; 3EE76:  84 09
...
vm_op_C3_cmp_sge: lda $0c                     ; 3EE85:  a5 0c
            cmp $08                     ; 3EE87:  c5 08
            lda $0d                     ; 3EE89:  a5 0d
            sbc $09                     ; 3EE8B:  e5 09
            sty $09                     ; 3EE8D:  84 09
...
vm_op_C5_cmp_sle: lda $08                     ; 3EE9C:  a5 08
            cmp $0c                     ; 3EE9E:  c5 0c
            lda $09                     ; 3EEA0:  a5 09
            sbc $0d                     ; 3EEA2:  e5 0d
            sty $09                     ; 3EEA4:  84 09
...
vm_op_C6_cmp_uge: lda $08                     ; 3EEB3:  a5 08
            cmp $0c                     ; 3EEB5:  c5 0c
            lda $09                     ; 3EEB7:  a5 09
            sbc $0d                     ; 3EEB9:  e5 0d
            sty $09                     ; 3EEBB:  84 09
...
vm_op_C8_cmp_ugt: lda $0c                     ; 3EEC5:  a5 0c
            cmp $08                     ; 3EEC7:  c5 08
            lda $0d                     ; 3EEC9:  a5 0d
            sbc $09                     ; 3EECB:  e5 09
            sty $09                     ; 3EECD:  84 09
...
vm_op_C7_cmp_ule: lda $0c                     ; 3EED7:  a5 0c
            cmp $08                     ; 3EED9:  c5 08
            lda $0d                     ; 3EEDB:  a5 0d
            sbc $09                     ; 3EEDD:  e5 09
            sty $09                     ; 3EEDF:  84 09
...
vm_op_C9_cmp_ult: lda $08                     ; 3EEE9:  a5 08
            cmp $0c                     ; 3EEEB:  c5 0c
            lda $09                     ; 3EEED:  a5 09
            sbc $0d                     ; 3EEEF:  e5 0d
            sty $09                     ; 3EEF1:  84 09
...
vm_op_CA_is_zero: lda $09                     ; 3EEFB:  a5 09
            sty $09                     ; 3EEFD:  84 09
            ora $08                     ; 3EEFF:  05 08
...
vm_op_CD_swap_AB: lda $08                     ; 3EF26:  a5 08
            ldx $0c                     ; 3EF28:  a6 0c
            stx $08                     ; 3EF2A:  86 08
            sta $0c                     ; 3EF2C:  85 0c
            lda $09                     ; 3EF2E:  a5 09
...
vm_op_D0_incA: inc $08                     ; 3EF39:  e6 08
            bne b15_ef3f                ; 3EF3B:  d0 02
            inc $09                     ; 3EF3D:  e6 09
b15_ef3f:   jmp vm_dispatch                ; 3EF3F:  4c 67 e8

vm_op_D1_decA: lda $08                     ; 3EF42:  a5 08
            bne b15_ef48                ; 3EF44:  d0 02
            dec $09                     ; 3EF46:  c6 09
b15_ef48:   dec $08                     ; 3EF48:  c6 08
            jmp vm_dispatch                ; 3EF4A:  4c 67 e8

vm_op_D2_aslA: asl $08                     ; 3EF4D:  06 08
            rol $09                     ; 3EF4F:  26 09
            jmp vm_dispatch                ; 3EF51:  4c 67 e8

vm_op_E0_byte: jsr vm_fetch_word                ; 3EF54:  20 bf ef
            ldy #$08                    ; 3EF57:  a0 08
            jsr vm_bitfield_read_test                ; 3EF59:  20 03 f6
            jmp vm_dispatch                ; 3EF5C:  4c 67 e8

vm_op_E1_byte: jsr vm_fetch_word                ; 3EF5F:  20 bf ef
            ldy #$08                    ; 3EF62:  a0 08
            jsr vm_bitfield_read                ; 3EF64:  20 cd f5
            jmp vm_dispatch                ; 3EF67:  4c 67 e8

vm_op_E2_byte: jsr vm_fetch_word                ; 3EF6A:  20 bf ef
            ldy #$0c                    ; 3EF6D:  a0 0c
            jsr vm_bitfield_write                ; 3EF6F:  20 2c f6
            jmp vm_dispatch                ; 3EF72:  4c 67 e8

vm_op_CF_vm_return: ldy #$07                    ; 3EF75:  a0 07
            lda vm_fp_lo                     ; 3EF77:  a5 04
            sta $0c                     ; 3EF79:  85 0c
            lda vm_fp_hi                     ; 3EF7B:  a5 05
            sta $0d                     ; 3EF7D:  85 0d
b15_ef7f:   lda ($0c),y                 ; 3EF7F:  b1 0c
            hex 99 00 00 ; sta scratch_ptr_lo,y  ; 3EF81:  99 00 00
            dey                         ; 3EF84:  88
            bpl b15_ef7f                ; 3EF85:  10 f8
            inc scratch_ptr_lo                     ; 3EF87:  e6 00
            bne b15_ef8f                ; 3EF89:  d0 04
            inc scratch_ptr_hi                     ; 3EF8B:  e6 01
            ldx #$00                    ; 3EF8D:  a2 00
b15_ef8f:   jmp (scratch_ptr_lo)                 ; 3EF8F:  6c 00 00

vm_op_trigger_syscall_shared: brk                         ; 3EF92:  00
vm_op_FF:   hex 00                      ; 3EF93:  00
            jmp vm_dispatch                ; 3EF94:  4c 67 e8

vm_fetch_sbyte:   ldx #$00                    ; 3EF97:  a2 00
            lda (vm_ip_lo),y                 ; 3EF99:  b1 06
            bpl b15_ef9e                ; 3EF9B:  10 01
            dex                         ; 3EF9D:  ca
b15_ef9e:   inc vm_ip_lo                     ; 3EF9E:  e6 06
            bne b15_efa4                ; 3EFA0:  d0 02
            inc vm_ip_hi                     ; 3EFA2:  e6 07
b15_efa4:   clc                         ; 3EFA4:  18
            rts                         ; 3EFA5:  60

vm_addr_ptr2_plus_sbyte:   clc                         ; 3EFA6:  18
            ldx #$00                    ; 3EFA7:  a2 00
            lda (vm_ip_lo),y                 ; 3EFA9:  b1 06
            bpl b15_efae                ; 3EFAB:  10 01
            dex                         ; 3EFAD:  ca
b15_efae:   adc vm_fp_lo                     ; 3EFAE:  65 04
            sta scratch_ptr_lo                     ; 3EFB0:  85 00
            txa                         ; 3EFB2:  8a
            adc vm_fp_hi                     ; 3EFB3:  65 05
            sta scratch_ptr_hi                     ; 3EFB5:  85 01
            inc vm_ip_lo                     ; 3EFB7:  e6 06
            bne b15_efbd                ; 3EFB9:  d0 02
            inc vm_ip_hi                     ; 3EFBB:  e6 07
b15_efbd:   clc                         ; 3EFBD:  18
            rts                         ; 3EFBE:  60

vm_fetch_word:   iny                         ; 3EFBF:  c8
            lda (vm_ip_lo),y                 ; 3EFC0:  b1 06
            tax                         ; 3EFC2:  aa
            dey                         ; 3EFC3:  88
            lda (vm_ip_lo),y                 ; 3EFC4:  b1 06
            pha                         ; 3EFC6:  48
            clc                         ; 3EFC7:  18
            lda vm_ip_lo                     ; 3EFC8:  a5 06
            adc #$02                    ; 3EFCA:  69 02
            sta vm_ip_lo                     ; 3EFCC:  85 06
            bcc b15_efd3                ; 3EFCE:  90 03
            inc vm_ip_hi                     ; 3EFD0:  e6 07
            clc                         ; 3EFD2:  18
b15_efd3:   pla                         ; 3EFD3:  68
            rts                         ; 3EFD4:  60

vm_read_word_into_ptr0:   lda (vm_ip_lo),y                 ; 3EFD5:  b1 06
            sta scratch_ptr_lo                     ; 3EFD7:  85 00
            iny                         ; 3EFD9:  c8
            lda (vm_ip_lo),y                 ; 3EFDA:  b1 06
            sta scratch_ptr_hi                     ; 3EFDC:  85 01
            dey                         ; 3EFDE:  88
            clc                         ; 3EFDF:  18
            lda vm_ip_lo                     ; 3EFE0:  a5 06
            adc #$02                    ; 3EFE2:  69 02
            sta vm_ip_lo                     ; 3EFE4:  85 06
            bcc b15_efeb                ; 3EFE6:  90 03
            inc vm_ip_hi                     ; 3EFE8:  e6 07
            clc                         ; 3EFEA:  18
b15_efeb:   rts                         ; 3EFEB:  60

vm_addr_ptr2_plus_word:   clc                         ; 3EFEC:  18
            lda (vm_ip_lo),y                 ; 3EFED:  b1 06
            adc vm_fp_lo                     ; 3EFEF:  65 04
            sta scratch_ptr_lo                     ; 3EFF1:  85 00
            iny                         ; 3EFF3:  c8
            lda (vm_ip_lo),y                 ; 3EFF4:  b1 06
            adc vm_fp_hi                     ; 3EFF6:  65 05
            sta scratch_ptr_hi                     ; 3EFF8:  85 01
            dey                         ; 3EFFA:  88
            clc                         ; 3EFFB:  18
            lda vm_ip_lo                     ; 3EFFC:  a5 06
            adc #$02                    ; 3EFFE:  69 02
            sta vm_ip_lo                     ; 3F000:  85 06
            bcc b15_f007                ; 3F002:  90 03
            inc vm_ip_hi                     ; 3F004:  e6 07
            clc                         ; 3F006:  18
b15_f007:   rts                         ; 3F007:  60

vm_push16_AX:   tay                         ; 3F008:  a8
            sec                         ; 3F009:  38
            lda vm_sp_lo                     ; 3F00A:  a5 02
            sbc #$02                    ; 3F00C:  e9 02
            sta vm_sp_lo                     ; 3F00E:  85 02
            bcs b15_f014                ; 3F010:  b0 02
            dec vm_sp_hi                     ; 3F012:  c6 03
b15_f014:   tya                         ; 3F014:  98
            ldy #$00                    ; 3F015:  a0 00
            sta (vm_sp_lo),y                 ; 3F017:  91 02
            iny                         ; 3F019:  c8
            txa                         ; 3F01A:  8a
            sta (vm_sp_lo),y                 ; 3F01B:  91 02
            jmp vm_dispatch                ; 3F01D:  4c 67 e8

vm_op_B2_pushA_B2: jsr tab_b15_f679            ; 3F020:  20 79 f6
            jmp vm_dispatch                ; 3F023:  4c 67 e8

tab_b15_f026: ; 512 bytes
vm_opcode_lo_table: hex 7f 83 87 8b 8f 93 97 9b ; 3F026:  7f 83 87 8b 8f 93 97 9b
...
vm_opcode_hi_table: hex e8 e8 e8 e8 e8 e8 e8 e8 ; 3F126:  e8 e8 e8 e8 e8 e8 e8 e8
...
syscall_dispatch: ldy #$17                    ; 3F226:  a0 17
b15_f228:   lda (vm_sp_lo),y                 ; 3F228:  b1 02
            ...
            nop                         ; 3F23C:  ea
            lda brk_scratch_lo                     ; 3F23D:  a5 66
            sta $08                     ; 3F23F:  85 08
            lda brk_scratch_hi                     ; 3F241:  a5 67
            sta $09                     ; 3F243:  85 09
            rts                         ; 3F245:  60

ext_op_dispatch: lda (vm_ip_lo),y                 ; 3F246:  b1 06
            inc vm_ip_lo                     ; 3F248:  e6 06
            bne b15_f24e                ; 3F24A:  d0 02
            inc vm_ip_hi                     ; 3F24C:  e6 07
b15_f24e:   asl a                       ; 3F24E:  0a
            tax                         ; 3F24F:  aa
            lda b15_f260+1,x            ; 3F250:  bd 61 f2
            sta scratch_ptr_lo                     ; 3F253:  85 00
            lda b15_f260+2,x            ; 3F255:  bd 62 f2
            sta scratch_ptr_hi                     ; 3F258:  85 01
            lda #$e8                    ; 3F25A:  a9 e8
            pha                         ; 3F25C:  48
            lda #$66                    ; 3F25D:  a9 66
            pha                         ; 3F25F:  48
b15_f260:   jmp (scratch_ptr_lo)                 ; 3F260:  6c 00 00

ext_op_table: hex c1 f2 f0 f2 7f f3 8c f3 ; 3F263:  c1 f2 f0 f2 7f f3 8c f3
...
sdiv32:     jsr sdiv32_setup                ; 3F2F0:  20 fe f2
            lda $40                     ; 3F2F3:  a5 40
            bpl tab_b15_f2fa            ; 3F2F5:  10 03
            jmp negate32_operand                ; 3F2F7:  4c 27 f4

tab_b15_f2fa: ; 4 bytes
            hex 60 4c 1c f3             ; 3F2FA:  60 4c 1c f3

sdiv32_setup:   lda $0b                     ; 3F2FE:  a5 0b
            sta $41                     ; 3F300:  85 41
            eor $0f                     ; 3F302:  45 0f
            sta $40                     ; 3F304:  85 40
            lda $0b                     ; 3F306:  a5 0b
            bpl b15_f30d                ; 3F308:  10 03
            jsr negate32_operand                ; 3F30A:  20 27 f4
b15_f30d:   lda $0f                     ; 3F30D:  a5 0f
            bpl udiv32                ; 3F30F:  10 0b
            ldx #$fc                    ; 3F311:  a2 fc
...
b15_f328:   asl $08                     ; 3F328:  06 08
            ...
            lda $10                     ; 3F339:  a5 10
            sbc $0c                     ; 3F33B:  e5 0c
            sta scratch_ptr_lo                     ; 3F33D:  85 00
            lda $11                     ; 3F33F:  a5 11
            sbc $0d                     ; 3F341:  e5 0d
            sta scratch_ptr_hi                     ; 3F343:  85 01
            lda $12                     ; 3F345:  a5 12
            sbc $0e                     ; 3F347:  e5 0e
            tax                         ; 3F349:  aa
            lda $13                     ; 3F34A:  a5 13
            ...
            stx $12                     ; 3F350:  86 12
            sta $13                     ; 3F352:  85 13
            lda scratch_ptr_lo                     ; 3F354:  a5 00
            sta $10                     ; 3F356:  85 10
            lda scratch_ptr_hi                     ; 3F358:  a5 01
            sta $11                     ; 3F35A:  85 11
            inc $08                     ; 3F35C:  e6 08
...
umod32:     jsr udiv32                ; 3F362:  20 1c f3
            sty $41                     ; 3F365:  84 41
            ldx #$03                    ; 3F367:  a2 03
            bne b15_f370                ; 3F369:  d0 05
smod32:     jsr sdiv32_setup                ; 3F36B:  20 fe f2
            ldx #$03                    ; 3F36E:  a2 03
...
b15_f3aa:   asl $08                     ; 3F3AA:  06 08
            ...
            rol $0a                     ; 3F3AE:  26 0a
            rol $0b                     ; 3F3B0:  26 0b
            jmp shl32_var                ; 3F3B2:  4c 99 f3

shr32_var_arith: clc                         ; 3F3B5:  18
            lda $0b                     ; 3F3B6:  a5 0b
...
shr32_var_logical:   clc                         ; 3F3DB:  18
            ldy #$ff                    ; 3F3DC:  a0 ff
            ldx #$fc                    ; 3F3DE:  a2 fc
...
b15_f3ec:   lsr $0b                     ; 3F3EC:  46 0b
            ...
            ror $09                     ; 3F3F0:  66 09
            ror $08                     ; 3F3F2:  66 08
            jmp shr32_var_logical                ; 3F3F4:  4c db f3

not32:      ldx #$03                    ; 3F3F7:  a2 03
...
logical_not32: jsr test_nonzero32                ; 3F433:  20 3b f4
            lda $08                     ; 3F436:  a5 08
            eor #$01                    ; 3F438:  49 01
            rts                         ; 3F43A:  60

test_nonzero32:   ldx #$03                    ; 3F43B:  a2 03
b15_f43d:   lda $08,x                   ; 3F43D:  b5 08
            bne b15_f451                ; 3F43F:  d0 10
            dex                         ; 3F441:  ca
            bpl b15_f43d                ; 3F442:  10 f9
            bmi b15_f462                ; 3F444:  30 1c
cmp32_eq:   ldx #$03                    ; 3F446:  a2 03
...
cmp32_a_lt_b_signed: jsr cmp32_a_minus_b                ; 3F467:  20 c3 f4
...
cmp32_a_lt_b_unsigned: jsr cmp32_a_minus_b                ; 3F475:  20 c3 f4
            bcs b15_f47b                ; 3F478:  b0 01
            iny                         ; 3F47A:  c8
b15_f47b:   sty $08                     ; 3F47B:  84 08
            rts                         ; 3F47D:  60

cmp32_a_gt_b_signed: jsr cmp32_b_minus_a                ; 3F47E:  20 d6 f4
...
cmp32_a_gt_b_unsigned: jsr cmp32_b_minus_a                ; 3F48C:  20 d6 f4
            bcs b15_f492                ; 3F48F:  b0 01
            iny                         ; 3F491:  c8
b15_f492:   sty $08                     ; 3F492:  84 08
            rts                         ; 3F494:  60

cmp32_a_le_b_signed: jsr cmp32_b_minus_a                ; 3F495:  20 d6 f4
...
cmp32_a_le_b_unsigned: jsr cmp32_b_minus_a                ; 3F4A3:  20 d6 f4
            bcc b15_f4a9                ; 3F4A6:  90 01
            iny                         ; 3F4A8:  c8
b15_f4a9:   sty $08                     ; 3F4A9:  84 08
            rts                         ; 3F4AB:  60

cmp32_a_ge_b_signed: jsr cmp32_a_minus_b                ; 3F4AC:  20 c3 f4
...
cmp32_a_ge_b_unsigned: jsr cmp32_a_minus_b                ; 3F4BA:  20 c3 f4
            bcc b15_f4c0                ; 3F4BD:  90 01
            iny                         ; 3F4BF:  c8
b15_f4c0:   sty $08                     ; 3F4C0:  84 08
            rts                         ; 3F4C2:  60

cmp32_a_minus_b:   lda $08                     ; 3F4C3:  a5 08
            cmp $0c                     ; 3F4C5:  c5 0c
            lda $09                     ; 3F4C7:  a5 09
            sbc $0d                     ; 3F4C9:  e5 0d
            sty $09                     ; 3F4CB:  84 09
...
cmp32_b_minus_a:   lda $0c                     ; 3F4D6:  a5 0c
            cmp $08                     ; 3F4D8:  c5 08
            lda $0d                     ; 3F4DA:  a5 0d
            sbc $09                     ; 3F4DC:  e5 09
            sty $09                     ; 3F4DE:  84 09
...
sign_extend16_to_32: lda $09                     ; 3F4E9:  a5 09
            bpl clear_a_high16                ; 3F4EB:  10 02
            ldy #$ff                    ; 3F4ED:  a0 ff
clear_a_high16:   sty $0a                     ; 3F4EF:  84 0a
            sty $0b                     ; 3F4F1:  84 0b
ext_op_nop: rts                         ; 3F4F3:  60

load_a32_from_ptr3:   lda (vm_ip_lo),y                 ; 3F4F4:  b1 06
            hex 99 08 00 ; sta $0008,y  ; 3F4F6:  99 08 00
            iny                         ; 3F4F9:  c8
            cpy #$04                    ; 3F4FA:  c0 04
            bne load_a32_from_ptr3                ; 3F4FC:  d0 f6
            beq b15_f50a                ; 3F4FE:  f0 0a
load_b32_from_ptr3:   lda (vm_ip_lo),y                 ; 3F500:  b1 06
            hex 99 0c 00 ; sta $000c,y  ; 3F502:  99 0c 00
            iny                         ; 3F505:  c8
            cpy #$04                    ; 3F506:  c0 04
            bne load_b32_from_ptr3                ; 3F508:  d0 f6
b15_f50a:   lda vm_ip_lo                     ; 3F50A:  a5 06
            adc #$03                    ; 3F50C:  69 03
            sta vm_ip_lo                     ; 3F50E:  85 06
            bcc b15_f514                ; 3F510:  90 02
            inc vm_ip_hi                     ; 3F512:  e6 07
b15_f514:   rts                         ; 3F514:  60

halve_a32_rounded: ldy #$ff                    ; 3F515:  a0 ff
            tya                         ; 3F517:  98
            bne b15_f51c                ; 3F518:  d0 02
halve_a32:  lda #$01                    ; 3F51A:  a9 01
...
store_a32_via_popped_ptr: jsr vm_pop_operand16                ; 3F531:  20 db ec
            ldy #$03                    ; 3F534:  a0 03
...
load_a32_from_addr: jsr vm_addr_ptr2_plus_word                ; 3F54D:  20 ec ef
load_a32_from_ptr0:   ldy #$03                    ; 3F550:  a0 03
b15_f552:   lda (scratch_ptr_lo),y                 ; 3F552:  b1 00
            hex 99 08 00 ; sta $0008,y  ; 3F554:  99 08 00
            dey                         ; 3F557:  88
            bpl b15_f552                ; 3F558:  10 f8
            rts                         ; 3F55A:  60

load_b32_from_addr: jsr vm_addr_ptr2_plus_word                ; 3F55B:  20 ec ef
b15_f55e:   ldy #$03                    ; 3F55E:  a0 03
b15_f560:   lda (scratch_ptr_lo),y                 ; 3F560:  b1 00
            hex 99 0c 00 ; sta $000c,y  ; 3F562:  99 0c 00
            dey                         ; 3F565:  88
            bpl b15_f560                ; 3F566:  10 f8
            rts                         ; 3F568:  60

store_a32_to_addr: jsr vm_addr_ptr2_plus_word                ; 3F569:  20 ec ef
b15_f56c:   ldy #$03                    ; 3F56C:  a0 03
b15_f56e:   hex b9 08 00 ; lda $0008,y  ; 3F56E:  b9 08 00
            sta (scratch_ptr_lo),y                 ; 3F571:  91 00
            dey                         ; 3F573:  88
            bpl b15_f56e                ; 3F574:  10 f8
            rts                         ; 3F576:  60

store_a32_to_addr_or_push: jsr vm_addr_ptr2_plus_word                ; 3F577:  20 ec ef
            bcc vm_push32_tail                ; 3F57A:  90 12
load_a32_indirect: jsr vm_read_word_into_ptr0                ; 3F57C:  20 d5 ef
            bcc load_a32_from_ptr0                ; 3F57F:  90 cf
load_b32_indirect: jsr vm_read_word_into_ptr0                ; 3F581:  20 d5 ef
            bcc b15_f55e                ; 3F584:  90 d8
store_a32_indirect: jsr vm_read_word_into_ptr0                ; 3F586:  20 d5 ef
            bcc b15_f56c                ; 3F589:  90 e1
push_value32_to_vm_stack: jsr vm_read_word_into_ptr0                ; 3F58B:  20 d5 ef
vm_push32_tail:   sec                         ; 3F58E:  38
            lda vm_sp_lo                     ; 3F58F:  a5 02
            sbc #$04                    ; 3F591:  e9 04
            sta vm_sp_lo                     ; 3F593:  85 02
            bcs b15_f599                ; 3F595:  b0 02
            dec vm_sp_hi                     ; 3F597:  c6 03
b15_f599:   ldy #$03                    ; 3F599:  a0 03
b15_f59b:   lda (scratch_ptr_lo),y                 ; 3F59B:  b1 00
            sta (vm_sp_lo),y                 ; 3F59D:  91 02
            dey                         ; 3F59F:  88
            bpl b15_f59b                ; 3F5A0:  10 f9
            rts                         ; 3F5A2:  60

push_a32_to_vm_stack: lda #$08                    ; 3F5A3:  a9 08
            sta scratch_ptr_lo                     ; 3F5A5:  85 00
            sty scratch_ptr_hi                     ; 3F5A7:  84 01
            jmp vm_push32_tail                ; 3F5A9:  4c 8e f5

pop_b32_from_vm_stack: ldy #$03                    ; 3F5AC:  a0 03
b15_f5ae:   lda (vm_sp_lo),y                 ; 3F5AE:  b1 02
            hex 99 0c 00 ; sta $000c,y  ; 3F5B0:  99 0c 00
            dey                         ; 3F5B3:  88
            bpl b15_f5ae                ; 3F5B4:  10 f8
            clc                         ; 3F5B6:  18
            lda vm_sp_lo                     ; 3F5B7:  a5 02
            adc #$04                    ; 3F5B9:  69 04
            sta vm_sp_lo                     ; 3F5BB:  85 02
            bcc b15_f5c1                ; 3F5BD:  90 02
            inc vm_sp_hi                     ; 3F5BF:  e6 03
b15_f5c1:   rts                         ; 3F5C1:  60

load_a32_via_a_ptr: lda $08                     ; 3F5C2:  a5 08
            sta scratch_ptr_lo                     ; 3F5C4:  85 00
            lda $09                     ; 3F5C6:  a5 09
            sta scratch_ptr_hi                     ; 3F5C8:  85 01
            jmp load_a32_from_ptr0                ; 3F5CA:  4c 50 f5

vm_bitfield_read:   pha                         ; 3F5CD:  48
            hex b9 00 00 ; lda scratch_ptr_lo,y  ; 3F5CE:  b9 00 00
            sta scratch_ptr_lo                     ; 3F5D1:  85 00
            hex b9 01 00 ; lda scratch_ptr_hi,y  ; 3F5D3:  b9 01 00
            sta scratch_ptr_hi                     ; 3F5D6:  85 01
            ldy #$00                    ; 3F5D8:  a0 00
            lda (scratch_ptr_lo),y                 ; 3F5DA:  b1 00
            sta $08                     ; 3F5DC:  85 08
            iny                         ; 3F5DE:  c8
            lda (scratch_ptr_lo),y                 ; 3F5DF:  b1 00
            sta $09                     ; 3F5E1:  85 09
            txa                         ; 3F5E3:  8a
...
b15_f5ed:   pla                         ; 3F5ED:  68
            jsr make_bitmask                ; 3F5EE:  20 69 f6
            lda $08                     ; 3F5F1:  a5 08
            and $0a                     ; 3F5F3:  25 0a
            sta $08                     ; 3F5F5:  85 08
            lda $09                     ; 3F5F7:  a5 09
...
vm_bitfield_read_test:   jsr vm_bitfield_read                ; 3F603:  20 cd f5
            lda $0b                     ; 3F606:  a5 0b
            eor #$ff                    ; 3F608:  49 ff
            sta $0b                     ; 3F60A:  85 0b
            lsr a                       ; 3F60C:  4a
            and $09                     ; 3F60D:  25 09
            sta scratch_ptr_lo                     ; 3F60F:  85 00
            lda $0a                     ; 3F611:  a5 0a
            eor #$ff                    ; 3F613:  49 ff
            sta $0a                     ; 3F615:  85 0a
            ror a                       ; 3F617:  6a
            and $08                     ; 3F618:  25 08
            ora scratch_ptr_lo                     ; 3F61A:  05 00
...
vm_bitfield_write:   pha                         ; 3F62C:  48
            hex b9 00 00 ; lda scratch_ptr_lo,y  ; 3F62D:  b9 00 00
            sta scratch_ptr_lo                     ; 3F630:  85 00
            hex b9 01 00 ; lda scratch_ptr_hi,y  ; 3F632:  b9 01 00
            sta scratch_ptr_hi                     ; 3F635:  85 01
            pla                         ; 3F637:  68
            jsr make_bitmask                ; 3F638:  20 69 f6
            txa                         ; 3F63B:  8a
...
b15_f656:   hex b9 0a 00 ; lda $000a,y  ; 3F656:  b9 0a 00
            eor #$ff                    ; 3F659:  49 ff
            and (scratch_ptr_lo),y                 ; 3F65B:  31 00
            hex 19 08 00 ; ora $0008,y  ; 3F65D:  19 08 00
            sta (scratch_ptr_lo),y                 ; 3F660:  91 00
            dey                         ; 3F662:  88
...
msg_rebels_f72e: hex 52 65 62 65 6c 73 00 20 ; 3F72E:  52 65 62 65 6c 73 00 20
            ...
            jsr battle_defender_province_staging                   ; 3F792:  20 67 6f
            jmp ($0064)                 ; 3F795:  6c 64 00

msg_marriage_pact: hex 6d 61 72 72 69 61 67 65 ; 3F798:  6d 61 72 72 69 61 67 65
...
msg_d_lost_its_leader: hex 25 64 20 6c 6f 73 74 20 ; 3F7B8:  25 64 20 6c 6f 73 74 20
...
lord_command_name_ptrs: hex 40 f8 45 f8 49 f8 4d f8 ; 3F816:  40 f8 45 f8 49 f8 4d f8
            ...
            brk                         ; 3F87B:  00
            hex 42                      ; 3F87C:  42
            adc brk_jmp_target_hi,x                   ; 3F87D:  75 69
            ...
            eor (brk_scratch_hi,x)                 ; 3F8D2:  41 67
            adc scratch_ptr_lo                     ; 3F8D4:  65 00
            pha                         ; 3F8D6:  48
...
msg_fiefs:  hex 20 20 46 69 65 66 73 20 ; 3F994:  20 20 46 69 65 66 73 20
            ...
            brk                         ; 3F9E7:  00
msg_will_you_lead_them_personally: hex 57                      ; 3F9E8:  57
            adc #$6c                    ; 3F9E9:  69 6c
            ...
            jmp (music_voice_idx)                 ; 3FA03:  6c 79 00

msg_they_have_arrived_safely: hex 54 68 65 79 20 68 61 76 ; 3FA06:  54 68 65 79 20 68 61 76
            ...
            ror $65                     ; 3FA1A:  66 65
            jmp (music_voice_idx)                 ; 3FA1C:  6c 79 00

msg_attack_where: hex 0a 41 74 74 61 63 6b 20 ; 3FA1F:  0a 41 74 74 61 63 6b 20
            hex 77 68 65 72 65 3f 0a 00 ; 3FA27:  77 68 65 72 65 3f 0a 00
msg_how_many_men_fa2f: hex 48 6f 77 20 6d 61 6e 79 ; 3FA2F:  48 6f 77 20 6d 61 6e 79
            ...
            jmp (music_voice_idx)                 ; 3FA74:  6c 79 00

msg_tax_is_d_enter_new_tax: hex 54 61 78 20 69 73 20 25 ; 3FA77:  54 61 78 20 69 73 20 25
            hex 64 0a 45 6e 74 65 72 20 ; 3FA7F:  64 0a 45 6e 74 65 72 20
            hex 6e 65 77 20 74 61 78 00 ; 3FA87:  6e 65 77 20 74 61 78 00
msg_the_peasants_are_delighted: hex 54 68 65 20 70 65 61 73 ; 3FA8F:  54 68 65 20 70 65 61 73
...
msg_rice:   hex 52 69 63 65 00 54 68 65 ; 3FAFF:  52 69 63 65 00 54 68 65
            ...
            ror $65                     ; 3FB20:  66 65
            jmp (music_voice_idx)                 ; 3FB22:  6c 79 00

msg_s_is_d_spend_how_much_on_it: hex 25 73 20 69 73 20 25 64 ; 3FB25:  25 73 20 69 73 20 25 64
            ...
            brk                         ; 3FB8E:  00
            hex 00                      ; 3FB8F:  00
msg_lord_s_we_now_have_d_men: jmp $726f                   ; 3FB90:  4c 6f 72
...
msg_enemy_morale_is_falling_to_pie: hex 45 6e 65 6d 79 20 6d 6f ; 3FBBB:  45 6e 65 6d 79 20 6d 6f
            hex 72                      ; 3FBC3:  72
            ...
            hex 6e 73 00 ; ror prg_bank_shadow    ; 3FC6B:  6e 73 00
msg_it_will_do_you_good: eor #$74                    ; 3FC6E:  49 74
            ...
            pla                         ; 3FCB3:  68
            adc music_voice_idx                     ; 3FCB4:  65 79
            rts                         ; 3FCB6:  60
            ...
            jsr ai_turn_loop_redispatch_flag                   ; 3FCE5:  20 79 6f
            ...
            adc ppumask_shadow                     ; 3FD06:  65 72
            ...
            brk                         ; 3FD25:  00
            hex 00                      ; 3FD26:  00
msg_lord_s_s_wants_d_gold_pay: jmp $726f                   ; 3FD27:  4c 6f 72
            ...
            asl a                       ; 3FD38:  0a
            and $64                     ; 3FD39:  25 64
            jsr battle_defender_province_staging                   ; 3FD3B:  20 67 6f
            ...
            jsr ai_turn_loop_redispatch_flag                   ; 3FDBB:  20 79 6f
...
msg_it_s_currently_a_s_state_ok_to: hex 49 74 60 73 20 63 75 72 ; 3FE64:  49 74 60 73 20 63 75 72
            ...
            adc $70                     ; 3FF61:  65 70
            adc (music_voice_idx,x)                 ; 3FF63:  61 79
            brk                         ; 3FF65:  00
            hex 53                      ; 3FF66:  53
            adc $6c                     ; 3FF67:  65 6c
...
NMI:        word nmi_handler               ; 3FFFA: da c0
RESET:      word reset_handler               ; 3FFFC: 00 c0
IRQ:        word irq_handler               ; 3FFFE: 39 c1