...
; ============================================================
  ...
  $800F  AC 20 CD                   CALL_abs               $CD20 (repaint_screen) {bytecode}
 ...
 >$8052  0B                         LOADL_quick   ; inline operand = 11
  ...
  $8080  E9 34 D1 04                CALL_abs_imm1          $D134 (draw_message) {bytecode}, $04
...
; ============================================================
 ...
 >$82A3  8E 00 01                   PUSH_imm2              $0100
  ...
  $82EE  8E 9E B8                   PUSH_imm2              $B89E (str_load_status_msgs)
  ...
  $82FF  AC 20 CD                   CALL_abs               $CD20 (repaint_screen) {bytecode}
 ...
 >$8323  09                         LOADL_quick   ; inline operand = 9
  ...
  $8342  CF                         RETURN
 >$8343  8E AB B8                   PUSH_imm2              $B8AB (str_data_cant_be_used)
...
; ============================================================
  ...
  $83A1  B5                         MULT
  $83A2  8C A9 76                   LOADR_imm2             $76A9 (province_unit_type_pct)
  $83A5  BB                         ADD
...
; ============================================================
 ...
 >$8612  8D 32                      BYTE_PUSH_imm1         +50
  ...
  $861F  E9 34 D1 04                CALL_abs_imm1          $D134 (draw_message) {bytecode}, $04
...
; ============================================================
 >$8630  8E C7 B8                   PUSH_imm2              $B8C7 (str_scenario_size_prompt)
  $8633  E9 26 D3 02                CALL_abs_imm1          $D326 (message_display) {bytecode}, $02
  $8637  8E C8 B8                   PUSH_imm2              $B8C8 (msg_fiefs_50fiefs)
  $863A  E9 51 D3 02                CALL_abs_imm1          $D351 (prompt_ab_window) {bytecode}, $02
...
; ============================================================
  ...
  $868F  E9 34 D1 04                CALL_abs_imm1          $D134 (draw_message) {bytecode}, $04
  $8693  CF                         RETURN
...
; ============================================================
 ...
 >$86A7  B3                         PUSHL
  $86A8  E9 F2 E5 02                CALL_abs_imm1          $E5F2 (render_map_section) {bytecode}, $02
 ...
 >$86E9  0B                         LOADL_quick   ; inline operand = 11
  ...
  $86EC  B3                         PUSHL
 >$86ED  E9 F2 E5 02                CALL_abs_imm1          $E5F2 (render_map_section) {bytecode}, $02
...
; ============================================================
  $8768  AC 20 CD                   CALL_abs               $CD20 (repaint_screen) {bytecode}
  ...
  $87AD  E9 34 D1 04                CALL_abs_imm1          $D134 (draw_message) {bytecode}, $04
  ...
  $87EC  E9 34 D1 04                CALL_abs_imm1          $D134 (draw_message) {bytecode}, $04
 ...
 >$8832  09                         LOADL_quick   ; inline operand = 9
  ...
  $884F  E9 34 D1 02                CALL_abs_imm1          $D134 (draw_message) {bytecode}, $02
...
; ============================================================
 ...
 >$8A34  0B                         LOADL_quick   ; inline operand = 11
  ...
  $8A4B  AC 20 CD                   CALL_abs               $CD20 (repaint_screen) {bytecode}
 ...
 >$8A91  AC 20 CD                   CALL_abs               $CD20 (repaint_screen) {bytecode}
 ...
 >$8AC9  8E DE B9                   PUSH_imm2              $B9DE (msg_please_select_skill_level)
  ...
  $8AE9  AC 20 CD                   CALL_abs               $CD20 (repaint_screen) {bytecode}
 ...
 >$8B44  8E 10 BA                   PUSH_imm2              $BA10 (str_market_panel_nl2)
...
; ============================================================
 ...
 >$8B86  0C                         LOADL_quick   ; inline operand = 12
  ...
  $8B91  8A 31 BA                   LOADL_imm2             $BA31 (str_enemy_morale_falling)
...
; ============================================================
 ...
 >$8C95  09                         LOADL_quick   ; inline operand = 9
  ...
  $8CCB  8E 5E BA                   PUSH_imm2              $BA5E (str_bid_for_fief_prompt)
 ...
 >$8D62  D4                         BYTE_POPSTORE
  ...
  $8D91  8E 8C BA                   PUSH_imm2              $BA8C (str_fief_is_yours)
  ...
  $8DA5  E9 34 D1 04                CALL_abs_imm1          $D134 (draw_message) {bytecode}, $04
 ...
 >$8DAC  8E A1 BA                   PUSH_imm2              $BAA1 (msg_fief)
  ...
  $8DBB  E9 34 D1 04                CALL_abs_imm1          $D134 (draw_message) {bytecode}, $04
 ...
 >$8DD6  AA 63 6F                   PUSH_abs               $6F63 (battle_defending_province)
  $8DD9  E9 54 E5 02                CALL_abs_imm1          $E554 (redraw_fief_on_map) {bytecode}, $02
...
; ============================================================
  ...
  $8EF2  E9 34 D1 06                CALL_abs_imm1          $D134 (draw_message) {bytecode}, $06
  ...
  $8EFC  E9 34 D1 08                CALL_abs_imm1          $D134 (draw_message) {bytecode}, $08
...
; ============================================================
  ...
  $8F51  8E FD BA                   PUSH_imm2              $BAFD (str_uprising_outcome_msgs)
  ...
  $8F5C  E9 34 D1 04                CALL_abs_imm1          $D134 (draw_message) {bytecode}, $04
  ...
  $8F7D  E9 3C DC 02                CALL_abs_imm1          $DC3C (list_remove_matching) {bytecode}, $02
...
; ============================================================
 ...
 >$9006  AC 1E 8C                   CALL_abs               $8C1E (cur_flag_and_selected_ai_state5) {bytecode}
  ...
  $902E  8E 26 BB                   PUSH_imm2              $BB26 (str_people_rebelling)
...
; ============================================================
  ...
  $90DE  E9 12 CA 04                CALL_abs_imm1          $CA12 (deduct_byte_at) {bytecode}, $04
...
; ============================================================
 ...
 >$91BE  3B                         PUSH_quick   ; inline operand = 11
  $91BF  E9 0E DC 02                CALL_abs_imm1          $DC0E (pool_push_pop) {bytecode}, $02
  $91C3  3B                         PUSH_quick   ; inline operand = 11
  $91C4  E9 3C DC 02                CALL_abs_imm1          $DC3C (list_remove_matching) {bytecode}, $02
  ...
  $91D0  AC 35 DB                   CALL_abs               $DB35 (increment_ai_player_count) {bytecode}
 >$91D3  0B                         LOADL_quick   ; inline operand = 11
  ...
  $91EB  E9 34 D1 04                CALL_abs_imm1          $D134 (draw_message) {bytecode}, $04
  $91EF  3C                         PUSH_quick   ; inline operand = 12
  $91F0  E9 E7 E1 02                CALL_abs_imm1          $E1E7 (clear_fief_pair_matrix) {bytecode}, $02
...
; ============================================================
  $93C4  8E C6 BB                   PUSH_imm2              $BBC6 (str_ninja_sent_against)
  ...
  $93E1  E9 34 D1 04                CALL_abs_imm1          $D134 (draw_message) {bytecode}, $04
  ...
  $943C  B3                         PUSHL
  $943D  E9 12 CA 04                CALL_abs_imm1          $CA12 (deduct_byte_at) {bytecode}, $04
  ...
  $9448  D0                         INC
  $9449  B3                         PUSHL
  $944A  E9 12 CA 04                CALL_abs_imm1          $CA12 (deduct_byte_at) {bytecode}, $04
...
; ============================================================
 ...
 >$94EF  8E 2A BC                   PUSH_imm2              $BC2A (str_typhoon_msg)
 ...
 >$9504  8E 4B BC                   PUSH_imm2              $BC4B (str_plague_msg)
 ...
 >$9516  E9 34 D1 04                CALL_abs_imm1          $D134 (draw_message) {bytecode}, $04
...
; ============================================================
  ...
  $95A7  E9 34 D1 04                CALL_abs_imm1          $D134 (draw_message) {bytecode}, $04
  ...
  $95FB  E9 34 D1 06                CALL_abs_imm1          $D134 (draw_message) {bytecode}, $06
...
; ============================================================
 ...
 >$9635  3B                         PUSH_quick   ; inline operand = 11
  ...
  $9653  E9 54 E5 02                CALL_abs_imm1          $E554 (redraw_fief_on_map) {bytecode}, $02
 ...
 >$9659  2B                         STORE_quick   ; inline operand = 11
  ...
  $9694  E9 0C E8 02                CALL_abs_imm1          $E80C (trigger_cutscene) {bytecode}, $02
...
; ============================================================
  ...
  $96F6  AC D7 DA                   CALL_abs               $DAD7 (compact_relation_list) {bytecode}
...
; ============================================================
 ...
 >$97AF  0B                         LOADL_quick   ; inline operand = 11
  ...
  $97DC  D3                         BYTE_DEREF
  $97DD  B3                         PUSHL
  $97DE  E9 0E DC 02                CALL_abs_imm1          $DC0E (pool_push_pop) {bytecode}, $02
  $97E2  0A                         LOADL_quick   ; inline operand = 10
  $97E3  D3                         BYTE_DEREF
  $97E4  B3                         PUSHL
  $97E5  E9 3C DC 02                CALL_abs_imm1          $DC3C (list_remove_matching) {bytecode}, $02
...
; ============================================================
  ...
  $98C1  E9 54 E5 02                CALL_abs_imm1          $E554 (redraw_fief_on_map) {bytecode}, $02
  $98C5  CF                         RETURN

; ============================================================
; sub $98C6   (frame_off=-58, body @ $98CB)
; ============================================================
  $98CB  AC D7 DA                   CALL_abs               $DAD7 (compact_relation_list) {bytecode}
...
; ============================================================
  $99B0  AC 20 CD                   CALL_abs               $CD20 (repaint_screen) {bytecode}
 ...
 >$99DD  3B                         PUSH_quick   ; inline operand = 11
  ...
  $99F2  E9 54 E5 02                CALL_abs_imm1          $E554 (redraw_fief_on_map) {bytecode}, $02
 ...
 >$9A04  A4 5F 6F                   LOADL_abs              $6F5F (selected_province_idx)
  ...
  $9A51  E9 54 E5 02                CALL_abs_imm1          $E554 (redraw_fief_on_map) {bytecode}, $02
 ...
 >$9A9E  60                         PUSH_qimm   ; inline operand = 0
  ...
  $9AA7  E9 F2 E5 02                CALL_abs_imm1          $E5F2 (render_map_section) {bytecode}, $02
  $9AAB  CF                         RETURN
...
; ============================================================
  ...
  $9AD6  E9 0C E8 02                CALL_abs_imm1          $E80C (trigger_cutscene) {bytecode}, $02
...
; ============================================================
 ...
 >$9B1B  A4 5F 6F                   LOADL_abs              $6F5F (selected_province_idx)
  ...
  $9B30  AC D7 DA                   CALL_abs               $DAD7 (compact_relation_list) {bytecode}
...
; ============================================================
  $9B84  AC 15 E3                   CALL_abs               $E315 (marriage_pact_handler) {bytecode}
  ...
  $9BA9  E9 0C E8 02                CALL_abs_imm1          $E80C (trigger_cutscene) {bytecode}, $02
...
; ============================================================
  ...
  $9CBA  E9 0C E8 02                CALL_abs_imm1          $E80C (trigger_cutscene) {bytecode}, $02
...
; ============================================================
  ...
  $9D07  E9 0C E8 02                CALL_abs_imm1          $E80C (trigger_cutscene) {bytecode}, $02
 ...
 >$9D11  0B                         LOADL_quick   ; inline operand = 11
  ...
  $9D60  D0                         INC
  $9D61  B3                         PUSHL
  $9D62  E9 12 CA 04                CALL_abs_imm1          $CA12 (deduct_byte_at) {bytecode}, $04
...
; ============================================================
 ...
 >$9DE9  0C                         LOADL_quick   ; inline operand = 12
  ...
  $9E05  AC 12 DB                   CALL_abs               $DB12 (defender_owner_is_keyed_daimyo) {bytecode}
...
; ============================================================
  ...
  $9E4A  AC 12 DB                   CALL_abs               $DB12 (defender_owner_is_keyed_daimyo) {bytecode}
...
; ============================================================
 ...
 >$9F1F  8D 1E                      BYTE_PUSH_imm1         +30
  ...
  $9F31  E9 0C E8 02                CALL_abs_imm1          $E80C (trigger_cutscene) {bytecode}, $02
 ...
 >$9F3B  8D 1E                      BYTE_PUSH_imm1         +30
  ...
  $9F4D  E9 0C E8 02                CALL_abs_imm1          $E80C (trigger_cutscene) {bytecode}, $02
...
; ============================================================
 ...
 >$A3FB  8E 00 01                   PUSH_imm2              $0100
  ...
  $A443  8E 1C BF                   PUSH_imm2              $BF1C (str_save_and_illness_msgs)
...
; ============================================================
  ...
  $A45E  AC 20 CD                   CALL_abs               $CD20 (repaint_screen) {bytecode}
 ...
 >$A55F  39                         PUSH_quick   ; inline operand = 9
  ...
  $A5A2  E9 72 D9 02                CALL_abs_imm1          $D972 (fief_owner_weakness) {bytecode}, $02
